---
url: "https://clear.ml/docs/latest/docs/release_notes/clearml_server/enterprise/ver_3_25/"
title: "Version 3.25 | ClearML"
---

[Skip to main content](https://clear.ml/docs/latest/docs/release_notes/clearml_server/enterprise/ver_3_25/#__docusaurus_skipToContent_fallback)

If you ❤️ ️ **ClearML**, ⭐️ us on [GitHub](https://github.com/clearml/clearml)!

On this page

### Enterprise Server 3.25.5 [​](https://clear.ml/docs/latest/docs/release_notes/clearml_server/enterprise/ver_3_25/\#enterprise-server-3255 "Direct link to Enterprise Server 3.25.5")
...
### Enterprise Server 3.25.4 [​](https://clear.ml/docs/latest/docs/release_notes/clearml_server/enterprise/ver_3_25/\#enterprise-server-3254 "Direct link to Enterprise Server 3.25.4")

**New Feature**

- Add support for tenant SSO without tenant information in the IDP claims

### Enterprise Server 3.25.3 [​](https://clear.ml/docs/latest/docs/release_notes/clearml_server/enterprise/ver_3_25/\#enterprise-server-3253 "Direct link to Enterprise Server 3.25.3")

**New Feature**

- Enable setting service accounts as admins

### Enterprise Server 3.25.2 [​](https://clear.ml/docs/latest/docs/release_notes/clearml_server/enterprise/ver_3_25/\#enterprise-server-3252 "Direct link to Enterprise Server 3.25.2")

**Bug Fix**

- Fix non-responsive task watchdog is crashing

### Enterprise Server 3.25.1 [​](https://clear.ml/docs/latest/docs/release_notes/clearml_server/enterprise/ver_3_25/\#enterprise-server-3251 "Direct link to Enterprise Server 3.25.1")
...
### Enterprise Server 3.25.0 [​](https://clear.ml/docs/latest/docs/release_notes/clearml_server/enterprise/ver_3_25/\#enterprise-server-3250 "Direct link to Enterprise Server 3.25.0")
...
- [Enterprise Server 3.25.5](https://clear.ml/docs/latest/docs/release_notes/clearml_server/enterprise/ver_3_25/#enterprise-server-3255)
- [Enterprise Server 3.25.4](https://clear.ml/docs/latest/docs/release_notes/clearml_server/enterprise/ver_3_25/#enterprise-server-3254)
- [Enterprise Server 3.25.3](https://clear.ml/docs/latest/docs/release_notes/clearml_server/enterprise/ver_3_25/#enterprise-server-3253)
- [Enterprise Server 3.25.2](https://clear.ml/docs/latest/docs/release_notes/clearml_server/enterprise/ver_3_25/#enterprise-server-3252)
- [Enterprise Server 3.25.1](https://clear.ml/docs/latest/docs/release_notes/clearml_server/enterprise/ver_3_25/#enterprise-server-3251)
- [Enterprise Server 3.25.0](https://clear.ml/docs/latest/docs/release_notes/clearml_server/enterprise/ver_3_25/#enterprise-server-3250)