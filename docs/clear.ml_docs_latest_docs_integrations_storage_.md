---
url: "https://clear.ml/docs/latest/docs/integrations/storage/"
title: "Storage | ClearML"
---

[Skip to main content](https://clear.ml/docs/latest/docs/integrations/storage/#__docusaurus_skipToContent_fallback)
...
![Supported storage](https://clear.ml/docs/latest/assets/images/ClearML_Supported_Storage--on-light-1529c8c3dabdc4d55bc2a10648d63cae.png)

To use cloud storage with ClearML, [install](https://clear.ml/docs/latest/docs/integrations/storage/#installation) the `clearml` package for your cloud storage type, and then
[configure](https://clear.ml/docs/latest/docs/integrations/storage/#configuring-storage) your storage credentials.

note

Once uploading an object to a storage medium, each machine that uses the object must have access to it.

## Installation [​](https://clear.ml/docs/latest/docs/integrations/storage/\#installation "Direct link to Installation")
...
## Configuring Storage [​](https://clear.ml/docs/latest/docs/integrations/storage/\#configuring-storage "Direct link to Configuring Storage")

Configuration for storage is done by editing the [clearml.conf](https://clear.ml/docs/latest/docs/configs/clearml_conf).
...
### Configuring AWS S3 [​](https://clear.ml/docs/latest/docs/integrations/storage/\#configuring-aws-s3 "Direct link to Configuring AWS S3")
...
#### Non-AWS Endpoints [​](https://clear.ml/docs/latest/docs/integrations/storage/\#non-aws-endpoints "Direct link to Non-AWS Endpoints")
...
To force usage of a non-AWS endpoint, port declaration is _always_ needed (e.g. `host: "my-minio-host:9000"`),
...
##### TLS [​](https://clear.ml/docs/latest/docs/integrations/storage/\#tls "Direct link to TLS")
...
##### Dell PowerScale with S3 [​](https://clear.ml/docs/latest/docs/integrations/storage/\#dell-powerscale-with-s3 "Direct link to Dell PowerScale with S3")
...
described [above](https://clear.ml/docs/latest/docs/integrations/storage/#non-aws-endpoints).

### Configuring Azure [​](https://clear.ml/docs/latest/docs/integrations/storage/\#configuring-azure "Direct link to Configuring Azure")
...
### Configuring Google Storage [​](https://clear.ml/docs/latest/docs/integrations/storage/\#configuring-google-storage "Direct link to Configuring Google Storage")
...
## Storage Manager [​](https://clear.ml/docs/latest/docs/integrations/storage/\#storage-manager "Direct link to Storage Manager")

ClearML provides the [StorageManager](https://clear.ml/docs/latest/docs/references/sdk/storage) class to manage downloading, uploading, and caching of
content directly from code.

See [StorageManager Examples](https://clear.ml/docs/latest/docs/guides/storage/examples_storagehelper).

### Path Substitution [​](https://clear.ml/docs/latest/docs/integrations/storage/\#path-substitution "Direct link to Path Substitution")
...
## Caching [​](https://clear.ml/docs/latest/docs/integrations/storage/\#caching "Direct link to Caching")

ClearML also manages a cache of all downloaded content so nothing is duplicated, and code won't need to download the same
piece twice!

Configure cache location by modifying the [clearml.conf](https://clear.ml/docs/latest/docs/configs/clearml_conf) file:
...
### Direct Access [​](https://clear.ml/docs/latest/docs/integrations/storage/\#direct-access "Direct link to Direct Access")
...
- [Installation](https://clear.ml/docs/latest/docs/integrations/storage/#installation)
- [Configuring Storage](https://clear.ml/docs/latest/docs/integrations/storage/#configuring-storage)
  - [Configuring AWS S3](https://clear.ml/docs/latest/docs/integrations/storage/#configuring-aws-s3)
  - [Configuring Azure](https://clear.ml/docs/latest/docs/integrations/storage/#configuring-azure)
  - [Configuring Google Storage](https://clear.ml/docs/latest/docs/integrations/storage/#configuring-google-storage)
- [Storage Manager](https://clear.ml/docs/latest/docs/integrations/storage/#storage-manager)
  - [Path Substitution](https://clear.ml/docs/latest/docs/integrations/storage/#path-substitution)
- [Caching](https://clear.ml/docs/latest/docs/integrations/storage/#caching)
  - [Direct Access](https://clear.ml/docs/latest/docs/integrations/storage/#direct-access)