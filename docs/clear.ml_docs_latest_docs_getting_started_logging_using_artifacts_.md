---
url: "https://clear.ml/docs/latest/docs/getting_started/logging_using_artifacts/"
title: "Logging and Using Task Artifacts | ClearML"
---

[Skip to main content](https://clear.ml/docs/latest/docs/getting_started/logging_using_artifacts/#__docusaurus_skipToContent_fallback)
...
This tutorial assumes that you've already set up [ClearML](https://clear.ml/docs/latest/docs/clearml_sdk/clearml_sdk_setup)

ClearML lets you easily store a task's output products--or **Artifacts**:

- [Model](https://clear.ml/docs/latest/docs/getting_started/logging_using_artifacts/#models) snapshot / weights file
...
See all [storage capabilities](https://clear.ml/docs/latest/docs/integrations/storage).

## Adding Artifacts [​](https://clear.ml/docs/latest/docs/getting_started/logging_using_artifacts/\#adding-artifacts "Direct link to Adding Artifacts")

Let's create a [Task](https://clear.ml/docs/latest/docs/fundamentals/task) and add some artifacts to it.

1. Create a task using [`Task.init()`](https://clear.ml/docs/latest/docs/references/sdk/task#taskinit)
...
2. Upload a local **file** using [`Task.upload_folder()`](https://clear.ml/docs/latest/docs/references/sdk/task#upload_artifact) and specifying the artifact's
name and its path:
...
3. Upload an **entire folder** with all its content by passing the folder path (the folder will be zipped and uploaded as a single zip file).
...
4. Upload an instance of an object. Numpy/Pandas/PIL Images are supported with `npz`/`csv.gz`/`jpg` formats accordingly.
...
For more artifact logging options, see [Artifacts](https://clear.ml/docs/latest/docs/clearml_sdk/task_sdk#artifacts).

### Using Artifacts [​](https://clear.ml/docs/latest/docs/getting_started/logging_using_artifacts/\#using-artifacts "Direct link to Using Artifacts")
...
## Models [​](https://clear.ml/docs/latest/docs/getting_started/logging_using_artifacts/\#models "Direct link to Models")
...
### Loading Models [​](https://clear.ml/docs/latest/docs/getting_started/logging_using_artifacts/\#loading-models "Direct link to Loading Models")
...
- [Adding Artifacts](https://clear.ml/docs/latest/docs/getting_started/logging_using_artifacts/#adding-artifacts)
  - [Using Artifacts](https://clear.ml/docs/latest/docs/getting_started/logging_using_artifacts/#using-artifacts)
- [Models](https://clear.ml/docs/latest/docs/getting_started/logging_using_artifacts/#models)
  - [Loading Models](https://clear.ml/docs/latest/docs/getting_started/logging_using_artifacts/#loading-models)