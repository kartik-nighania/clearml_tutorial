---
url: "https://clear.ml/docs/latest/docs/release_notes/clearml_server/open_source/ver_1_16/"
title: "Version 1.16 | ClearML"
---

[Skip to main content](https://clear.ml/docs/latest/docs/release_notes/clearml_server/open_source/ver_1_16/#__docusaurus_skipToContent_fallback)

If you ❤️ ️ **ClearML**, ⭐️ us on [GitHub](https://github.com/clearml/clearml)!

On this page

### ClearML Server 1.16.2 [​](https://clear.ml/docs/latest/docs/release_notes/clearml_server/open_source/ver_1_16/\#clearml-server-1162 "Direct link to ClearML Server 1.16.2")

**Bug Fix**

- Fix no graphs are shown in Workers and Queues screens

### ClearML Server 1.16.1 [​](https://clear.ml/docs/latest/docs/release_notes/clearml_server/open_source/ver_1_16/\#clearml-server-1161 "Direct link to ClearML Server 1.16.1")

**Bug Fix**

- Fix user credentials reset on API server restart ( [ClearML #250](https://github.com/clearml/clearml-server/issues/250))

### ClearML Server 1.16.0 [​](https://clear.ml/docs/latest/docs/release_notes/clearml_server/open_source/ver_1_16/\#clearml-server-1160 "Direct link to ClearML Server 1.16.0")
...
- [ClearML Server 1.16.2](https://clear.ml/docs/latest/docs/release_notes/clearml_server/open_source/ver_1_16/#clearml-server-1162)
- [ClearML Server 1.16.1](https://clear.ml/docs/latest/docs/release_notes/clearml_server/open_source/ver_1_16/#clearml-server-1161)
- [ClearML Server 1.16.0](https://clear.ml/docs/latest/docs/release_notes/clearml_server/open_source/ver_1_16/#clearml-server-1160)