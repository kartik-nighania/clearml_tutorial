---
url: "https://clear.ml/docs/latest/docs/integrations/xgboost/"
title: "XGBoost | ClearML"
---

[Skip to main content](https://clear.ml/docs/latest/docs/integrations/xgboost/#__docusaurus_skipToContent_fallback)
...
![Task scalars](https://clear.ml/docs/latest/assets/images/examples_xgboost_metric_scalars-ba5f134ccd09d9c616490c4a0e3f90cf.png#light-mode-only)![Task scalars](https://clear.ml/docs/latest/assets/images/examples_xgboost_metric_scalars_dark-cd5dae767b4e172a939b8848f171e9e5.png#dark-mode-only)

## Automatic Logging Control [​](https://clear.ml/docs/latest/docs/integrations/xgboost/\#automatic-logging-control "Direct link to Automatic Logging Control")
...
## Manual Logging [​](https://clear.ml/docs/latest/docs/integrations/xgboost/\#manual-logging "Direct link to Manual Logging")
...
## Examples [​](https://clear.ml/docs/latest/docs/integrations/xgboost/\#examples "Direct link to Examples")
...
- [XGBoost Metric](https://clear.ml/docs/latest/docs/guides/frameworks/xgboost/xgboost_metrics) \- Demonstrates ClearML automatic logging of XGBoost models and plots
- [XGBoost and scikit-learn](https://clear.ml/docs/latest/docs/guides/frameworks/xgboost/xgboost_sample) \- Demonstrates ClearML automatic logging of XGBoost scalars and models

## Remote Execution [​](https://clear.ml/docs/latest/docs/integrations/xgboost/\#remote-execution "Direct link to Remote Execution")
...
### Reproducing Task Runs [​](https://clear.ml/docs/latest/docs/integrations/xgboost/\#reproducing-task-runs "Direct link to Reproducing Task Runs")
...
### Executing a Task Remotely [​](https://clear.ml/docs/latest/docs/integrations/xgboost/\#executing-a-task-remotely "Direct link to Executing a Task Remotely")
...
## Hyperparameter Optimization [​](https://clear.ml/docs/latest/docs/integrations/xgboost/\#hyperparameter-optimization "Direct link to Hyperparameter Optimization")
...
- [Automatic Logging Control](https://clear.ml/docs/latest/docs/integrations/xgboost/#automatic-logging-control)
- [Manual Logging](https://clear.ml/docs/latest/docs/integrations/xgboost/#manual-logging)
- [Examples](https://clear.ml/docs/latest/docs/integrations/xgboost/#examples)
- [Remote Execution](https://clear.ml/docs/latest/docs/integrations/xgboost/#remote-execution)
  - [Reproducing Task Runs](https://clear.ml/docs/latest/docs/integrations/xgboost/#reproducing-task-runs)
  - [Executing a Task Remotely](https://clear.ml/docs/latest/docs/integrations/xgboost/#executing-a-task-remotely)
- [Hyperparameter Optimization](https://clear.ml/docs/latest/docs/integrations/xgboost/#hyperparameter-optimization)