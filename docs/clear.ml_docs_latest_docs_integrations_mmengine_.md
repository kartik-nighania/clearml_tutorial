---
url: "https://clear.ml/docs/latest/docs/integrations/mmengine/"
title: "MMEngine | ClearML"
---

[Skip to main content](https://clear.ml/docs/latest/docs/integrations/mmengine/#__docusaurus_skipToContent_fallback)
...
You can specify the following parameters:
   - `init_kwargs` – A dictionary that contains the arguments to pass to ClearML's [`Task.init()`](https://clear.ml/docs/latest/docs/references/sdk/task#taskinit).
...
4. Report images to your task using `ClearMLVisBackend.add_image()`. Under the `image` parameter, input the image
