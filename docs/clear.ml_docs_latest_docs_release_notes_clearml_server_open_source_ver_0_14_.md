---
url: "https://clear.ml/docs/latest/docs/release_notes/clearml_server/open_source/ver_0_14/"
title: "Version 0.14 | ClearML"
---

[Skip to main content](https://clear.ml/docs/latest/docs/release_notes/clearml_server/open_source/ver_0_14/#__docusaurus_skipToContent_fallback)
...
### Trains Server 0.14.2 [​](https://clear.ml/docs/latest/docs/release_notes/clearml_server/open_source/ver_0_14/\#trains-server-0142 "Direct link to Trains Server 0.14.2")
...
### Trains Server 0.14.1 [​](https://clear.ml/docs/latest/docs/release_notes/clearml_server/open_source/ver_0_14/\#trains-server-0141 "Direct link to Trains Server 0.14.1")
...
### Trains Server 0.14.0 [​](https://clear.ml/docs/latest/docs/release_notes/clearml_server/open_source/ver_0_14/\#trains-server-0140 "Direct link to Trains Server 0.14.0")
...
- Allow deleting an input model from an experiment whose status is _Draft_.
...
- [Trains Server 0.14.2](https://clear.ml/docs/latest/docs/release_notes/clearml_server/open_source/ver_0_14/#trains-server-0142)
- [Trains Server 0.14.1](https://clear.ml/docs/latest/docs/release_notes/clearml_server/open_source/ver_0_14/#trains-server-0141)
- [Trains Server 0.14.0](https://clear.ml/docs/latest/docs/release_notes/clearml_server/open_source/ver_0_14/#trains-server-0140)