---
url: "https://clear.ml/docs/latest/docs/release_notes/clearml_agent/ver_0_17/"
title: "Version 0.17 | ClearML"
---

[Skip to main content](https://clear.ml/docs/latest/docs/release_notes/clearml_agent/ver_0_17/#__docusaurus_skipToContent_fallback)

If you ❤️ ️ **ClearML**, ⭐️ us on [GitHub](https://github.com/clearml/clearml)!

On this page

### ClearML Agent 0.17.2 [​](https://clear.ml/docs/latest/docs/release_notes/clearml_agent/ver_0_17/\#clearml-agent-0172 "Direct link to ClearML Agent 0.17.2")
...
### ClearML Agent 0.17.0 [​](https://clear.ml/docs/latest/docs/release_notes/clearml_agent/ver_0_17/\#clearml-agent-0170 "Direct link to ClearML Agent 0.17.0")

- Renamed `trains-agent` as `clearml-agent` (see [clearml-agent](https://github.com/clearml/clearml-agent) in GitHub).

- [ClearML Agent 0.17.2](https://clear.ml/docs/latest/docs/release_notes/clearml_agent/ver_0_17/#clearml-agent-0172)
- [ClearML Agent 0.17.0](https://clear.ml/docs/latest/docs/release_notes/clearml_agent/ver_0_17/#clearml-agent-0170)