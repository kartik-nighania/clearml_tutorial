---
url: "https://clear.ml/docs/latest/docs/webapp/applications/apps_aws_autoscaler/"
title: "AWS Autoscaler | ClearML"
---

[Skip to main content](https://clear.ml/docs/latest/docs/webapp/applications/apps_aws_autoscaler/#__docusaurus_skipToContent_fallback)
...
Each resource type is associated with a ClearML [queue](https://clear.ml/docs/latest/docs/fundamentals/agents_and_queues#what-is-a-queue) whose status determines the need for instances of that resource
...
[configuring runtimes such as Sysbox](https://clear.ml/docs/latest/docs/webapp/applications/apps_aws_autoscaler/#running-autoscaler-instances-with-sysbox)).
...
![Autoscaler dashboard](https://clear.ml/docs/latest/assets/images/apps_aws_autoscaler-2dc25ab73a6fa60e3ec9894ca12af61d.png#light-mode-only)![Autoscaler dashboard](https://clear.ml/docs/latest/assets/images/apps_aws_autoscaler_dark-14d7905a9f95c9c46e8c16df72a12d6e.png#dark-mode-only)
...
## Autoscaler Instance Configuration [​](https://clear.ml/docs/latest/docs/webapp/applications/apps_aws_autoscaler/\#autoscaler-instance-configuration "Direct link to Autoscaler Instance Configuration")
...
### Configuration Options [​](https://clear.ml/docs/latest/docs/webapp/applications/apps_aws_autoscaler/\#configuration-options "Direct link to Configuration Options")
...
- **AWS Credentials** \- Credentials with which the autoscaler can access your AWS account. See [Generating AWS IAM Credentials](https://clear.ml/docs/latest/docs/webapp/applications/apps_aws_autoscaler/#generating-aws-iam-credentials)
...
- **Compute Resources**
  ...
  - Availability Zone - The [EC2 availability zone](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/Concepts.RegionsAndAvailabilityZones.html#Concepts.RegionsAndAvailabilityZones.AvailabilityZones)
    ...
    - AMI ID or image name - The AWS AMI to launch. If you use an AMI name, the autoscaler will try to resolve the
      alias into an AMI ID. To use marketplace AMI aliases, you must enable the necessary permissions (see [Generating AWS IAM Credentials](https://clear.ml/docs/latest/docs/webapp/applications/apps_aws_autoscaler/#generating-aws-iam-credentials)).
...
tasks run by the autoscaler. For more information, see [Configuration Vault](https://clear.ml/docs/latest/docs/webapp/applications/apps_aws_autoscaler/#configuration-vault) (available under ClearML Enterprise Plan).
...
creating the instances launch spec. See [boto3 EC2.client.run\_instances Request Syntax](https://boto3.amazonaws.com/v1/documentation/api/latest/reference/services/ec2/client/run_instances.html)
...
![Autoscaler instance launch form](https://clear.ml/docs/latest/assets/images/app_aws_autoscaler_wizard-f36b4a7151d60628f20e0787b23429fb.png)

### Configuration Vault [​](https://clear.ml/docs/latest/docs/webapp/applications/apps_aws_autoscaler/\#configuration-vault "Direct link to Configuration Vault")

Enterprise Feature

The Configuration Vault is available under the ClearML Enterprise plan.

You can utilize the [configuration vault](https://clear.ml/docs/latest/docs/webapp/settings/webapp_settings_profile#configuration-vault) to set the following:
...
For more information, see [Files Section](https://clear.ml/docs/latest/docs/configs/clearml_conf#files-section)
- `environment` \- Dictionary of environment variables and values to set in the OS environment of the container running
the autoscaler. For more information, see [Environment Section](https://clear.ml/docs/latest/docs/configs/clearml_conf#environment-section)
...
#### Configure Specific Autoscaler Instances [​](https://clear.ml/docs/latest/docs/webapp/applications/apps_aws_autoscaler/\#configure-specific-autoscaler-instances "Direct link to Configure Specific Autoscaler Instances")
...
#### Configure Instances Spawned by the Autoscaler [​](https://clear.ml/docs/latest/docs/webapp/applications/apps_aws_autoscaler/\#configure-instances-spawned-by-the-autoscaler "Direct link to Configure Instances Spawned by the Autoscaler")
...
- Run the autoscaler using a [ClearML Service Account](https://clear.ml/docs/latest/docs/webapp/settings/webapp_settings_users#service-accounts). Add the
...
- Admins can add the configuration to a [ClearML Administrator Vault](https://clear.ml/docs/latest/docs/webapp/settings/webapp_settings_admin_vaults)
and link the vault with a [user group](https://clear.ml/docs/latest/docs/webapp/settings/webapp_settings_users#user-groups) that includes the user running the
autoscaler

## Generating AWS IAM Credentials [​](https://clear.ml/docs/latest/docs/webapp/applications/apps_aws_autoscaler/\#generating-aws-iam-credentials "Direct link to Generating AWS IAM Credentials")
...
![AWS Policies](https://clear.ml/docs/latest/assets/images/apps_aws_permissions_1-9220af7692387f24d4aca9974dd0db99.png)

2. Under policies, click **Create Policy**

![AWS create policy](https://clear.ml/docs/latest/assets/images/apps_aws_permissions_2-3e9a14652c27d948bd5d659f725b18f9.png)

3. In the **Create Policy** modal, click on the JSON option

![AWS create policy JSON](https://clear.ml/docs/latest/assets/images/apps_aws_permissions_3-4b91b080cedb659e80e10299019b21a4.png)

4. Insert the following policy into the text box (make sure to replace `<AWS_ACCOUNT_ID>` with your account ID):
...
5. Complete creating the policy

6. Attach the created policy to an IAM user/group whose credentials will be used in the autoscaler app (you can create a
new IAM user/group for this purpose)

7. Obtain a set of AWS IAM credentials for the user/group to which you have attached the created policy in the previous step


## Running Autoscaler Instances with Sysbox [​](https://clear.ml/docs/latest/docs/webapp/applications/apps_aws_autoscaler/\#running-autoscaler-instances-with-sysbox "Direct link to Running Autoscaler Instances with Sysbox")

To support workloads that require nested container environments, such as the ClearML [Virtual Machine Remote Desktop](https://clear.ml/docs/latest/docs/webapp/applications/apps_vm_desktop)
...
### Init Script Example [​](https://clear.ml/docs/latest/docs/webapp/applications/apps_aws_autoscaler/\#init-script-example "Direct link to Init Script Example")
...
- [Autoscaler Instance Configuration](https://clear.ml/docs/latest/docs/webapp/applications/apps_aws_autoscaler/#autoscaler-instance-configuration)
  - [Configuration Options](https://clear.ml/docs/latest/docs/webapp/applications/apps_aws_autoscaler/#configuration-options)
  - [Configuration Vault](https://clear.ml/docs/latest/docs/webapp/applications/apps_aws_autoscaler/#configuration-vault)
- [Generating AWS IAM Credentials](https://clear.ml/docs/latest/docs/webapp/applications/apps_aws_autoscaler/#generating-aws-iam-credentials)
- [Running Autoscaler Instances with Sysbox](https://clear.ml/docs/latest/docs/webapp/applications/apps_aws_autoscaler/#running-autoscaler-instances-with-sysbox)
  - [Init Script Example](https://clear.ml/docs/latest/docs/webapp/applications/apps_aws_autoscaler/#init-script-example)