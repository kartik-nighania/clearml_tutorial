---
url: "https://clear.ml/docs/latest/docs/guides/set_offline/"
title: "Storing Task Data Offline | ClearML"
---

[Skip to main content](https://clear.ml/docs/latest/docs/guides/set_offline/#__docusaurus_skipToContent_fallback)
...
local session folder, which can be later uploaded to the [ClearML Server](https://clear.ml/docs/latest/docs/deploying_clearml/clearml_server).

## Setting Task to Offline Mode [​](https://clear.ml/docs/latest/docs/guides/set_offline/\#setting-task-to-offline-mode "Direct link to Setting Task to Offline Mode")
...
## Uploading Session Data [​](https://clear.ml/docs/latest/docs/guides/set_offline/\#uploading-session-data "Direct link to Uploading Session Data")
...
- [`Task.import_offline_session`](https://clear.ml/docs/latest/docs/references/sdk/task#taskimport_offline_session) method.
...
The session details can be viewed in the ClearML WebApp, in the "my\_task" task of the "examples"
project, as specified when initializing the Task.

- [Setting Task to Offline Mode](https://clear.ml/docs/latest/docs/guides/set_offline/#setting-task-to-offline-mode)
- [Uploading Session Data](https://clear.ml/docs/latest/docs/guides/set_offline/#uploading-session-data)