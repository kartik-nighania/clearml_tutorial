---
url: "https://clear.ml/docs/latest/docs/release_notes/clearml_server/open_source/ver_0_10/"
title: "Version 0.10 | ClearML"
---

[Skip to main content](https://clear.ml/docs/latest/docs/release_notes/clearml_server/open_source/ver_0_10/#__docusaurus_skipToContent_fallback)
...
### Trains Server 0.10.1 [​](https://clear.ml/docs/latest/docs/release_notes/clearml_server/open_source/ver_0_10/\#trains-server-0101 "Direct link to Trains Server 0.10.1")
...
- Add simple username / password login scheme, see [GitHub trains-server Issue 3](https://github.com/clearml/clearml-server/issues/3)
  - Fixed User/Password configuration (see [instructions](https://clear.ml/docs/latest/docs/deploying_clearml/clearml_server_config#web-login-authentication)).
...
### Trains Server 0.10.0 [​](https://clear.ml/docs/latest/docs/release_notes/clearml_server/open_source/ver_0_10/\#trains-server-0100 "Direct link to Trains Server 0.10.0")
...
- [Trains Server 0.10.1](https://clear.ml/docs/latest/docs/release_notes/clearml_server/open_source/ver_0_10/#trains-server-0101)
- [Trains Server 0.10.0](https://clear.ml/docs/latest/docs/release_notes/clearml_server/open_source/ver_0_10/#trains-server-0100)