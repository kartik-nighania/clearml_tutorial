---
url: "https://clear.ml/docs/latest/docs/release_notes/clearml_server/open_source/ver_1_13/"
title: "Version 1.13 | ClearML"
---

[Skip to main content](https://clear.ml/docs/latest/docs/release_notes/clearml_server/open_source/ver_1_13/#__docusaurus_skipToContent_fallback)

If you ❤️ ️ **ClearML**, ⭐️ us on [GitHub](https://github.com/clearml/clearml)!

On this page

### ClearML Server 1.13.1 [​](https://clear.ml/docs/latest/docs/release_notes/clearml_server/open_source/ver_1_13/\#clearml-server-1131 "Direct link to ClearML Server 1.13.1")
...
### ClearML Server 1.13.0 [​](https://clear.ml/docs/latest/docs/release_notes/clearml_server/open_source/ver_1_13/\#clearml-server-1130 "Direct link to ClearML Server 1.13.0")
...
- [ClearML Server 1.13.1](https://clear.ml/docs/latest/docs/release_notes/clearml_server/open_source/ver_1_13/#clearml-server-1131)
- [ClearML Server 1.13.0](https://clear.ml/docs/latest/docs/release_notes/clearml_server/open_source/ver_1_13/#clearml-server-1130)