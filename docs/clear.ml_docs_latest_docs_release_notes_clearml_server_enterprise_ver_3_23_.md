---
url: "https://clear.ml/docs/latest/docs/release_notes/clearml_server/enterprise/ver_3_23/"
title: "Version 3.23 | ClearML"
---

[Skip to main content](https://clear.ml/docs/latest/docs/release_notes/clearml_server/enterprise/ver_3_23/#__docusaurus_skipToContent_fallback)

If you ❤️ ️ **ClearML**, ⭐️ us on [GitHub](https://github.com/clearml/clearml)!

On this page

### Enterprise Server 3.23.2 [​](https://clear.ml/docs/latest/docs/release_notes/clearml_server/enterprise/ver_3_23/\#enterprise-server-3232 "Direct link to Enterprise Server 3.23.2")
...
### Enterprise Server 3.23.1 [​](https://clear.ml/docs/latest/docs/release_notes/clearml_server/enterprise/ver_3_23/\#enterprise-server-3231 "Direct link to Enterprise Server 3.23.1")
...
### Enterprise Server 3.23.0 [​](https://clear.ml/docs/latest/docs/release_notes/clearml_server/enterprise/ver_3_23/\#enterprise-server-3230 "Direct link to Enterprise Server 3.23.0")
...
- Fix broken download links to artifacts stored in Azure ( [ClearML Server #247](https://github.com/clearml/clearml-server/issues/247))
...
- Fix UI pipeline DAG display to be "bottoms-up" so all final steps appear in the bottom of the diagram ( [ClearML Web PR #86](https://github.com/clearml/clearml-web/pull/86))
...
- [Enterprise Server 3.23.2](https://clear.ml/docs/latest/docs/release_notes/clearml_server/enterprise/ver_3_23/#enterprise-server-3232)
- [Enterprise Server 3.23.1](https://clear.ml/docs/latest/docs/release_notes/clearml_server/enterprise/ver_3_23/#enterprise-server-3231)
- [Enterprise Server 3.23.0](https://clear.ml/docs/latest/docs/release_notes/clearml_server/enterprise/ver_3_23/#enterprise-server-3230)