---
url: "https://clear.ml/docs/latest/docs/integrations/catboost/"
title: "CatBoost | ClearML"
---

[Skip to main content](https://clear.ml/docs/latest/docs/integrations/catboost/#__docusaurus_skipToContent_fallback)
...
See an example of CatBoost and ClearML in action [here](https://clear.ml/docs/latest/docs/guides/frameworks/catboost/).
...
## Automatic Logging Control [​](https://clear.ml/docs/latest/docs/integrations/catboost/\#automatic-logging-control "Direct link to Automatic Logging Control")
...
## Manual Logging [​](https://clear.ml/docs/latest/docs/integrations/catboost/\#manual-logging "Direct link to Manual Logging")
...
## Remote Execution [​](https://clear.ml/docs/latest/docs/integrations/catboost/\#remote-execution "Direct link to Remote Execution")
...
### Reproducing Task Runs [​](https://clear.ml/docs/latest/docs/integrations/catboost/\#reproducing-task-runs "Direct link to Reproducing Task Runs")
...
### Executing a Task Remotely [​](https://clear.ml/docs/latest/docs/integrations/catboost/\#executing-a-task-remotely "Direct link to Executing a Task Remotely")
...
## Hyperparameter Optimization [​](https://clear.ml/docs/latest/docs/integrations/catboost/\#hyperparameter-optimization "Direct link to Hyperparameter Optimization")
...
- [Automatic Logging Control](https://clear.ml/docs/latest/docs/integrations/catboost/#automatic-logging-control)
- [Manual Logging](https://clear.ml/docs/latest/docs/integrations/catboost/#manual-logging)
- [Remote Execution](https://clear.ml/docs/latest/docs/integrations/catboost/#remote-execution)
  - [Reproducing Task Runs](https://clear.ml/docs/latest/docs/integrations/catboost/#reproducing-task-runs)
  - [Executing a Task Remotely](https://clear.ml/docs/latest/docs/integrations/catboost/#executing-a-task-remotely)
- [Hyperparameter Optimization](https://clear.ml/docs/latest/docs/integrations/catboost/#hyperparameter-optimization)