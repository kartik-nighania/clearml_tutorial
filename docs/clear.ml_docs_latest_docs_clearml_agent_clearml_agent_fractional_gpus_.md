---
url: "https://clear.ml/docs/latest/docs/clearml_agent/clearml_agent_fractional_gpus/"
title: "Fractional GPUs | ClearML"
---

[Skip to main content](https://clear.ml/docs/latest/docs/clearml_agent/clearml_agent_fractional_gpus/#__docusaurus_skipToContent_fallback)
...
- [Dynamic GPU Slicing](https://clear.ml/docs/latest/docs/clearml_agent/clearml_agent_fractional_gpus/#dynamic-gpu-fractions): On-demand GPU slicing per task for both MIG and non-MIG devices ( **Available under the ClearML Enterprise plan**):
- [Container-based Memory Limits](https://clear.ml/docs/latest/docs/clearml_agent/clearml_agent_fractional_gpus/#container-based-memory-limits): Use pre-packaged containers with built-in memory
limits to run multiple containers on the same GPU ( **Available as part of the ClearML open source offering**)
- [Kubernetes-based Static MIG Slicing](https://clear.ml/docs/latest/docs/clearml_agent/clearml_agent_fractional_gpus/#kubernetes-static-mig-fractions): Set up Kubernetes support for NVIDIA MIG
(Multi-Instance GPU) to define GPU fractions for specific workloads ( **Available as part of the ClearML open source offering**)

## Dynamic GPU Fractions [​](https://clear.ml/docs/latest/docs/clearml_agent/clearml_agent_fractional_gpus/\#dynamic-gpu-fractions "Direct link to Dynamic GPU Fractions")
...
- [Bare metal / VM](https://clear.ml/docs/latest/docs/clearml_agent/clearml_agent_deployment_bare_metal)
- Kubernetes:
  - [ClearML Dynamic MIG Operator (CDMO)](https://clear.ml/docs/latest/docs/clearml_agent/fractional_gpus/cdmo) chart for MIG devices
  - [ClearML Fractional GPU Injector (CFGI)](https://clear.ml/docs/latest/docs/clearml_agent/fractional_gpus/cfgi) chart for non-MIG devices
  - [CDMO and CFGI on a shared cluster](https://clear.ml/docs/latest/docs/clearml_agent/fractional_gpus/cdmo_cfgi_same_cluster) for both MIG and non-MIG devices

![Fractional GPU diagram](https://clear.ml/docs/latest/assets/images/fractional_gpu_diagram-3b3eb25750b549fb1d03f7b9369ad717.png)

## Container-based Memory Limits [​](https://clear.ml/docs/latest/docs/clearml_agent/clearml_agent_fractional_gpus/\#container-based-memory-limits "Direct link to Container-based Memory Limits")
...
### Usage [​](https://clear.ml/docs/latest/docs/clearml_agent/clearml_agent_fractional_gpus/\#usage "Direct link to Usage")

#### Manual Execution [​](https://clear.ml/docs/latest/docs/clearml_agent/clearml_agent_fractional_gpus/\#manual-execution "Direct link to Manual Execution")
...
#### Remote Execution [​](https://clear.ml/docs/latest/docs/clearml_agent/clearml_agent_fractional_gpus/\#remote-execution "Direct link to Remote Execution")
...
![Task container](https://clear.ml/docs/latest/assets/images/fractional_gpu_task_container-3044933433a116557af3b7207636afcc.png#light-mode-only)![Task container](https://clear.ml/docs/latest/assets/images/fractional_gpu_task_container_dark-f65c110c1c71badd2cb5faa18f9e5fe1.png#dark-mode-only)
...
#### Fractional GPU Containers on Kubernetes [​](https://clear.ml/docs/latest/docs/clearml_agent/clearml_agent_fractional_gpus/\#fractional-gpu-containers-on-kubernetes "Direct link to Fractional GPU Containers on Kubernetes")
...
### Custom Container [​](https://clear.ml/docs/latest/docs/clearml_agent/clearml_agent_fractional_gpus/\#custom-container "Direct link to Custom Container")
...
## Kubernetes Static MIG Fractions [​](https://clear.ml/docs/latest/docs/clearml_agent/clearml_agent_fractional_gpus/\#kubernetes-static-mig-fractions "Direct link to Kubernetes Static MIG Fractions")
...
- [Dynamic GPU Fractions](https://clear.ml/docs/latest/docs/clearml_agent/clearml_agent_fractional_gpus/#dynamic-gpu-fractions)
- [Container-based Memory Limits](https://clear.ml/docs/latest/docs/clearml_agent/clearml_agent_fractional_gpus/#container-based-memory-limits)
  - [Usage](https://clear.ml/docs/latest/docs/clearml_agent/clearml_agent_fractional_gpus/#usage)
  - [Custom Container](https://clear.ml/docs/latest/docs/clearml_agent/clearml_agent_fractional_gpus/#custom-container)
- [Kubernetes Static MIG Fractions](https://clear.ml/docs/latest/docs/clearml_agent/clearml_agent_fractional_gpus/#kubernetes-static-mig-fractions)