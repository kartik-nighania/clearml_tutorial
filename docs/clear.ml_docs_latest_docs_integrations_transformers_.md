---
url: "https://clear.ml/docs/latest/docs/integrations/transformers/"
title: "Transformers | ClearML"
---

[Skip to main content](https://clear.ml/docs/latest/docs/integrations/transformers/#__docusaurus_skipToContent_fallback)
...
All of this is captured into a [ClearML Task](https://clear.ml/docs/latest/docs/fundamentals/task). By default, a task called `Trainer` is created
...
Additionally, you can view all of your Transformers runs tracked by ClearML in the [Task Table](https://clear.ml/docs/latest/docs/webapp/webapp_model_table).
...
See an example of Transformers and ClearML in action [here](https://clear.ml/docs/latest/docs/guides/frameworks/huggingface/transformers).

## Remote Execution [​](https://clear.ml/docs/latest/docs/integrations/transformers/\#remote-execution "Direct link to Remote Execution")
...
### Reproducing Task Runs [​](https://clear.ml/docs/latest/docs/integrations/transformers/\#reproducing-task-runs "Direct link to Reproducing Task Runs")
...
1. Clone the task
2. Edit the hyperparameters and/or other details.
3. In the **CONFIGURATION > HYPERPARAMETERS > Transformers** section, set both `_ignore_hparams_ui_overrides_` and `_ignore_model_config_ui_overrides_`
...
## Hyperparameter Optimization [​](https://clear.ml/docs/latest/docs/integrations/transformers/\#hyperparameter-optimization "Direct link to Hyperparameter Optimization")
...
- [Remote Execution](https://clear.ml/docs/latest/docs/integrations/transformers/#remote-execution)
  - [Reproducing Task Runs](https://clear.ml/docs/latest/docs/integrations/transformers/#reproducing-task-runs)
- [Hyperparameter Optimization](https://clear.ml/docs/latest/docs/integrations/transformers/#hyperparameter-optimization)