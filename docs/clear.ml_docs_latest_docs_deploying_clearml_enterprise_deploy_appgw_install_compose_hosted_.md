---
url: "https://clear.ml/docs/latest/docs/deploying_clearml/enterprise_deploy/appgw_install_compose_hosted/"
title: "Docker-Compose - Hosted Server | ClearML"
---

[Skip to main content](https://clear.ml/docs/latest/docs/deploying_clearml/enterprise_deploy/appgw_install_compose_hosted/#__docusaurus_skipToContent_fallback)
...
## Requirements [​](https://clear.ml/docs/latest/docs/deploying_clearml/enterprise_deploy/appgw_install_compose_hosted/\#requirements "Direct link to Requirements")
...
## Host Configuration [​](https://clear.ml/docs/latest/docs/deploying_clearml/enterprise_deploy/appgw_install_compose_hosted/\#host-configuration "Direct link to Host Configuration")

### Docker Installation [​](https://clear.ml/docs/latest/docs/deploying_clearml/enterprise_deploy/appgw_install_compose_hosted/\#docker-installation "Direct link to Docker Installation")
...
### Docker-compose File [​](https://clear.ml/docs/latest/docs/deploying_clearml/enterprise_deploy/appgw_install_compose_hosted/\#docker-compose-file "Direct link to Docker-compose File")
...
### Configuration File [​](https://clear.ml/docs/latest/docs/deploying_clearml/enterprise_deploy/appgw_install_compose_hosted/\#configuration-file "Direct link to Configuration File")
...
- `ROUTER_NAME`: In the case of [multiple routers on the same tenant](https://clear.ml/docs/latest/docs/deploying_clearml/enterprise_deploy/appgw_install_compose_hosted/#multiple-router-in-the-same-tenant), each router
...
### Installation [​](https://clear.ml/docs/latest/docs/deploying_clearml/enterprise_deploy/appgw_install_compose_hosted/\#installation "Direct link to Installation")
...
required. See [Migrating the AI App Gateway to Non-Root Images](https://clear.ml/docs/latest/docs/deploying_clearml/enterprise_deploy/appgw_migrate_nonroot) for details.

### Advanced Configuration [​](https://clear.ml/docs/latest/docs/deploying_clearml/enterprise_deploy/appgw_install_compose_hosted/\#advanced-configuration "Direct link to Advanced Configuration")

#### Using Open HTTP [​](https://clear.ml/docs/latest/docs/deploying_clearml/enterprise_deploy/appgw_install_compose_hosted/\#using-open-http "Direct link to Using Open HTTP")
...
#### Multiple Router in the Same Tenant [​](https://clear.ml/docs/latest/docs/deploying_clearml/enterprise_deploy/appgw_install_compose_hosted/\#multiple-router-in-the-same-tenant "Direct link to Multiple Router in the Same Tenant")
...
##### Example Configuration [​](https://clear.ml/docs/latest/docs/deploying_clearml/enterprise_deploy/appgw_install_compose_hosted/\#example-configuration "Direct link to Example Configuration")
...
Make sure `LISTEN_QUEUE_NAME` is set in the [`docker-compose` environment variables](https://clear.ml/docs/latest/docs/deploying_clearml/enterprise_deploy/appgw_install_compose_hosted/#docker-compose-file) for each router instance.

## Monitoring and Testing the Gateway [​](https://clear.ml/docs/latest/docs/deploying_clearml/enterprise_deploy/appgw_install_compose_hosted/\#monitoring-and-testing-the-gateway "Direct link to Monitoring and Testing the Gateway")
...
- [Requirements](https://clear.ml/docs/latest/docs/deploying_clearml/enterprise_deploy/appgw_install_compose_hosted/#requirements)
- [Host Configuration](https://clear.ml/docs/latest/docs/deploying_clearml/enterprise_deploy/appgw_install_compose_hosted/#host-configuration)
  - [Docker Installation](https://clear.ml/docs/latest/docs/deploying_clearml/enterprise_deploy/appgw_install_compose_hosted/#docker-installation)
  - [Docker-compose File](https://clear.ml/docs/latest/docs/deploying_clearml/enterprise_deploy/appgw_install_compose_hosted/#docker-compose-file)
  - [Configuration File](https://clear.ml/docs/latest/docs/deploying_clearml/enterprise_deploy/appgw_install_compose_hosted/#configuration-file)
  - [Installation](https://clear.ml/docs/latest/docs/deploying_clearml/enterprise_deploy/appgw_install_compose_hosted/#installation)
  - [Advanced Configuration](https://clear.ml/docs/latest/docs/deploying_clearml/enterprise_deploy/appgw_install_compose_hosted/#advanced-configuration)
- [Monitoring and Testing the Gateway](https://clear.ml/docs/latest/docs/deploying_clearml/enterprise_deploy/appgw_install_compose_hosted/#monitoring-and-testing-the-gateway)