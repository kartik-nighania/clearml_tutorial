---
url: "https://clear.ml/docs/latest/docs/release_notes/sdk/open_source/ver_1_2/"
title: "Version 1.2 | ClearML"
---

[Skip to main content](https://clear.ml/docs/latest/docs/release_notes/sdk/open_source/ver_1_2/#__docusaurus_skipToContent_fallback)

If you ❤️ ️ **ClearML**, ⭐️ us on [GitHub](https://github.com/clearml/clearml)!

On this page

### ClearML 1.2.1 [​](https://clear.ml/docs/latest/docs/release_notes/sdk/open_source/ver_1_2/\#clearml-121 "Direct link to ClearML 1.2.1")

**Bug Fix**

- Fix HTTP download fails constructing URL ( [#593](https://github.com/clearml/clearml/issues/593))

### ClearML 1.2.0 [​](https://clear.ml/docs/latest/docs/release_notes/sdk/open_source/ver_1_2/\#clearml-120 "Direct link to ClearML 1.2.0")
...
- Fix extra\_layout not passed to report\_matrix ( [#559](https://github.com/clearml/clearml/issues/559))
...
- [ClearML 1.2.1](https://clear.ml/docs/latest/docs/release_notes/sdk/open_source/ver_1_2/#clearml-121)
- [ClearML 1.2.0](https://clear.ml/docs/latest/docs/release_notes/sdk/open_source/ver_1_2/#clearml-120)