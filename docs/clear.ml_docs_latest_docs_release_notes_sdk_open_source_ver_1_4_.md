---
url: "https://clear.ml/docs/latest/docs/release_notes/sdk/open_source/ver_1_4/"
title: "Version 1.4 | ClearML"
---

[Skip to main content](https://clear.ml/docs/latest/docs/release_notes/sdk/open_source/ver_1_4/#__docusaurus_skipToContent_fallback)

If you ❤️ ️ **ClearML**, ⭐️ us on [GitHub](https://github.com/clearml/clearml)!

On this page

### ClearML 1.4.1 [​](https://clear.ml/docs/latest/docs/release_notes/sdk/open_source/ver_1_4/\#clearml-141 "Direct link to ClearML 1.4.1")

**Bug Fix**

- Fix Process Pool hangs at exit ( [#674](https://github.com/clearml/clearml/issues/674))

### ClearML 1.4.0 [​](https://clear.ml/docs/latest/docs/release_notes/sdk/open_source/ver_1_4/\#clearml-140 "Direct link to ClearML 1.4.0")
...
- Add wildcard support for model auto-logging, see [`Task.init()`](https://clear.ml/docs/latest/docs/references/sdk/task#taskinit)
...
- [ClearML 1.4.1](https://clear.ml/docs/latest/docs/release_notes/sdk/open_source/ver_1_4/#clearml-141)
- [ClearML 1.4.0](https://clear.ml/docs/latest/docs/release_notes/sdk/open_source/ver_1_4/#clearml-140)