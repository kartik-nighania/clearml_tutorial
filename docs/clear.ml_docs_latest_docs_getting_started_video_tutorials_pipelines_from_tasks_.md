---
url: "https://clear.ml/docs/latest/docs/getting_started/video_tutorials/pipelines_from_tasks/"
title: "Pipelines from Tasks | ClearML"
---

[Skip to main content](https://clear.ml/docs/latest/docs/getting_started/video_tutorials/pipelines_from_tasks/#__docusaurus_skipToContent_fallback)

If you ❤️ ️ **ClearML**, ⭐️ us on [GitHub](https://github.com/clearml/clearml)!

On this page

## Video Tutorial [​](https://clear.ml/docs/latest/docs/getting_started/video_tutorials/pipelines_from_tasks/\#video-tutorial "Direct link to Video Tutorial")

7 - Pipelines from tasks - YouTube

Tap to unmute

[7 - Pipelines from tasks](https://www.youtube.com/watch?v=prZ_eiv_y3c) [ClearML](https://www.youtube.com/channel/UCDYdA4hjckRLRVBrCoKenCQ)
...
- [Video Tutorial](https://clear.ml/docs/latest/docs/getting_started/video_tutorials/pipelines_from_tasks/#video-tutorial)