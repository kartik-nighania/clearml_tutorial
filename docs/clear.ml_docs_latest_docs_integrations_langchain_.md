---
url: "https://clear.ml/docs/latest/docs/integrations/langchain/"
title: "LangChain | ClearML"
---

[Skip to main content](https://clear.ml/docs/latest/docs/integrations/langchain/#__docusaurus_skipToContent_fallback)
...
1. Set up the `ClearMLCallbackHandler`. The following code creates a [ClearML Task](https://clear.ml/docs/latest/docs/fundamentals/task) called
...
You can also pass the following parameters to the `ClearMLCallbackHandler` object:
   - `task_type` – The type of ClearML task to create (see [task types](https://clear.ml/docs/latest/docs/fundamentals/task#task-types))
...
2. Use `ClearMLCallbackHandler.flush_tracker()` after each model request to make sure all outputs, including metrics and
...
## Additional Logging Options [​](https://clear.ml/docs/latest/docs/integrations/langchain/\#additional-logging-options "Direct link to Additional Logging Options")
...
- [Additional Logging Options](https://clear.ml/docs/latest/docs/integrations/langchain/#additional-logging-options)