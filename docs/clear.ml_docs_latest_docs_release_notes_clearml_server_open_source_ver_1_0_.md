---
url: "https://clear.ml/docs/latest/docs/release_notes/clearml_server/open_source/ver_1_0/"
title: "Version 1.0 | ClearML"
---

[Skip to main content](https://clear.ml/docs/latest/docs/release_notes/clearml_server/open_source/ver_1_0/#__docusaurus_skipToContent_fallback)

If you ❤️ ️ **ClearML**, ⭐️ us on [GitHub](https://github.com/clearml/clearml)!

On this page

### ClearML Server 1.0.2 [​](https://clear.ml/docs/latest/docs/release_notes/clearml_server/open_source/ver_1_0/\#clearml-server-102 "Direct link to ClearML Server 1.0.2")
...
### ClearML Server 1.0.1 [​](https://clear.ml/docs/latest/docs/release_notes/clearml_server/open_source/ver_1_0/\#clearml-server-101 "Direct link to ClearML Server 1.0.1")
...
### ClearML Server 1.0.0 [​](https://clear.ml/docs/latest/docs/release_notes/clearml_server/open_source/ver_1_0/\#clearml-server-100 "Direct link to ClearML Server 1.0.0")
...
- Add Context menu batch operations ( [ClearML #286](https://github.com/clearml/clearml/issues/286))
- Add global search regex support ( [ClearML #81](https://github.com/clearml/clearml/issues/81#issuecomment-735003956))
...
- Add deleting experiments and models through UI (ClearML [#53](https://github.com/clearml/clearml-server/issues/53), [#61](https://github.com/clearml/clearml-server/issues/61), and [#81](https://github.com/clearml/clearml/issues/81#issuecomment-706907718))
...
- Add Full project name display in project cards ( [ClearML #81](https://github.com/clearml/clearml/issues/81#issuecomment-823303842))
...
- Fix UI custom columns choice does not persist per project ( [ClearML #314](https://github.com/clearml/clearml/issues/314))
- Fix API plot\_str not returned for compressed plots
...
- Fix UI X-axis labels are being cut in plots ( [ClearML #264](https://github.com/clearml/clearml/issues/264))
- Fix UI scalar color choice dialog toggles between screen positions every time you open it
- Fix UI hovering on legend clears parallel coordinates graph filters ( [ClearML #259](https://github.com/clearml/clearml/issues/259))
...
- [ClearML Server 1.0.2](https://clear.ml/docs/latest/docs/release_notes/clearml_server/open_source/ver_1_0/#clearml-server-102)
- [ClearML Server 1.0.1](https://clear.ml/docs/latest/docs/release_notes/clearml_server/open_source/ver_1_0/#clearml-server-101)
- [ClearML Server 1.0.0](https://clear.ml/docs/latest/docs/release_notes/clearml_server/open_source/ver_1_0/#clearml-server-100)