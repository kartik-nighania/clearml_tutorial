...
## _class_ InputModel(model\_id=None, name=None, project=None, tags=None, only\_published=False) [​](https://clear.ml/docs/latest/docs/references/sdk/model_inputmodel/\#class-inputmodelmodel_idnone-namenone-projectnone-tagsnone-only_publishedfalse "Direct link to class-inputmodelmodel_idnone-namenone-projectnone-tagsnone-only_publishedfalse")
...
- **Parameters**
  - **model\_id** (`Optional`\[`str`\]) – The ClearML ID (system UUID) of the input model whose metadata the **ClearML Server**
  ...
  - **only\_published** (`bool`) – If `True`, filter out non-published (draft) models.

* * *

### archive [​](https://clear.ml/docs/latest/docs/references/sdk/model_inputmodel/\#archive "Direct link to archive")
...
### comment [​](https://clear.ml/docs/latest/docs/references/sdk/model_inputmodel/\#comment "Direct link to comment")
...
### config\_dict [​](https://clear.ml/docs/latest/docs/references/sdk/model_inputmodel/\#config_dict "Direct link to config_dict")
...
### config\_text [​](https://clear.ml/docs/latest/docs/references/sdk/model_inputmodel/\#config_text "Direct link to config_text")
...
### connect [​](https://clear.ml/docs/latest/docs/references/sdk/model_inputmodel/\#connect "Direct link to connect")
...
- **Parameters**
  - **task** ( [_Task_](https://clear.ml/docs/latest/docs/references/sdk/task#clearml.Task)) – The Task object to connect to.

  - **ignore\_remote\_overrides** (`bool`) – If `True`, UI/backend model changes are ignored during remote execution.
    Defaults to `False`, meaning that any changes made in the UI/backend will be applied in remote execution.

  - **name** (`Optional`\[`str`\]) – The name under which this model appears on the Task.
...
### InputModel.empty [​](https://clear.ml/docs/latest/docs/references/sdk/model_inputmodel/\#inputmodelempty "Direct link to InputModel.empty")
...
- **Parameters**
  ...
  - **config\_text** (`Optional`\[`str`\]) – The model configuration as a string.
    This is usually the content of a configuration dictionary file.
    Specify `config_text` or `config_dict`, but not both.

  - **config\_dict** (`Optional`\[`dict`\]) – The model configuration as a dictionary.
    Specify `config_text` or `config_dict`, but not both.

  - **label\_enumeration** (`Optional`\[`Mapping`\[`str`, `int`\]\]) – The label enumeration dictionary of string (label) to integer (value) pairs.
    For example:
...
### framework [​](https://clear.ml/docs/latest/docs/references/sdk/model_inputmodel/\#framework "Direct link to framework")
...
### get\_all\_metadata [​](https://clear.ml/docs/latest/docs/references/sdk/model_inputmodel/\#get_all_metadata "Direct link to get_all_metadata")
...
### get\_all\_metadata\_casted [​](https://clear.ml/docs/latest/docs/references/sdk/model_inputmodel/\#get_all_metadata_casted "Direct link to get_all_metadata_casted")
...
### get\_local\_copy [​](https://clear.ml/docs/latest/docs/references/sdk/model_inputmodel/\#get_local_copy "Direct link to get_local_copy")
...
### get\_metadata [​](https://clear.ml/docs/latest/docs/references/sdk/model_inputmodel/\#get_metadata "Direct link to get_metadata")
...
### get\_metadata\_casted [​](https://clear.ml/docs/latest/docs/references/sdk/model_inputmodel/\#get_metadata_casted "Direct link to get_metadata_casted")
...
### get\_weights [​](https://clear.ml/docs/latest/docs/references/sdk/model_inputmodel/\#get_weights "Direct link to get_weights")
...
### get\_weights\_package [​](https://clear.ml/docs/latest/docs/references/sdk/model_inputmodel/\#get_weights_package "Direct link to get_weights_package")
...
### id [​](https://clear.ml/docs/latest/docs/references/sdk/model_inputmodel/\#id "Direct link to id")
...
### InputModel.import\_model [​](https://clear.ml/docs/latest/docs/references/sdk/model_inputmodel/\#inputmodelimport_model "Direct link to InputModel.import_model")
...
- **Parameters**
  ...
  - **weights\_url** (`str`) – URL of the weights file. If the URL is already registered in ClearML, the existing model
  ...
  - **config\_text** (`Optional`\[`str`\]) – Model configuration as a string. This is usually the content of a configuration
    dictionary file. Specify `config_text` or `config_dict`, but not both.

  - **config\_dict** (`Optional`\[`dict`\]) – Model configuration as a dictionary. Specify `config_text` or `config_dict`,
    but not both.

  - **label\_enumeration** (`Optional`\[`Mapping`\[`str`, `int`\]\]) – Optional label enumeration dictionary of string (label) to integer (value) pairs.
...
```
  ...
  - **name** (`Optional`\[`str`\]) – Name of the imported model.

  - **project** (`Optional`\[`str`\]) – Project to add the model to.

  - **tags** (`Optional`\[`List`\[`str`\]\]) – List of tags which describe the model.

  - **comment** (`Optional`\[`str`\]) – A comment / description for the model.

  - **is\_package** (`bool`) – If `True`, adds a package tag to the model. Defaults to `False`.

  - **create\_as\_published** (`bool`) – If `True`, sets the model status to “Published” immediately. Defaults to `False`,
    the status will be Draft

  - **framework** (`Optional`\[`str`\]) – The framework of the model
- **Return type**
...
### labels [​](https://clear.ml/docs/latest/docs/references/sdk/model_inputmodel/\#labels "Direct link to labels")
...
### InputModel.load\_model [​](https://clear.ml/docs/latest/docs/references/sdk/model_inputmodel/\#inputmodelload_model "Direct link to InputModel.load_model")
...
- **Parameters**
  - **weights\_url** (`str`) – URL of the weights file. Examples:
    - `"https://domain.com/file.bin"`

    - `"s3://bucket/file.bin"`

    - `"file:///home/user/file.bin"`
  - **load\_archived** (`bool`) – If `True`, include archived models in the search. Defaults to `False`.
- **Return type**
...
### name [​](https://clear.ml/docs/latest/docs/references/sdk/model_inputmodel/\#name "Direct link to name")
...
### original\_task [​](https://clear.ml/docs/latest/docs/references/sdk/model_inputmodel/\#original_task "Direct link to original_task")
...
### project [​](https://clear.ml/docs/latest/docs/references/sdk/model_inputmodel/\#project "Direct link to project")
...
### publish [​](https://clear.ml/docs/latest/docs/references/sdk/model_inputmodel/\#publish "Direct link to publish")
...
### published [​](https://clear.ml/docs/latest/docs/references/sdk/model_inputmodel/\#published "Direct link to published")
...
### InputModel.query\_models [​](https://clear.ml/docs/latest/docs/references/sdk/model_inputmodel/\#inputmodelquery_models "Direct link to InputModel.query_models")
...
### InputModel.remove [​](https://clear.ml/docs/latest/docs/references/sdk/model_inputmodel/\#inputmodelremove "Direct link to InputModel.remove")
...
- **Parameters**
  - **model** (`Union`\[`str`, [`Model`](https://clear.ml/docs/latest/docs/references/sdk/model_model#clearml.Model)\]) – Model ID or Model object to remove.
...
### report\_confusion\_matrix [​](https://clear.ml/docs/latest/docs/references/sdk/model_inputmodel/\#report_confusion_matrix "Direct link to report_confusion_matrix")
...
### report\_histogram [​](https://clear.ml/docs/latest/docs/references/sdk/model_inputmodel/\#report_histogram "Direct link to report_histogram")
...
### report\_line\_plot [​](https://clear.ml/docs/latest/docs/references/sdk/model_inputmodel/\#report_line_plot "Direct link to report_line_plot")
...
### report\_matrix [​](https://clear.ml/docs/latest/docs/references/sdk/model_inputmodel/\#report_matrix "Direct link to report_matrix")
...
### report\_scalar [​](https://clear.ml/docs/latest/docs/references/sdk/model_inputmodel/\#report_scalar "Direct link to report_scalar")
...
### report\_scatter2d [​](https://clear.ml/docs/latest/docs/references/sdk/model_inputmodel/\#report_scatter2d "Direct link to report_scatter2d")
...
### report\_scatter3d [​](https://clear.ml/docs/latest/docs/references/sdk/model_inputmodel/\#report_scatter3d "Direct link to report_scatter3d")
...
### report\_single\_value [​](https://clear.ml/docs/latest/docs/references/sdk/model_inputmodel/\#report_single_value "Direct link to report_single_value")
...
### report\_surface [​](https://clear.ml/docs/latest/docs/references/sdk/model_inputmodel/\#report_surface "Direct link to report_surface")
...
### report\_table [​](https://clear.ml/docs/latest/docs/references/sdk/model_inputmodel/\#report_table "Direct link to report_table")
...
### report\_vector [​](https://clear.ml/docs/latest/docs/references/sdk/model_inputmodel/\#report_vector "Direct link to report_vector")
...
### set\_all\_metadata [​](https://clear.ml/docs/latest/docs/references/sdk/model_inputmodel/\#set_all_metadata "Direct link to set_all_metadata")
...
### set\_metadata [​](https://clear.ml/docs/latest/docs/references/sdk/model_inputmodel/\#set_metadata "Direct link to set_metadata")
...
### system\_tags [​](https://clear.ml/docs/latest/docs/references/sdk/model_inputmodel/\#system_tags "Direct link to system_tags")
...
### tags [​](https://clear.ml/docs/latest/docs/references/sdk/model_inputmodel/\#tags "Direct link to tags")
...
### task [​](https://clear.ml/docs/latest/docs/references/sdk/model_inputmodel/\#task "Direct link to task")
...
### unarchive [​](https://clear.ml/docs/latest/docs/references/sdk/model_inputmodel/\#unarchive "Direct link to unarchive")
...
### url [​](https://clear.ml/docs/latest/docs/references/sdk/model_inputmodel/\#url "Direct link to url")
