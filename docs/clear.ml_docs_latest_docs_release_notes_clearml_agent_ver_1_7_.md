---
url: "https://clear.ml/docs/latest/docs/release_notes/clearml_agent/ver_1_7/"
title: "Version 1.7 | ClearML"
---

[Skip to main content](https://clear.ml/docs/latest/docs/release_notes/clearml_agent/ver_1_7/#__docusaurus_skipToContent_fallback)

If you ❤️ ️ **ClearML**, ⭐️ us on [GitHub](https://github.com/clearml/clearml)!

On this page

### ClearML Agent 1.7.0 [​](https://clear.ml/docs/latest/docs/release_notes/clearml_agent/ver_1_7/\#clearml-agent-170 "Direct link to ClearML Agent 1.7.0")
...
- Fix `agent.package_manager.poetry_install_extra_args` are used in all Poetry commands and not just in `install` ( [#173](https://github.com/clearml/clearml-agent/issues/173))
...
- [ClearML Agent 1.7.0](https://clear.ml/docs/latest/docs/release_notes/clearml_agent/ver_1_7/#clearml-agent-170)