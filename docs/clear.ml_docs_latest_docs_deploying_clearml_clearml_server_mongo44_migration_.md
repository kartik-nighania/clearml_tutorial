---
url: "https://clear.ml/docs/latest/docs/deploying_clearml/clearml_server_mongo44_migration/"
title: "Upgrading Server from v1.1 or Older | ClearML"
---

[Skip to main content](https://clear.ml/docs/latest/docs/deploying_clearml/clearml_server_mongo44_migration/#__docusaurus_skipToContent_fallback)
...
If your server is v0.15 or older, you must first go through the [v0.16 upgrade procedure](https://clear.ml/docs/latest/docs/deploying_clearml/clearml_server_es7_migration)
...
## Prerequisites [​](https://clear.ml/docs/latest/docs/deploying_clearml/clearml_server_mongo44_migration/\#prerequisites "Direct link to Prerequisites")
...
## Before You Begin [​](https://clear.ml/docs/latest/docs/deploying_clearml/clearml_server_mongo44_migration/\#before-you-begin "Direct link to Before You Begin")
...
## Migrating the Data [​](https://clear.ml/docs/latest/docs/deploying_clearml/clearml_server_mongo44_migration/\#migrating-the-data "Direct link to Migrating the Data")

### Migrating by Script [​](https://clear.ml/docs/latest/docs/deploying_clearml/clearml_server_mongo44_migration/\#migrating-by-script "Direct link to Migrating by Script")
...
Once the script finishes successfully, [continue with your upgrade](https://clear.ml/docs/latest/docs/deploying_clearml/clearml_server_mongo44_migration/#completing-the-installation).

### Manual migration [​](https://clear.ml/docs/latest/docs/deploying_clearml/clearml_server_mongo44_migration/\#manual-migration "Direct link to Manual migration")
...
01. Backup the source data folder:
...
02. Copy the data to the new folder and set permissions (permissions are required on Linux):
...
03. Run the mongo 4.0 container:
...
05. Stop the mongo 4.0 container:
...
06. Run the mongo 4.2 container:
...
08. Stop the mongo 4.2 container:
...
09. Run the mongo 4.4 container:
...
## Completing the Installation [​](https://clear.ml/docs/latest/docs/deploying_clearml/clearml_server_mongo44_migration/\#completing-the-installation "Direct link to Completing the Installation")
...
- [Google Cloud Platform custom images](https://clear.ml/docs/latest/docs/deploying_clearml/upgrade_server_gcp)
- [Linux and macOS](https://clear.ml/docs/latest/docs/deploying_clearml/upgrade_server_linux_mac)
- [Windows](https://clear.ml/docs/latest/docs/deploying_clearml/upgrade_server_win)

- [Prerequisites](https://clear.ml/docs/latest/docs/deploying_clearml/clearml_server_mongo44_migration/#prerequisites)
- [Before You Begin](https://clear.ml/docs/latest/docs/deploying_clearml/clearml_server_mongo44_migration/#before-you-begin)
- [Migrating the Data](https://clear.ml/docs/latest/docs/deploying_clearml/clearml_server_mongo44_migration/#migrating-the-data)
  - [Migrating by Script](https://clear.ml/docs/latest/docs/deploying_clearml/clearml_server_mongo44_migration/#migrating-by-script)
  - [Manual migration](https://clear.ml/docs/latest/docs/deploying_clearml/clearml_server_mongo44_migration/#manual-migration)
- [Completing the Installation](https://clear.ml/docs/latest/docs/deploying_clearml/clearml_server_mongo44_migration/#completing-the-installation)