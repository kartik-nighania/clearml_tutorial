---
url: "https://clear.ml/docs/latest/docs/webapp/applications/apps_streamlit/"
title: "Streamlit Launcher | ClearML"
---

[Skip to main content](https://clear.ml/docs/latest/docs/webapp/applications/apps_streamlit/#__docusaurus_skipToContent_fallback)
...
Once you start a Streamlit launcher instance, you will be provided with an [externally accessible link](https://clear.ml/docs/latest/docs/webapp/applications/apps_streamlit/#traffic_router) to your Streamlit app,
...
- Streamlit App status indicator
  - ![Active server](https://clear.ml/docs/latest/icons/ico-streamlit-active.svg) \- App is running and is actively in use
  - ![Loading server](https://clear.ml/docs/latest/icons/ico-streamlit-loading.svg) \- App is setting up
  - ![Idle server](https://clear.ml/docs/latest/icons/ico-streamlit-idle.svg) \- App is idle
  - ![Stopped server](https://clear.ml/docs/latest/icons/ico-streamlit-stopped.svg) \- App is stopped
- Idle time
- Streamlit App - Externally accessible link to your Streamlit app. You can send this link to your colleagues, so they can
access the app. Click ![Copy](https://clear.ml/docs/latest/icons/ico-copy-to-clipboard.svg)
to copy link
...
![Streamlit Dashboard](https://clear.ml/docs/latest/assets/images/apps_streamlit-d933371174dc83db7a78e6cb27eb8993.png#light-mode-only)![Streamlit Dashboard](https://clear.ml/docs/latest/assets/images/apps_streamlit_dark-173bc7edffe13fdcf22c0ffe5717f96d.png#dark-mode-only)

## Streamlit Launcher Instance Configuration [​](https://clear.ml/docs/latest/docs/webapp/applications/apps_streamlit/\#streamlit-launcher-instance-configuration "Direct link to Streamlit Launcher Instance Configuration")
...
### Configuration Options [​](https://clear.ml/docs/latest/docs/webapp/applications/apps_streamlit/\#configuration-options "Direct link to Configuration Options")
...
- **Queue** \- The [ClearML Queue](https://clear.ml/docs/latest/docs/fundamentals/agents_and_queues#what-is-a-queue) to which the Streamlit launcher
...
![Streamlit launch form](https://clear.ml/docs/latest/assets/images/apps_streamlit_form-b4b2cd79925209f3ebaa39b6fb9305ff.png#light-mode-only)![Streamlit launch form](https://clear.ml/docs/latest/assets/images/apps_streamlit_form_dark-b3668037ee75a47d323b6a200239c22c.png#dark-mode-only)

- [Streamlit Launcher Instance Configuration](https://clear.ml/docs/latest/docs/webapp/applications/apps_streamlit/#streamlit-launcher-instance-configuration)
  - [Configuration Options](https://clear.ml/docs/latest/docs/webapp/applications/apps_streamlit/#configuration-options)