---
url: "https://clear.ml/docs/latest/docs/release_notes/clearml_server/enterprise/ver_3_24/"
title: "Version 3.24 | ClearML"
---

[Skip to main content](https://clear.ml/docs/latest/docs/release_notes/clearml_server/enterprise/ver_3_24/#__docusaurus_skipToContent_fallback)

If you ❤️ ️ **ClearML**, ⭐️ us on [GitHub](https://github.com/clearml/clearml)!

On this page

### Enterprise Server 3.24.7 [​](https://clear.ml/docs/latest/docs/release_notes/clearml_server/enterprise/ver_3_24/\#enterprise-server-3247 "Direct link to Enterprise Server 3.24.7")

**Bug Fix**

- Fix duplicate emails can be added to user list

### Enterprise Server 3.24.6 [​](https://clear.ml/docs/latest/docs/release_notes/clearml_server/enterprise/ver_3_24/\#enterprise-server-3246 "Direct link to Enterprise Server 3.24.6")

**Bug Fix**

- Fix setting a service account as admin navigates to incorrect page

### Enterprise Server 3.24.5 [​](https://clear.ml/docs/latest/docs/release_notes/clearml_server/enterprise/ver_3_24/\#enterprise-server-3245 "Direct link to Enterprise Server 3.24.5")

**New Feature**

- Add configuration option to disable automatic upgrade of database files when Mongo DB is updated

### Enterprise Server 3.24.4 [​](https://clear.ml/docs/latest/docs/release_notes/clearml_server/enterprise/ver_3_24/\#enterprise-server-3244 "Direct link to Enterprise Server 3.24.4")
...
### Enterprise Server 3.24.3 [​](https://clear.ml/docs/latest/docs/release_notes/clearml_server/enterprise/ver_3_24/\#enterprise-server-3243 "Direct link to Enterprise Server 3.24.3")
...
### Enterprise Server 3.24.2 [​](https://clear.ml/docs/latest/docs/release_notes/clearml_server/enterprise/ver_3_24/\#enterprise-server-3242 "Direct link to Enterprise Server 3.24.2")
...
### Enterprise Server 3.24.1 [​](https://clear.ml/docs/latest/docs/release_notes/clearml_server/enterprise/ver_3_24/\#enterprise-server-3241 "Direct link to Enterprise Server 3.24.1")
...
### Enterprise Server 3.24.0 [​](https://clear.ml/docs/latest/docs/release_notes/clearml_server/enterprise/ver_3_24/\#enterprise-server-3240 "Direct link to Enterprise Server 3.24.0")
...
- [Enterprise Server 3.24.7](https://clear.ml/docs/latest/docs/release_notes/clearml_server/enterprise/ver_3_24/#enterprise-server-3247)
- [Enterprise Server 3.24.6](https://clear.ml/docs/latest/docs/release_notes/clearml_server/enterprise/ver_3_24/#enterprise-server-3246)
- [Enterprise Server 3.24.5](https://clear.ml/docs/latest/docs/release_notes/clearml_server/enterprise/ver_3_24/#enterprise-server-3245)
- [Enterprise Server 3.24.4](https://clear.ml/docs/latest/docs/release_notes/clearml_server/enterprise/ver_3_24/#enterprise-server-3244)
- [Enterprise Server 3.24.3](https://clear.ml/docs/latest/docs/release_notes/clearml_server/enterprise/ver_3_24/#enterprise-server-3243)
- [Enterprise Server 3.24.2](https://clear.ml/docs/latest/docs/release_notes/clearml_server/enterprise/ver_3_24/#enterprise-server-3242)
- [Enterprise Server 3.24.1](https://clear.ml/docs/latest/docs/release_notes/clearml_server/enterprise/ver_3_24/#enterprise-server-3241)
- [Enterprise Server 3.24.0](https://clear.ml/docs/latest/docs/release_notes/clearml_server/enterprise/ver_3_24/#enterprise-server-3240)