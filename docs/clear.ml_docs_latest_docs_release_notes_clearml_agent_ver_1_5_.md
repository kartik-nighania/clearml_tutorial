---
url: "https://clear.ml/docs/latest/docs/release_notes/clearml_agent/ver_1_5/"
title: "Version 1.5 | ClearML"
---

[Skip to main content](https://clear.ml/docs/latest/docs/release_notes/clearml_agent/ver_1_5/#__docusaurus_skipToContent_fallback)

If you ❤️ ️ **ClearML**, ⭐️ us on [GitHub](https://github.com/clearml/clearml)!

On this page

### ClearML Agent 1.5.2 [​](https://clear.ml/docs/latest/docs/release_notes/clearml_agent/ver_1_5/\#clearml-agent-152 "Direct link to ClearML Agent 1.5.2")
...
### ClearML Agent 1.5.1 [​](https://clear.ml/docs/latest/docs/release_notes/clearml_agent/ver_1_5/\#clearml-agent-151 "Direct link to ClearML Agent 1.5.1")
...
### ClearML Agent 1.5.0 [​](https://clear.ml/docs/latest/docs/release_notes/clearml_agent/ver_1_5/\#clearml-agent-150 "Direct link to ClearML Agent 1.5.0")
...
- K8s Glue
  ...
  - Make sure git\_user/pass is passed to the task pod
  - Remove support for `kubectl run`

- [ClearML Agent 1.5.2](https://clear.ml/docs/latest/docs/release_notes/clearml_agent/ver_1_5/#clearml-agent-152)
- [ClearML Agent 1.5.1](https://clear.ml/docs/latest/docs/release_notes/clearml_agent/ver_1_5/#clearml-agent-151)
- [ClearML Agent 1.5.0](https://clear.ml/docs/latest/docs/release_notes/clearml_agent/ver_1_5/#clearml-agent-150)