...
[Skip to main content](https://clear.ml/docs/latest/docs/pipelines/pipelines_sdk_function_decorators/#__docusaurus_skipToContent_fallback)

If you ❤️ ️ **ClearML**, ⭐️ us on [GitHub](https://github.com/clearml/clearml)!

On this page

## Creating Pipelines Using Function Decorators [​](https://clear.ml/docs/latest/docs/pipelines/pipelines_sdk_function_decorators/\#creating-pipelines-using-function-decorators "Direct link to Creating Pipelines Using Function Decorators")

Use the [`PipelineDecorator`](https://clear.ml/docs/latest/docs/references/sdk/automation_controller_pipelinedecorator#class-automationcontrollerpipelinedecorator)
class to create pipelines from your existing functions. Use [`@PipelineDecorator.component`](https://clear.ml/docs/latest/docs/references/sdk/automation_controller_pipelinedecorator#pipelinedecoratorcomponent)
to denote functions that comprise the steps of your pipeline, and [`@PipelineDecorator.pipeline`](https://clear.ml/docs/latest/docs/references/sdk/automation_controller_pipelinedecorator#pipelinedecoratorpipeline)
for your main pipeline execution logic function.

## @PipelineDecorator.pipeline [​](https://clear.ml/docs/latest/docs/pipelines/pipelines_sdk_function_decorators/\#pipelinedecoratorpipeline "Direct link to @PipelineDecorator.pipeline")

Using the [`@PipelineDecorator.pipeline`](https://clear.ml/docs/latest/docs/references/sdk/automation_controller_pipelinedecorator#pipelinedecoratorpipeline)
...
### Arguments [​](https://clear.ml/docs/latest/docs/pipelines/pipelines_sdk_function_decorators/\#arguments "Direct link to Arguments")
...
- `default_queue` \- The default [ClearML Queue](https://clear.ml/docs/latest/docs/fundamentals/agents_and_queues#what-is-a-queue) in which to enqueue all pipeline steps (unless otherwise specified in the pipeline step).
- `args_map` \- Map arguments to their [configuration section](https://clear.ml/docs/latest/docs/fundamentals/hyperparameters#webapp-interface) in
...
execution logic (Pipeline Task) and step execution Tasks. Example: "pipeline/component\_execution".
...
parameters. When launching a new pipeline run from the [UI](https://clear.ml/docs/latest/docs/webapp/pipelines/webapp_pipeline_page), you can modify their values for the new run.
...
## @PipelineDecorator.component [​](https://clear.ml/docs/latest/docs/pipelines/pipelines_sdk_function_decorators/\#pipelinedecoratorcomponent "Direct link to @PipelineDecorator.component")

Using the [`@PipelineDecorator.component`](https://clear.ml/docs/latest/docs/references/sdk/automation_controller_pipelinedecorator#pipelinedecoratorcomponent)
...
In the case that the `skip_global_imports` parameter of [`@PipelineDecorator.pipeline`](https://clear.ml/docs/latest/docs/references/sdk/automation_controller_pipelinedecorator#pipelinedecoratorpipeline)
...
### Arguments [​](https://clear.ml/docs/latest/docs/pipelines/pipelines_sdk_function_decorators/\#arguments-1 "Direct link to Arguments")
...
- `cache` \- If `True`, the pipeline controller checks if a step with the same code (including setup, see task [Execution](https://clear.ml/docs/latest/docs/webapp/webapp_exp_track_visual#execution)
...
[`PipelineDecorator.set_default_execution_queue method`](https://clear.ml/docs/latest/docs/references/sdk/automation_controller_pipelinedecorator#pipelinedecoratorset_default_execution_queue)
method.
...
- `task_type` (optional) - The [task type](https://clear.ml/docs/latest/docs/fundamentals/task#task-types) to be created
...
specify which frameworks to log. See `Task.init`'s [`auto_connect_framework` parameter](https://clear.ml/docs/latest/docs/references/sdk/task#taskinit)
- `auto_connect_arg_parser` \- Control automatic logging of argparse objects. See `Task.init`'s [`auto_connect_arg_parser` parameter](https://clear.ml/docs/latest/docs/references/sdk/task#taskinit)

You can also directly upload a model or an artifact from the step to the pipeline controller, using the
[`PipelineDecorator.upload_model`](https://clear.ml/docs/latest/docs/references/sdk/automation_controller_pipelinedecorator#pipelinedecoratorupload_model)
and [`PipelineDecorator.upload_artifact`](https://clear.ml/docs/latest/docs/references/sdk/automation_controller_pipelinedecorator#pipelinedecoratorupload_artifact)
methods respectively.

## Controlling Pipeline Execution [​](https://clear.ml/docs/latest/docs/pipelines/pipelines_sdk_function_decorators/\#controlling-pipeline-execution "Direct link to Controlling Pipeline Execution")

### Default Execution Queue [​](https://clear.ml/docs/latest/docs/pipelines/pipelines_sdk_function_decorators/\#default-execution-queue "Direct link to Default Execution Queue")

The [`PipelineDecorator.set_default_execution_queue`](https://clear.ml/docs/latest/docs/references/sdk/automation_controller_pipelinedecorator#pipelinedecoratorset_default_execution_queue)
...
### Running the Pipeline [​](https://clear.ml/docs/latest/docs/pipelines/pipelines_sdk_function_decorators/\#running-the-pipeline "Direct link to Running the Pipeline")

To run the pipeline, call the pipeline controller function.

ClearML pipelines can be run in one of the following modes:

#### Remote Mode [​](https://clear.ml/docs/latest/docs/pipelines/pipelines_sdk_function_decorators/\#remote-mode "Direct link to Remote Mode")
...
#### Debugging Mode [​](https://clear.ml/docs/latest/docs/pipelines/pipelines_sdk_function_decorators/\#debugging-mode "Direct link to Debugging Mode")
...
executed on the developer machine with full ability to debug each function call. Call [`PipelineDecorator.debug_pipeline`](https://clear.ml/docs/latest/docs/references/sdk/automation_controller_pipelinedecorator#pipelinedecoratordebug_pipeline)
...
#### Local Mode [​](https://clear.ml/docs/latest/docs/pipelines/pipelines_sdk_function_decorators/\#local-mode "Direct link to Local Mode")
...
- [Creating Pipelines Using Function Decorators](https://clear.ml/docs/latest/docs/pipelines/pipelines_sdk_function_decorators/#creating-pipelines-using-function-decorators)
- [@PipelineDecorator.pipeline](https://clear.ml/docs/latest/docs/pipelines/pipelines_sdk_function_decorators/#pipelinedecoratorpipeline)
  - [Arguments](https://clear.ml/docs/latest/docs/pipelines/pipelines_sdk_function_decorators/#arguments)
- [@PipelineDecorator.component](https://clear.ml/docs/latest/docs/pipelines/pipelines_sdk_function_decorators/#pipelinedecoratorcomponent)
  - [Arguments](https://clear.ml/docs/latest/docs/pipelines/pipelines_sdk_function_decorators/#arguments-1)
- [Controlling Pipeline Execution](https://clear.ml/docs/latest/docs/pipelines/pipelines_sdk_function_decorators/#controlling-pipeline-execution)
  - [Default Execution Queue](https://clear.ml/docs/latest/docs/pipelines/pipelines_sdk_function_decorators/#default-execution-queue)
  - [Running the Pipeline](https://clear.ml/docs/latest/docs/pipelines/pipelines_sdk_function_decorators/#running-the-pipeline)