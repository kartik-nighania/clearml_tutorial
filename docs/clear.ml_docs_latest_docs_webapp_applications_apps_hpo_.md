---
url: "https://clear.ml/docs/latest/docs/webapp/applications/apps_hpo/"
title: "Hyperparameter Optimization | ClearML"
---

[Skip to main content](https://clear.ml/docs/latest/docs/webapp/applications/apps_hpo/#__docusaurus_skipToContent_fallback)
...
![HPO Dashboard](https://clear.ml/docs/latest/assets/images/apps_format_overview-79471a6d32c8e413ca593b6e7e4adf81.png#light-mode-only)![HPO Dashboard](https://clear.ml/docs/latest/assets/images/apps_format_overview_dark-a4341e670545794566ad535036cb4f87.png#dark-mode-only)
...
## HPO Instance Configuration [​](https://clear.ml/docs/latest/docs/webapp/applications/apps_hpo/\#hpo-instance-configuration "Direct link to HPO Instance Configuration")
...
### Configuration Options [​](https://clear.ml/docs/latest/docs/webapp/applications/apps_hpo/\#configuration-options "Direct link to Configuration Options")
...
- **Execution Queue** \- The [ClearML Queue](https://clear.ml/docs/latest/docs/fundamentals/agents_and_queues#what-is-a-queue) to which
...
![HPO app instance launch form](https://clear.ml/docs/latest/assets/images/apps_hpo_wizard-b77a973bb6199375ec68858ba9aca369.png#light-mode-only)![HPO app instance launch form](https://clear.ml/docs/latest/assets/images/apps_hpo_wizard_dark-c229dce314966b440d683021c1b219f3.png#dark-mode-only)

- [HPO Instance Configuration](https://clear.ml/docs/latest/docs/webapp/applications/apps_hpo/#hpo-instance-configuration)
  - [Configuration Options](https://clear.ml/docs/latest/docs/webapp/applications/apps_hpo/#configuration-options)