---
url: "https://clear.ml/docs/latest/docs/clearml_sdk/task_sdk/"
title: "Task | ClearML"
---

[Skip to main content](https://clear.ml/docs/latest/docs/clearml_sdk/task_sdk/#__docusaurus_skipToContent_fallback)
...
## Task Creation [​](https://clear.ml/docs/latest/docs/clearml_sdk/task_sdk/\#task-creation "Direct link to Task Creation")

[`Task.init`](https://clear.ml/docs/latest/docs/references/sdk/task) is the main method used to create tasks in ClearML. It will create a task, and
populate it with:
...
`pytorch`, and `random` packages by setting a fixed initial seed. See [Setting Random Seed](https://clear.ml/docs/latest/docs/clearml_sdk/task_sdk/#setting-random-seed).
...
Once a task is created, the task object can be accessed from anywhere in the code by calling [`Task.current_task()`](https://clear.ml/docs/latest/docs/references/sdk/task#taskcurrent_task).

If multiple tasks need to be created in the same process (for example, for logging multiple manual runs),
make sure to close a task, before initializing a new one. To close a task simply call [`Task.close()`](https://clear.ml/docs/latest/docs/references/sdk/task#close)
(see example [here](https://clear.ml/docs/latest/docs/guides/advanced/multiple_tasks_single_process)).
...
### Automatic Logging [​](https://clear.ml/docs/latest/docs/clearml_sdk/task_sdk/\#automatic-logging "Direct link to Automatic Logging")
...
- **Hyperparameters**\- ClearML logs the following types of hyperparameters:
  ...
  - Command Line Parsing - ClearML captures any command line parameters passed when invoking code that uses standard Python packages, including:
    ...
    - [jsonargparse](https://clear.ml/docs/latest/docs/integrations/jsonargparse)
  - TensorFlow Definitions (`absl-py`)
  - [Hydra](https://clear.ml/docs/latest/docs/integrations/hydra) \- ClearML logs the OmegaConf which holds all the configuration files, as well as values overridden during runtime.
- **Models**\- ClearML automatically logs and updates the models and all snapshot paths saved with the following frameworks:
  ...
  - [AutoKeras](https://clear.ml/docs/latest/docs/integrations/autokeras)
  ...
  - [Hugging Face Transformers](https://clear.ml/docs/latest/docs/integrations/transformers)
  - [LightGBM](https://clear.ml/docs/latest/docs/integrations/lightgbm)
  ...
  - [YOLOv8](https://clear.ml/docs/latest/docs/integrations/yolov8)
  - [YOLOv5](https://clear.ml/docs/latest/docs/integrations/yolov5)
- **Metrics, scalars, plots, debug images**reported through supported frameworks, including:

  - [Matplotlib](https://clear.ml/docs/latest/docs/integrations/matplotlib)
  - [Tensorboard](https://clear.ml/docs/latest/docs/integrations/tensorboard)
  - [TensorboardX](https://clear.ml/docs/latest/docs/integrations/tensorboardx)
- **Execution details**including:
  ...
  - Python environment
  - Execution [configuration](https://clear.ml/docs/latest/docs/webapp/webapp_exp_track_visual#configuration)

### Control Automatic Logging [​](https://clear.ml/docs/latest/docs/clearml_sdk/task_sdk/\#control-automatic-logging "Direct link to Control Automatic Logging")
...
#### Frameworks [​](https://clear.ml/docs/latest/docs/clearml_sdk/task_sdk/\#frameworks "Direct link to Frameworks")
...
#### Argument Parsers [​](https://clear.ml/docs/latest/docs/clearml_sdk/task_sdk/\#argument-parsers "Direct link to Argument Parsers")

To control a task's logging of parameters from supported argument parsers, use the `auto_connect_arg_parser` parameter of [`Task.init()`](https://clear.ml/docs/latest/docs/references/sdk/task#taskinit).
...
### Task Reuse [​](https://clear.ml/docs/latest/docs/clearml_sdk/task_sdk/\#task-reuse "Direct link to Task Reuse")
...
[`sdk.development.task_reuse_time_window_in_hours`](https://clear.ml/docs/latest/docs/configs/clearml_conf#task_reuse) in
...
For more information, see [`Task.init()`](https://clear.ml/docs/latest/docs/references/sdk/task#taskinit).

### Continuing Task Execution [​](https://clear.ml/docs/latest/docs/clearml_sdk/task_sdk/\#continuing-task-execution "Direct link to Continuing Task Execution")
...
[Task Reuse](https://clear.ml/docs/latest/docs/clearml_sdk/task_sdk/#task-reuse)).
...
See [Offline Mode](https://clear.ml/docs/latest/docs/clearml_sdk/task_sdk/#offline-mode).

### Task Creation from Existing Code or Container [​](https://clear.ml/docs/latest/docs/clearml_sdk/task_sdk/\#task-creation-from-existing-code-or-container "Direct link to Task Creation from Existing Code or Container")
...
For more information, see [`Task.create()`](https://clear.ml/docs/latest/docs/references/sdk/task#taskcreate).

## Tracking Task Progress [​](https://clear.ml/docs/latest/docs/clearml_sdk/task_sdk/\#tracking-task-progress "Direct link to Tracking Task Progress")

Track a task's progress by setting the task progress property using [`Task.set_progress()`](https://clear.ml/docs/latest/docs/references/sdk/task#set_progress).
Set a task's progress to a numeric value between 0 - 100. Access the task's current progress, using
[`Task.get_progress()`](https://clear.ml/docs/latest/docs/references/sdk/task#get_progress).
...
![Task table progress indication](https://clear.ml/docs/latest/assets/images/fundamentals_task_progress-c922b8fc361b841a97416b79341ba44a.png#light-mode-only)![Task table progress indication](https://clear.ml/docs/latest/assets/images/fundamentals_task_progress_dark-998390fe6a1088d524ce85098c23a6bb.png#dark-mode-only)

Additionally, you can view a task's progress in its [INFO](https://clear.ml/docs/latest/docs/webapp/webapp_exp_track_visual#info) tab
in the WebApp.

## Accessing Tasks [​](https://clear.ml/docs/latest/docs/clearml_sdk/task_sdk/\#accessing-tasks "Direct link to Accessing Tasks")
...
combination using the [`Task.get_task()`](https://clear.ml/docs/latest/docs/references/sdk/task#taskget_task) class method. If a project / name
combination is used, and multiple tasks have the exact same name, the function will return the _last modified task_.
...
## Querying / Searching Tasks [​](https://clear.ml/docs/latest/docs/clearml_sdk/task_sdk/\#querying--searching-tasks "Direct link to Querying / Searching Tasks")

Search and filter tasks programmatically. Input search parameters into the [`Task.get_tasks()`](https://clear.ml/docs/latest/docs/references/sdk/task#taskget_tasks)
...
See [`Task.get_tasks`](https://clear.ml/docs/latest/docs/references/sdk/task#taskget_tasks) for all `task_filter` options.

### Tag Filters [​](https://clear.ml/docs/latest/docs/clearml_sdk/task_sdk/\#tag-filters "Direct link to Tag Filters")
...
#### Examples [​](https://clear.ml/docs/latest/docs/clearml_sdk/task_sdk/\#examples "Direct link to Examples")
...
## Cloning and Executing Tasks [​](https://clear.ml/docs/latest/docs/clearml_sdk/task_sdk/\#cloning-and-executing-tasks "Direct link to Cloning and Executing Tasks")

Once a task object is created, it can be copied (cloned). [`Task.clone()`](https://clear.ml/docs/latest/docs/references/sdk/task#taskclone) returns
a copy of the original task (`source_task`). By default, the cloned task is added to the same project as the original,
and it's called "Clone Of ORIGINAL\_NAME", but the name / project / comment (description) of the cloned task can be directly overridden.
...
A newly cloned task has a [draft](https://clear.ml/docs/latest/docs/fundamentals/task#task-states) status,
...
Once a task is modified, launch it by pushing it into an execution queue with the [`Task.enqueue()`](https://clear.ml/docs/latest/docs/references/sdk/task#taskenqueue)
class method. Then a [ClearML Agent](https://clear.ml/docs/latest/docs/clearml_agent) assigned to the queue will pull the task from the queue and execute
it.
...
## Advanced Flows [​](https://clear.ml/docs/latest/docs/clearml_sdk/task_sdk/\#advanced-flows "Direct link to Advanced Flows")

### Remote Execution [​](https://clear.ml/docs/latest/docs/clearml_sdk/task_sdk/\#remote-execution "Direct link to Remote Execution")
...
Use [`Task.execute_remotely()`](https://clear.ml/docs/latest/docs/references/sdk/task#execute_remotely) to implement this workflow. This method
...
See the [Remote Execution](https://clear.ml/docs/latest/docs/guides/advanced/execute_remotely) example.

#### Remote Function Execution [​](https://clear.ml/docs/latest/docs/clearml_sdk/task_sdk/\#remote-function-execution "Direct link to Remote Function Execution")

A specific function can also be launched on a remote machine with [`Task.create_function_task()`](https://clear.ml/docs/latest/docs/references/sdk/task#create_function_task).
...
### Distributed Execution [​](https://clear.ml/docs/latest/docs/clearml_sdk/task_sdk/\#distributed-execution "Direct link to Distributed Execution")

ClearML supports distributed remote execution through multiple worker nodes using [`Task.launch_multi_node()`](https://clear.ml/docs/latest/docs/references/sdk/task#launch_multi_node).
...
#### Example: PyTorch Distributed [​](https://clear.ml/docs/latest/docs/clearml_sdk/task_sdk/\#example-pytorch-distributed "Direct link to Example: PyTorch Distributed")
...
### Offline Mode [​](https://clear.ml/docs/latest/docs/clearml_sdk/task_sdk/\#offline-mode "Direct link to Offline Mode")

You can work with tasks in Offline Mode, in which all the data and logs that the Task captures are stored in a local
session folder, which can later be uploaded to the [ClearML Server](https://clear.ml/docs/latest/docs/deploying_clearml/clearml_server).
...
- [`clearml-task`](https://clear.ml/docs/latest/docs/apps/clearml_task) CLI
...
- [`Task.import_offline_session()`](https://clear.ml/docs/latest/docs/references/sdk/task#taskimport_offline_session) class method
...
### Setting Random Seed [​](https://clear.ml/docs/latest/docs/clearml_sdk/task_sdk/\#setting-random-seed "Direct link to Setting Random Seed")
...
ClearML uses `1337` as the default initial seed. To set a different value for your task, use the [`Task.set_random_seed`](https://clear.ml/docs/latest/docs/references/sdk/task#taskset_random_seed)
...
## Artifacts [​](https://clear.ml/docs/latest/docs/clearml_sdk/task_sdk/\#artifacts "Direct link to Artifacts")
...
### Logging Artifacts [​](https://clear.ml/docs/latest/docs/clearml_sdk/task_sdk/\#logging-artifacts "Direct link to Logging Artifacts")

To log an artifact in a task, use [`upload_artifact()`](https://clear.ml/docs/latest/docs/references/sdk/task#upload_artifact).
...
See more details in the [Artifacts Reporting example](https://clear.ml/docs/latest/docs/guides/reporting/artifacts) and in the [SDK reference](https://clear.ml/docs/latest/docs/references/sdk/task#upload_artifact).

### Using Artifacts [​](https://clear.ml/docs/latest/docs/clearml_sdk/task_sdk/\#using-artifacts "Direct link to Using Artifacts")

A task's artifacts are accessed through the task's _artifact_ property which lists the artifacts' locations.
...
## Models [​](https://clear.ml/docs/latest/docs/clearml_sdk/task_sdk/\#models "Direct link to Models")

The following is an overview of working with models through a `Task` object. You can also work directly with model
objects (see [Models (SDK)](https://clear.ml/docs/latest/docs/clearml_sdk/model_sdk)).

### Logging Models Manually [​](https://clear.ml/docs/latest/docs/clearml_sdk/task_sdk/\#logging-models-manually "Direct link to Logging Models Manually")

To manually log a model in a task, create an instance of the [OutputModel](https://clear.ml/docs/latest/docs/references/sdk/model_outputmodel) class.
...
### Updating Models Manually [​](https://clear.ml/docs/latest/docs/clearml_sdk/task_sdk/\#updating-models-manually "Direct link to Updating Models Manually")

The snapshots of manually uploaded models aren't automatically captured. To update a task's model, use the
[`Task.update_output_model`](https://clear.ml/docs/latest/docs/references/sdk/task#update_output_model) method:
...
Models can also be manually updated independently, without any task. See [`OutputModel.update_weights`](https://clear.ml/docs/latest/docs/references/sdk/model_outputmodel#update_weights).

### Using Models [​](https://clear.ml/docs/latest/docs/clearml_sdk/task_sdk/\#using-models "Direct link to Using Models")
...
### Setting Upload Destination [​](https://clear.ml/docs/latest/docs/clearml_sdk/task_sdk/\#setting-upload-destination "Direct link to Setting Upload Destination")
...
[ClearML Configuration Reference](https://clear.ml/docs/latest/docs/configs/clearml_conf#sdkdevelopment)) and set `sdk.developmenmt.default_output_uri`
to the desired storage (see [Storage](https://clear.ml/docs/latest/docs/integrations/storage)). This is especially helpful when
using [clearml-agent](https://clear.ml/docs/latest/docs/clearml_agent) to execute code.

## Configuration [​](https://clear.ml/docs/latest/docs/clearml_sdk/task_sdk/\#configuration "Direct link to Configuration")

### Manual Hyperparameter Logging [​](https://clear.ml/docs/latest/docs/clearml_sdk/task_sdk/\#manual-hyperparameter-logging "Direct link to Manual Hyperparameter Logging")

#### Setting Parameters [​](https://clear.ml/docs/latest/docs/clearml_sdk/task_sdk/\#setting-parameters "Direct link to Setting Parameters")

To define parameters manually use [`Task.set_parameters()`](https://clear.ml/docs/latest/docs/references/sdk/task#set_parameters) to specify
...
Call [`Task.set_parameter()`](https://clear.ml/docs/latest/docs/references/sdk/task#set_parameter) to set a single parameter.
...
#### Adding Parameters [​](https://clear.ml/docs/latest/docs/clearml_sdk/task_sdk/\#adding-parameters "Direct link to Adding Parameters")

To update the parameters in a task, use [`Task.set_parameters_as_dict()`](https://clear.ml/docs/latest/docs/references/sdk/task#set_parameters_as_dict).
...
### Accessing Parameters [​](https://clear.ml/docs/latest/docs/clearml_sdk/task_sdk/\#accessing-parameters "Direct link to Accessing Parameters")

To access all task parameters, use [`Task.get_parameters()`](https://clear.ml/docs/latest/docs/references/sdk/task#get_parameters). This
...
Access a specific parameter with the [`Task.get_parameter`](https://clear.ml/docs/latest/docs/references/sdk/task#get_parameter) method specifying
...
### Tracking Python Objects [​](https://clear.ml/docs/latest/docs/clearml_sdk/task_sdk/\#tracking-python-objects "Direct link to Tracking Python Objects")

ClearML can track Python objects (such as dictionaries and custom classes) as they evolve in your code, and log them to
your task's configuration using [`Task.connect()`](https://clear.ml/docs/latest/docs/references/sdk/task#connect). Once objects are connected
...
![Task parameters](https://clear.ml/docs/latest/assets/images/fundamentals_task_config_hyperparams-f4a6b9b3b3a6d768b9559d21dfb72a23.png#light-mode-only)![Task parameters](https://clear.ml/docs/latest/assets/images/fundamentals_task_config_hyperparams_dark-b574287441c221287ce9ab05f228b105.png#dark-mode-only)

### Configuration Objects [​](https://clear.ml/docs/latest/docs/clearml_sdk/task_sdk/\#configuration-objects "Direct link to Configuration Objects")

To log configuration more elaborate than a key-value dictionary (such as nested dictionaries or configuration files),
use [`Task.connect_configuration()`](https://clear.ml/docs/latest/docs/references/sdk/task#connect_configuration).
...
![Task configuration objects](https://clear.ml/docs/latest/assets/images/fundamentals_task_config_object-44c983c529913c44491b1bfb533f85dd.png#light-mode-only)![Task configuration objects](https://clear.ml/docs/latest/assets/images/fundamentals_task_config_object_dark-4f8194c3a6d2cc06e71b511e3c2506d9.png#dark-mode-only)

### User Properties [​](https://clear.ml/docs/latest/docs/clearml_sdk/task_sdk/\#user-properties "Direct link to User Properties")

A task's user properties do not impact task execution, so you can add / modify the properties at any stage. Add user
properties to a task with the [`Task.set_user_properties`](https://clear.ml/docs/latest/docs/references/sdk/task#set_user_properties) method.
...
![Task user properties](https://clear.ml/docs/latest/assets/images/fundamentals_task_config_properties-34b573aaac639edb91df52b00ba0786b.png#light-mode-only)![Task user properties](https://clear.ml/docs/latest/assets/images/fundamentals_task_config_properties_dark-74fd9b1cb9bb9dccb440248fdfa78376.png#dark-mode-only)

## Scalars [​](https://clear.ml/docs/latest/docs/clearml_sdk/task_sdk/\#scalars "Direct link to Scalars")

After invoking `Task.init` in a script, ClearML automatically captures scalars logged by supported frameworks
(see [automatic logging](https://clear.ml/docs/latest/docs/clearml_sdk/task_sdk/#automatic-logging)).
...
See [Manual Reporting](https://clear.ml/docs/latest/docs/fundamentals/logger#manual-reporting) for more information.

### Retrieving Scalar Values [​](https://clear.ml/docs/latest/docs/clearml_sdk/task_sdk/\#retrieving-scalar-values "Direct link to Retrieving Scalar Values")

#### Scalar Summary [​](https://clear.ml/docs/latest/docs/clearml_sdk/task_sdk/\#scalar-summary "Direct link to Scalar Summary")

Use [`Task.get_last_scalar_metrics()`](https://clear.ml/docs/latest/docs/references/sdk/task#get_last_scalar_metrics) to get a summary of all
...
#### Get Sample Values [​](https://clear.ml/docs/latest/docs/clearml_sdk/task_sdk/\#get-sample-values "Direct link to Get Sample Values")

Use [`get_reported_scalars()`](https://clear.ml/docs/latest/docs/references/sdk/task#get_reported_scalars) to retrieve a sample of the logged scalars
...
To fetch all scalar values, use [`Task.get_all_reported_scalars()`](https://clear.ml/docs/latest/docs/references/sdk/task#get_all_reported_scalars).
...
#### Get Single Value Scalars [​](https://clear.ml/docs/latest/docs/clearml_sdk/task_sdk/\#get-single-value-scalars "Direct link to Get Single Value Scalars")

To get the values of a reported single-value scalars, use [`Task.get_reported_single_value()`](https://clear.ml/docs/latest/docs/references/sdk/task#get_reported_single_value)
and specify the scalar's `name`.

To get all reported single scalar values, use [`Task.get_reported_single_values()`](https://clear.ml/docs/latest/docs/references/sdk/task#get_reported_single_values),
...
## SDK Reference [​](https://clear.ml/docs/latest/docs/clearml_sdk/task_sdk/\#sdk-reference "Direct link to SDK Reference")

For detailed information, see the complete [Task SDK reference page](https://clear.ml/docs/latest/docs/references/sdk/task).

- [Task Creation](https://clear.ml/docs/latest/docs/clearml_sdk/task_sdk/#task-creation)
  - [Automatic Logging](https://clear.ml/docs/latest/docs/clearml_sdk/task_sdk/#automatic-logging)
  - [Control Automatic Logging](https://clear.ml/docs/latest/docs/clearml_sdk/task_sdk/#control-automatic-logging)
  - [Task Reuse](https://clear.ml/docs/latest/docs/clearml_sdk/task_sdk/#task-reuse)
  - [Continuing Task Execution](https://clear.ml/docs/latest/docs/clearml_sdk/task_sdk/#continuing-task-execution)
  - [Task Creation from Existing Code or Container](https://clear.ml/docs/latest/docs/clearml_sdk/task_sdk/#task-creation-from-existing-code-or-container)
- [Tracking Task Progress](https://clear.ml/docs/latest/docs/clearml_sdk/task_sdk/#tracking-task-progress)
- [Accessing Tasks](https://clear.ml/docs/latest/docs/clearml_sdk/task_sdk/#accessing-tasks)
- [Querying / Searching Tasks](https://clear.ml/docs/latest/docs/clearml_sdk/task_sdk/#querying--searching-tasks)
  - [Tag Filters](https://clear.ml/docs/latest/docs/clearml_sdk/task_sdk/#tag-filters)
- [Cloning and Executing Tasks](https://clear.ml/docs/latest/docs/clearml_sdk/task_sdk/#cloning-and-executing-tasks)
- [Advanced Flows](https://clear.ml/docs/latest/docs/clearml_sdk/task_sdk/#advanced-flows)
  - [Remote Execution](https://clear.ml/docs/latest/docs/clearml_sdk/task_sdk/#remote-execution)
  - [Distributed Execution](https://clear.ml/docs/latest/docs/clearml_sdk/task_sdk/#distributed-execution)
  - [Offline Mode](https://clear.ml/docs/latest/docs/clearml_sdk/task_sdk/#offline-mode)
  - [Setting Random Seed](https://clear.ml/docs/latest/docs/clearml_sdk/task_sdk/#setting-random-seed)
- [Artifacts](https://clear.ml/docs/latest/docs/clearml_sdk/task_sdk/#artifacts)
  - [Logging Artifacts](https://clear.ml/docs/latest/docs/clearml_sdk/task_sdk/#logging-artifacts)
  - [Using Artifacts](https://clear.ml/docs/latest/docs/clearml_sdk/task_sdk/#using-artifacts)
- [Models](https://clear.ml/docs/latest/docs/clearml_sdk/task_sdk/#models)
  - [Logging Models Manually](https://clear.ml/docs/latest/docs/clearml_sdk/task_sdk/#logging-models-manually)
  - [Updating Models Manually](https://clear.ml/docs/latest/docs/clearml_sdk/task_sdk/#updating-models-manually)
  - [Using Models](https://clear.ml/docs/latest/docs/clearml_sdk/task_sdk/#using-models)
  - [Setting Upload Destination](https://clear.ml/docs/latest/docs/clearml_sdk/task_sdk/#setting-upload-destination)
- [Configuration](https://clear.ml/docs/latest/docs/clearml_sdk/task_sdk/#configuration)
  - [Manual Hyperparameter Logging](https://clear.ml/docs/latest/docs/clearml_sdk/task_sdk/#manual-hyperparameter-logging)
  - [Accessing Parameters](https://clear.ml/docs/latest/docs/clearml_sdk/task_sdk/#accessing-parameters)
  - [Tracking Python Objects](https://clear.ml/docs/latest/docs/clearml_sdk/task_sdk/#tracking-python-objects)
  - [Configuration Objects](https://clear.ml/docs/latest/docs/clearml_sdk/task_sdk/#configuration-objects)
  - [User Properties](https://clear.ml/docs/latest/docs/clearml_sdk/task_sdk/#user-properties)
- [Scalars](https://clear.ml/docs/latest/docs/clearml_sdk/task_sdk/#scalars)
  - [Retrieving Scalar Values](https://clear.ml/docs/latest/docs/clearml_sdk/task_sdk/#retrieving-scalar-values)
- [SDK Reference](https://clear.ml/docs/latest/docs/clearml_sdk/task_sdk/#sdk-reference)