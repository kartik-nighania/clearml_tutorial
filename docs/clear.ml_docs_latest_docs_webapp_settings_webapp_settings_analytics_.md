---
url: "https://clear.ml/docs/latest/docs/webapp/settings/webapp_settings_analytics/"
title: "Analytics | ClearML"
---

[Skip to main content](https://clear.ml/docs/latest/docs/webapp/settings/webapp_settings_analytics/#__docusaurus_skipToContent_fallback)
...
The Analytics section is available where the service administrators have configured [custom event metering](https://clear.ml/docs/latest/docs/deploying_clearml/enterprise_deploy/extra_configs/event_metering),
...
- [Usage and cost plots](https://clear.ml/docs/latest/docs/webapp/settings/webapp_settings_analytics/#usage-and-cost-plots) for the metered events
...
## Usage and Cost Plots [​](https://clear.ml/docs/latest/docs/webapp/settings/webapp_settings_analytics/\#usage-and-cost-plots "Direct link to Usage and Cost Plots")
...
- [Usage and Cost Plots](https://clear.ml/docs/latest/docs/webapp/settings/webapp_settings_analytics/#usage-and-cost-plots)