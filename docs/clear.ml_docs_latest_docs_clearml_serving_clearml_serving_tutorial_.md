---
url: "https://clear.ml/docs/latest/docs/clearml_serving/clearml_serving_tutorial/"
title: "ClearML Serving Quick Start Tutorial | ClearML"
---

[Skip to main content](https://clear.ml/docs/latest/docs/clearml_serving/clearml_serving_tutorial/#__docusaurus_skipToContent_fallback)
...
3. Train and serve a model
4. Query the deployed Endpoint

## Initial Steps [​](https://clear.ml/docs/latest/docs/clearml_serving/clearml_serving_tutorial/\#initial-steps "Direct link to Initial Steps")
...
- Connect `clearml` SDK to the server, see instructions [here](https://clear.ml/docs/latest/docs/clearml_sdk/clearml_sdk_setup#install-clearml)


## Run Triton-based Serving Inference Container (Docker Compose) [​](https://clear.ml/docs/latest/docs/clearml_serving/clearml_serving_tutorial/\#run-triton-based-serving-inference-container-docker-compose "Direct link to Run Triton-based Serving Inference Container (Docker Compose)")
...
## Train a Model [​](https://clear.ml/docs/latest/docs/clearml_serving/clearml_serving_tutorial/\#train-a-model "Direct link to Train a Model")

Train a model and add it to your ClearML model repository, so you can later serve it:

1. Run the following example script: [https://github.com/clearml/clearml-serving/blob/main/examples/pytorch/train\_pytorch\_mnist.py](https://github.com/clearml/clearml-serving/blob/main/examples/pytorch/train_pytorch_mnist.py).
...
## Serve the Model [​](https://clear.ml/docs/latest/docs/clearml_serving/clearml_serving_tutorial/\#serve-the-model "Direct link to Serve the Model")
...
- [Initial Steps](https://clear.ml/docs/latest/docs/clearml_serving/clearml_serving_tutorial/#initial-steps)
- [Run Triton-based Serving Inference Container (Docker Compose)](https://clear.ml/docs/latest/docs/clearml_serving/clearml_serving_tutorial/#run-triton-based-serving-inference-container-docker-compose)
- [Train a Model](https://clear.ml/docs/latest/docs/clearml_serving/clearml_serving_tutorial/#train-a-model)
- [Serve the Model](https://clear.ml/docs/latest/docs/clearml_serving/clearml_serving_tutorial/#serve-the-model)