---
url: "https://clear.ml/docs/latest/docs/clearml_data/data_management_examples/data_man_folder_sync/"
title: "Folder Sync with CLI | ClearML"
---

[Skip to main content](https://clear.ml/docs/latest/docs/clearml_data/data_management_examples/data_man_folder_sync/#__docusaurus_skipToContent_fallback)
...
## Prerequisites [​](https://clear.ml/docs/latest/docs/clearml_data/data_management_examples/data_man_folder_sync/\#prerequisites "Direct link to Prerequisites")
...
## Syncing a Folder [​](https://clear.ml/docs/latest/docs/clearml_data/data_management_examples/data_man_folder_sync/\#syncing-a-folder "Direct link to Syncing a Folder")
...
## Modifying Synced Folder [​](https://clear.ml/docs/latest/docs/clearml_data/data_management_examples/data_man_folder_sync/\#modifying-synced-folder "Direct link to Modifying Synced Folder")

Modify the data folder:

1. Add another line to one of the files in the `data_samples` folder.

2. Add a file to the sample\_data folder.
...
3. Repeat the process of creating a new dataset with the previous one as its parent, and syncing the folder.
...
- [Prerequisites](https://clear.ml/docs/latest/docs/clearml_data/data_management_examples/data_man_folder_sync/#prerequisites)
- [Syncing a Folder](https://clear.ml/docs/latest/docs/clearml_data/data_management_examples/data_man_folder_sync/#syncing-a-folder)
- [Modifying Synced Folder](https://clear.ml/docs/latest/docs/clearml_data/data_management_examples/data_man_folder_sync/#modifying-synced-folder)