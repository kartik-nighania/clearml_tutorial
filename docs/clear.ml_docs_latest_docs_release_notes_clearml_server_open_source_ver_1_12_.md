---
url: "https://clear.ml/docs/latest/docs/release_notes/clearml_server/open_source/ver_1_12/"
title: "Version 1.12 | ClearML"
---

[Skip to main content](https://clear.ml/docs/latest/docs/release_notes/clearml_server/open_source/ver_1_12/#__docusaurus_skipToContent_fallback)

If you ❤️ ️ **ClearML**, ⭐️ us on [GitHub](https://github.com/clearml/clearml)!

On this page

### ClearML Server 1.12.1 [​](https://clear.ml/docs/latest/docs/release_notes/clearml_server/open_source/ver_1_12/\#clearml-server-1121 "Direct link to ClearML Server 1.12.1")
...
### ClearML Server 1.12.0 [​](https://clear.ml/docs/latest/docs/release_notes/clearml_server/open_source/ver_1_12/\#clearml-server-1120 "Direct link to ClearML Server 1.12.0")
...
- [ClearML Server 1.12.1](https://clear.ml/docs/latest/docs/release_notes/clearml_server/open_source/ver_1_12/#clearml-server-1121)
- [ClearML Server 1.12.0](https://clear.ml/docs/latest/docs/release_notes/clearml_server/open_source/ver_1_12/#clearml-server-1120)