---
url: "https://clear.ml/docs/latest/docs/release_notes/clearml_server/enterprise/ver_3_21/"
title: "Version 3.21 | ClearML"
---

[Skip to main content](https://clear.ml/docs/latest/docs/release_notes/clearml_server/enterprise/ver_3_21/#__docusaurus_skipToContent_fallback)

If you ❤️ ️ **ClearML**, ⭐️ us on [GitHub](https://github.com/clearml/clearml)!

On this page

### Enterprise Server 3.21.4 [​](https://clear.ml/docs/latest/docs/release_notes/clearml_server/enterprise/ver_3_21/\#enterprise-server-3214 "Direct link to Enterprise Server 3.21.4")

**New Feature**

- Support setting up a supervisor company that can monitor the resource dashboards of all tenants on the server

### Enterprise Server 3.21.3 [​](https://clear.ml/docs/latest/docs/release_notes/clearml_server/enterprise/ver_3_21/\#enterprise-server-3213 "Direct link to Enterprise Server 3.21.3")

**New Feature**

- Allow hiding Dataset and Orchestration menu options for non-admins

### Enterprise Server 3.21.2 [​](https://clear.ml/docs/latest/docs/release_notes/clearml_server/enterprise/ver_3_21/\#enterprise-server-3212 "Direct link to Enterprise Server 3.21.2")
...
### Enterprise Server 3.21.1 [​](https://clear.ml/docs/latest/docs/release_notes/clearml_server/enterprise/ver_3_21/\#enterprise-server-3211 "Direct link to Enterprise Server 3.21.1")
...
### Enterprise Server 3.21.0 [​](https://clear.ml/docs/latest/docs/release_notes/clearml_server/enterprise/ver_3_21/\#enterprise-server-3210 "Direct link to Enterprise Server 3.21.0")
...
- [Enterprise Server 3.21.4](https://clear.ml/docs/latest/docs/release_notes/clearml_server/enterprise/ver_3_21/#enterprise-server-3214)
- [Enterprise Server 3.21.3](https://clear.ml/docs/latest/docs/release_notes/clearml_server/enterprise/ver_3_21/#enterprise-server-3213)
- [Enterprise Server 3.21.2](https://clear.ml/docs/latest/docs/release_notes/clearml_server/enterprise/ver_3_21/#enterprise-server-3212)
- [Enterprise Server 3.21.1](https://clear.ml/docs/latest/docs/release_notes/clearml_server/enterprise/ver_3_21/#enterprise-server-3211)
- [Enterprise Server 3.21.0](https://clear.ml/docs/latest/docs/release_notes/clearml_server/enterprise/ver_3_21/#enterprise-server-3210)