---
url: "https://clear.ml/docs/latest/docs/release_notes/clearml_agent/ver_1_0/"
title: "Version 1.0 | ClearML"
---

[Skip to main content](https://clear.ml/docs/latest/docs/release_notes/clearml_agent/ver_1_0/#__docusaurus_skipToContent_fallback)

If you ❤️ ️ **ClearML**, ⭐️ us on [GitHub](https://github.com/clearml/clearml)!

On this page

### ClearML Agent 1.0.0 [​](https://clear.ml/docs/latest/docs/release_notes/clearml_agent/ver_1_0/\#clearml-agent-100 "Direct link to ClearML Agent 1.0.0")
...
- [ClearML Agent 1.0.0](https://clear.ml/docs/latest/docs/release_notes/clearml_agent/ver_1_0/#clearml-agent-100)