---
url: "https://clear.ml/docs/latest/docs/hyperdatasets/dataviews/"
title: "Dataviews | ClearML"
---

[Skip to main content](https://clear.ml/docs/latest/docs/hyperdatasets/dataviews/#__docusaurus_skipToContent_fallback)
...
## Dataview State [​](https://clear.ml/docs/latest/docs/hyperdatasets/dataviews/\#dataview-state "Direct link to Dataview State")

Dataviews can be in either _Draft_ or _Published_ state.

A _Draft_ Dataview is editable. A _Published_ Dataview is read-only, which ensures reproducible tasks and
preserves the Dataview's settings.

## Filtering [​](https://clear.ml/docs/latest/docs/hyperdatasets/dataviews/\#filtering "Direct link to Filtering")
...
## Debiasing Input Data [​](https://clear.ml/docs/latest/docs/hyperdatasets/dataviews/\#debiasing-input-data "Direct link to Debiasing Input Data")
...
## ROI Label Mapping (Label Translation) [​](https://clear.ml/docs/latest/docs/hyperdatasets/dataviews/\#roi-label-mapping-label-translation "Direct link to ROI Label Mapping (Label Translation)")
...
## Class Label Enumeration [​](https://clear.ml/docs/latest/docs/hyperdatasets/dataviews/\#class-label-enumeration "Direct link to Class Label Enumeration")
...
## Iteration Control [​](https://clear.ml/docs/latest/docs/hyperdatasets/dataviews/\#iteration-control "Direct link to Iteration Control")
...
## Usage [​](https://clear.ml/docs/latest/docs/hyperdatasets/dataviews/\#usage "Direct link to Usage")

### Creating Dataviews [​](https://clear.ml/docs/latest/docs/hyperdatasets/dataviews/\#creating-dataviews "Direct link to Creating Dataviews")
...
### Adding Queries [​](https://clear.ml/docs/latest/docs/hyperdatasets/dataviews/\#adding-queries "Direct link to Adding Queries")

Dataview filters are created by adding filter queries to the Dataview. To add a query to a DataView, use [`DataView.add_query()`](https://clear.ml/docs/latest/docs/references/hyperdataset/dataview#add_query)
...
Apply multiple filters (with the same or different queries) by calling [`DataView.add_query()`](https://clear.ml/docs/latest/docs/references/hyperdataset/dataview#add_query)
multiple times.

Use [`DataView.add_multi_query()`](https://clear.ml/docs/latest/docs/references/hyperdataset/dataview#add_multi_query) for specifying multiple ROI
rules in the same query.

You can retrieve the Dataview frames using [`DataView.to_list()`](https://clear.ml/docs/latest/docs/references/hyperdataset/dataview#to_list),
[`DataView.to_dict()`](https://clear.ml/docs/latest/docs/references/hyperdataset/dataview#to_dict), or [`DataView.get_iterator()`](https://clear.ml/docs/latest/docs/references/hyperdataset/dataview#get_iterator)
(see [Accessing Frames](https://clear.ml/docs/latest/docs/hyperdatasets/dataviews/#accessing-frames)).

### ROI Query Examples [​](https://clear.ml/docs/latest/docs/hyperdatasets/dataviews/\#roi-query-examples "Direct link to ROI Query Examples")

#### ROI query for a single label [​](https://clear.ml/docs/latest/docs/hyperdatasets/dataviews/\#roi-query-for-a-single-label "Direct link to ROI query for a single label")
...
#### ROI query for one label OR another [​](https://clear.ml/docs/latest/docs/hyperdatasets/dataviews/\#roi-query-for-one-label-or-another "Direct link to ROI query for one label OR another")
...
#### ROI query for two specific labels in the same ROI [​](https://clear.ml/docs/latest/docs/hyperdatasets/dataviews/\#roi-query-for-two-specific-labels-in-the-same-roi "Direct link to ROI query for two specific labels in the same ROI")
...
#### ROI query for one label AND NOT another (Lucene query) [​](https://clear.ml/docs/latest/docs/hyperdatasets/dataviews/\#roi-query-for-one-label-and-not-another-lucene-query "Direct link to ROI query for one label AND NOT another (Lucene query)")
...
#### ROI query for one label AND another label in different ROIs [​](https://clear.ml/docs/latest/docs/hyperdatasets/dataviews/\#roi-query-for-one-label-and-another-label-in-different-rois "Direct link to ROI query for one label AND another label in different ROIs")

This example uses an ROI query to filter for frames containing at least one ROI with the label `Car` and at least one
ROI with the label `Person`. The example demonstrates using the `roi_queries` parameter of [`DataView.add_multi_query()`](https://clear.ml/docs/latest/docs/references/hyperdataset/dataview#add_multi_query)
with a list of [`DataView.RoiQuery`](https://clear.ml/docs/latest/docs/references/hyperdataset/dataview#roiquery) objects:
...
#### ROI query for one label AND NOT another label in different ROIs [​](https://clear.ml/docs/latest/docs/hyperdatasets/dataviews/\#roi-query-for-one-label-and-not-another-label-in-different-rois "Direct link to ROI query for one label AND NOT another label in different ROIs")

This example uses an ROI query to filter for frames containing at least one ROI with the label `Car` AND that DO NOT
contain ROIs with the label `Person`. To exclude an ROI, pass `must_not=True` in the [`DataView.RoiQuery`](https://clear.ml/docs/latest/docs/references/hyperdataset/dataview#roiquery)
object.
...
#### Querying Multiple Datasets and Versions [​](https://clear.ml/docs/latest/docs/hyperdatasets/dataviews/\#querying-multiple-datasets-and-versions "Direct link to Querying Multiple Datasets and Versions")
...
### Frame Queries [​](https://clear.ml/docs/latest/docs/hyperdatasets/dataviews/\#frame-queries "Direct link to Frame Queries")
...
#### Frame Query by Metadata [​](https://clear.ml/docs/latest/docs/hyperdatasets/dataviews/\#frame-query-by-metadata "Direct link to Frame Query by Metadata")
...
#### Frame Query by Date and Time [​](https://clear.ml/docs/latest/docs/hyperdatasets/dataviews/\#frame-query-by-date-and-time "Direct link to Frame Query by Date and Time")

Provided that a metadata field stores date and time values, you can query frames based on date ranges and specific time
intervals

##### Frame Query for Specific Date [​](https://clear.ml/docs/latest/docs/hyperdatasets/dataviews/\#frame-query-for-specific-date "Direct link to Frame Query for Specific Date")
...
##### Frame Query for Date Range [​](https://clear.ml/docs/latest/docs/hyperdatasets/dataviews/\#frame-query-for-date-range "Direct link to Frame Query for Date Range")
...
##### Frame Query for Time Interval [​](https://clear.ml/docs/latest/docs/hyperdatasets/dataviews/\#frame-query-for-time-interval "Direct link to Frame Query for Time Interval")
...
### Controlling Query Iteration [​](https://clear.ml/docs/latest/docs/hyperdatasets/dataviews/\#controlling-query-iteration "Direct link to Controlling Query Iteration")

Use [`DataView.set_iteration_parameters()`](https://clear.ml/docs/latest/docs/references/hyperdataset/dataview#set_iteration_parameters) to manage the
order, number, timing, and reproducibility of frames for training.

#### Iterate Frames Infinitely [​](https://clear.ml/docs/latest/docs/hyperdatasets/dataviews/\#iterate-frames-infinitely "Direct link to Iterate Frames Infinitely")
...
#### Iterate All Frames Matching the Query [​](https://clear.ml/docs/latest/docs/hyperdatasets/dataviews/\#iterate-all-frames-matching-the-query "Direct link to Iterate All Frames Matching the Query")
...
#### Iterate a Maximum Number of Frames [​](https://clear.ml/docs/latest/docs/hyperdatasets/dataviews/\#iterate-a-maximum-number-of-frames "Direct link to Iterate a Maximum Number of Frames")
...
### Debiasing Input Data [​](https://clear.ml/docs/latest/docs/hyperdatasets/dataviews/\#debiasing-input-data-1 "Direct link to Debiasing Input Data")

Debias input data using the [`DataView.add_query`](https://clear.ml/docs/latest/docs/references/hyperdataset/dataview#add_query) method's `weight`
...
### Setting Label Enumeration Values [​](https://clear.ml/docs/latest/docs/hyperdatasets/dataviews/\#setting-label-enumeration-values "Direct link to Setting Label Enumeration Values")
...
If certain ROI labels are [mapped](https://clear.ml/docs/latest/docs/hyperdatasets/dataviews/#mapping-roi-labels) from certain labels **to** other labels,
...
### Mapping ROI Labels [​](https://clear.ml/docs/latest/docs/hyperdatasets/dataviews/\#mapping-roi-labels "Direct link to Mapping ROI Labels")
...
### Accessing Frames [​](https://clear.ml/docs/latest/docs/hyperdatasets/dataviews/\#accessing-frames "Direct link to Accessing Frames")

Dataview objects can be retrieved by the Dataview ID or name using the [`DataView.get`](https://clear.ml/docs/latest/docs/references/hyperdataset/dataview#dataviewget)
class method.
...
[`DataView.to_list()`](https://clear.ml/docs/latest/docs/references/hyperdataset/dataview#to_list) returns the Dataview queries result as a Python list.

[`DataView.to_dict()`](https://clear.ml/docs/latest/docs/references/hyperdataset/dataview#to_dict) returns a list of dictionaries, where each dictionary represents a frame. Use the
...
Since the `to_list`/`to_dict` methods return all the frames in the Dataview, it is recommended to use the [`DataView.get_iterator`](https://clear.ml/docs/latest/docs/references/hyperdataset/dataview#get_iterator)
...
- [Dataview State](https://clear.ml/docs/latest/docs/hyperdatasets/dataviews/#dataview-state)
- [Filtering](https://clear.ml/docs/latest/docs/hyperdatasets/dataviews/#filtering)
- [Debiasing Input Data](https://clear.ml/docs/latest/docs/hyperdatasets/dataviews/#debiasing-input-data)
- [ROI Label Mapping (Label Translation)](https://clear.ml/docs/latest/docs/hyperdatasets/dataviews/#roi-label-mapping-label-translation)
- [Class Label Enumeration](https://clear.ml/docs/latest/docs/hyperdatasets/dataviews/#class-label-enumeration)
- [Iteration Control](https://clear.ml/docs/latest/docs/hyperdatasets/dataviews/#iteration-control)
- [Usage](https://clear.ml/docs/latest/docs/hyperdatasets/dataviews/#usage)
  - [Creating Dataviews](https://clear.ml/docs/latest/docs/hyperdatasets/dataviews/#creating-dataviews)
  - [Adding Queries](https://clear.ml/docs/latest/docs/hyperdatasets/dataviews/#adding-queries)
  - [ROI Query Examples](https://clear.ml/docs/latest/docs/hyperdatasets/dataviews/#roi-query-examples)
  - [Frame Queries](https://clear.ml/docs/latest/docs/hyperdatasets/dataviews/#frame-queries)
  - [Controlling Query Iteration](https://clear.ml/docs/latest/docs/hyperdatasets/dataviews/#controlling-query-iteration)
  - [Debiasing Input Data](https://clear.ml/docs/latest/docs/hyperdatasets/dataviews/#debiasing-input-data-1)
  - [Setting Label Enumeration Values](https://clear.ml/docs/latest/docs/hyperdatasets/dataviews/#setting-label-enumeration-values)
  - [Mapping ROI Labels](https://clear.ml/docs/latest/docs/hyperdatasets/dataviews/#mapping-roi-labels)
  - [Accessing Frames](https://clear.ml/docs/latest/docs/hyperdatasets/dataviews/#accessing-frames)