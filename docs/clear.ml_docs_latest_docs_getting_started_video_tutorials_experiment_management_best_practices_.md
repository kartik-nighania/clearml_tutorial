---
url: "https://clear.ml/docs/latest/docs/getting_started/video_tutorials/experiment_management_best_practices/"
title: "Experiment Management Best Practices | ClearML"
---

[Skip to main content](https://clear.ml/docs/latest/docs/getting_started/video_tutorials/experiment_management_best_practices/#__docusaurus_skipToContent_fallback)

If you ❤️ ️ **ClearML**, ⭐️ us on [GitHub](https://github.com/clearml/clearml)!

On this page

## Video Tutorial [​](https://clear.ml/docs/latest/docs/getting_started/video_tutorials/experiment_management_best_practices/\#video-tutorial "Direct link to Video Tutorial")

3 - Experiment Management Best Practices - YouTube

Tap to unmute

[3 - Experiment Management Best Practices](https://www.youtube.com/watch?v=kyOfwVg05EM) [ClearML](https://www.youtube.com/channel/UCDYdA4hjckRLRVBrCoKenCQ)
...
Another type of artifact are model files or weight files, but _they_ get a special place in the ClearML ecosystem. First of all models that are saved using any of the major machine learning libraries will automatically be captured just like the command line arguments from before.
...
- [Video Tutorial](https://clear.ml/docs/latest/docs/getting_started/video_tutorials/experiment_management_best_practices/#video-tutorial)