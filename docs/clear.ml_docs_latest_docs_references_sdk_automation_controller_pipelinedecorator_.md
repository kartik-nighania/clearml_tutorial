---
url: "https://clear.ml/docs/latest/docs/references/sdk/automation_controller_pipelinedecorator/"
title: "PipelineDecorator | ClearML"
---

[Skip to main content](https://clear.ml/docs/latest/docs/references/sdk/automation_controller_pipelinedecorator/#__docusaurus_skipToContent_fallback)

If you ❤️ ️ **ClearML**, ⭐️ us on [GitHub](https://github.com/clearml/clearml)!

On this page

## _class_ automation.controller.PipelineDecorator(name, project, version=None, pool\_frequency=0.2, add\_pipeline\_tags=False, target\_project=None, abort\_on\_failure=False, add\_run\_number=True, retry\_on\_failure=None, docker=None, docker\_args=None, docker\_bash\_setup\_script=None, packages=None, repo=None, repo\_branch=None, repo\_commit=None, artifact\_serialization\_function=None, artifact\_deserialization\_function=None, output\_uri=None, skip\_global\_imports=False, working\_dir=None, enable\_local\_imports=True) [​](https://clear.ml/docs/latest/docs/references/sdk/automation_controller_pipelinedecorator/\#class-automationcontrollerpipelinedecoratorname-project-versionnone-pool_frequency02-add_pipeline_tagsfalse-target_projectnone-abort_on_failurefalse-add_run_numbertrue-retry_on_failurenone-dockernone-docker_argsnone-docker_bash_setup_scriptnone-packagesnone-reponone-repo_branchnone-repo_commitnone-artifact_serialization_functionnone-artifact_deserialization_functionnone-output_urinone-skip_global_importsfalse-working_dirnone-enable_local_importstrue "Direct link to class-automationcontrollerpipelinedecoratorname-project-versionnone-pool_frequency02-add_pipeline_tagsfalse-target_projectnone-abort_on_failurefalse-add_run_numbertrue-retry_on_failurenone-dockernone-docker_argsnone-docker_bash_setup_scriptnone-packagesnone-reponone-repo_branchnone-repo_commitnone-artifact_serialization_functionnone-artifact_deserialization_functionnone-output_urinone-skip_global_importsfalse-working_dirnone-enable_local_importstrue")
...
- **Parameters**
  ...
  - **retry\_on\_failure** (`Union`\[`int`, `Callable`\[\[ [`PipelineController`](https://clear.ml/docs/latest/docs/references/sdk/automation_controller_pipelinecontroller#clearml.PipelineController), `Node`, `int`\], `bool`\], `None`\]) – Integer (number of retries) or Callback function that returns True to allow a retry
...
```
  ...
  - **skip\_global\_imports** (`bool`) – If True, global imports will not be included in the steps’ execution, otherwise all
...
### add\_function\_step [​](https://clear.ml/docs/latest/docs/references/sdk/automation_controller_pipelinedecorator/\#add_function_step "Direct link to add_function_step")
...
- **Parameters**
  ...
  - **pre\_execute\_callback** (`Optional`\[`Callable`\[\[ [`PipelineController`](https://clear.ml/docs/latest/docs/references/sdk/automation_controller_pipelinecontroller#clearml.PipelineController), `Node`, `dict`\], `bool`\]\]) – Callback function, called when the step (Task) is created
...
```
  ...
  - **post\_execute\_callback** (`Optional`\[`Callable`\[\[ [`PipelineController`](https://clear.ml/docs/latest/docs/references/sdk/automation_controller_pipelinecontroller#clearml.PipelineController), `Node`\], `None`\]\]) – Callback function, called when a step (Task) is completed
...
```
  ...
  - **status\_change\_callback** (`Optional`\[`Callable`\[\[ [`PipelineController`](https://clear.ml/docs/latest/docs/references/sdk/automation_controller_pipelinecontroller#clearml.PipelineController), `Node`, `str`\], `None`\]\]) – Callback function, called when the status of a step (Task) changes.
    Use node.job to access the ClearmlJob object, or node.job.task to directly access the Task object.
...
### add\_parameter [​](https://clear.ml/docs/latest/docs/references/sdk/automation_controller_pipelinedecorator/\#add_parameter "Direct link to add_parameter")
...
### add\_step [​](https://clear.ml/docs/latest/docs/references/sdk/automation_controller_pipelinedecorator/\#add_step "Direct link to add_step")
...
### add\_tags [​](https://clear.ml/docs/latest/docs/references/sdk/automation_controller_pipelinedecorator/\#add_tags "Direct link to add_tags")
...
### PipelineDecorator.clone [​](https://clear.ml/docs/latest/docs/references/sdk/automation_controller_pipelinedecorator/\#pipelinedecoratorclone "Direct link to PipelineDecorator.clone")
...
[`PipelineController`](https://clear.ml/docs/latest/docs/references/sdk/automation_controller_pipelinecontroller#clearml.PipelineController)
...
### PipelineDecorator.component [​](https://clear.ml/docs/latest/docs/references/sdk/automation_controller_pipelinedecorator/\#pipelinedecoratorcomponent "Direct link to PipelineDecorator.component")

\* _classmethod component(\_func=None, , return\_values=('return\_object',), name=None, cache=False, packages=None, parents=None, execution\_queue=None, continue\_on\_fail=False, docker=None, docker\_args=None, docker\_bash\_setup\_script=None, task\_type=None, auto\_connect\_frameworks=None, auto\_connect\_arg\_parser=None, repo=None, repo\_branch=None, repo\_commit=None, helper\_functions=None, monitor\_metrics=None, monitor\_artifacts=None, monitor\_models=None, retry\_on\_failure=None, pre\_execute\_callback=None, post\_execute\_callback=None, status\_change\_callback=None, tags=None, output\_uri=None, draft=False, working\_dir=None, continue\_behaviour=None, stage=None)_
...
- **Parameters**
  ...
  - **\_func** (`Optional`\[`Any`\]) – wrapper function

  - **return\_values** (`Union`\[`str`, `Sequence`\[`str`\]\]) – Provide a list of names for all the results.
    Notice! If not provided, no results will be stored as artifacts.

  - **name** (`Optional`\[`str`\]) – Optional, set the name of the pipeline component task.
    If not provided, the wrapped function name is used as the pipeline component name

  - **cache** (`bool`) – If True, before launching the new step,
    after updating with the latest configuration, check if an exact Task with the same parameter/code
  ...
  - **parents** (`Optional`\[`List`\[`str`\]\]) – Optional list of parent nodes in the DAG.
    The current step in the pipeline will be sent for execution only after all the parent nodes
    have been executed successfully.
  ...
  - **docker\_args** (`Optional`\[`str`\]) – Add docker execution arguments for the remote execution
    (use single string for all docker arguments).

  - **docker\_bash\_setup\_script** (`Optional`\[`str`\]) – Add a bash script to be executed inside the docker before
  ...
  - **helper\_functions** (`Optional`\[`Sequence`\[`Callable`\]\]) – Optional, a list of helper functions to make available
    ...
    Example, assuming we have two functions parse\_data(), and load\_data(): \[parse\_data, load\_data\]

  - **monitor\_metrics** (`Optional`\[`List`\[`Union`\[`Tuple`\[`str`, `str`\], `Tuple`\]\]\]) – Optional, Automatically log the step’s reported metrics also on the pipeline Task.
  ...
  - **monitor\_artifacts** (`Optional`\[`List`\[`Union`\[`str`, `Tuple`\[`str`, `str`\]\]\]\]) – Optional, Automatically log the step’s artifacts on the pipeline Task.
  ...
  - **monitor\_models** (`Optional`\[`List`\[`Union`\[`str`, `Tuple`\[`str`, `str`\]\]\]\]) – Optional, Automatically log the step’s output models on the pipeline Task.
...
```
  ...
  - **working\_dir** (`Optional`\[`str`\]) – Working directory to launch the step from.
...
### connect\_configuration [​](https://clear.ml/docs/latest/docs/references/sdk/automation_controller_pipelinedecorator/\#connect_configuration "Direct link to connect_configuration")
...
### PipelineDecorator.create [​](https://clear.ml/docs/latest/docs/references/sdk/automation_controller_pipelinedecorator/\#pipelinedecoratorcreate "Direct link to PipelineDecorator.create")
...
### create\_draft [​](https://clear.ml/docs/latest/docs/references/sdk/automation_controller_pipelinedecorator/\#create_draft "Direct link to create_draft")
...
### PipelineDecorator.debug\_pipeline [​](https://clear.ml/docs/latest/docs/references/sdk/automation_controller_pipelinedecorator/\#pipelinedecoratordebug_pipeline "Direct link to PipelineDecorator.debug_pipeline")

**_classmethod_ debug\_pipeline()**
...
### elapsed [​](https://clear.ml/docs/latest/docs/references/sdk/automation_controller_pipelinedecorator/\#elapsed "Direct link to elapsed")
...
### PipelineDecorator.enqueue [​](https://clear.ml/docs/latest/docs/references/sdk/automation_controller_pipelinedecorator/\#pipelinedecoratorenqueue "Direct link to PipelineDecorator.enqueue")
...
- **Parameters**
  - **pipeline\_controller** (`Union`\[ [`PipelineController`](https://clear.ml/docs/latest/docs/references/sdk/automation_controller_pipelinecontroller#clearml.PipelineController), `str`\]) – The PipelineController to enqueue. Specify a PipelineController object or PipelineController ID
...
### PipelineDecorator.get [​](https://clear.ml/docs/latest/docs/references/sdk/automation_controller_pipelinedecorator/\#pipelinedecoratorget "Direct link to PipelineDecorator.get")
...
### PipelineDecorator.get\_current\_pipeline [​](https://clear.ml/docs/latest/docs/references/sdk/automation_controller_pipelinedecorator/\#pipelinedecoratorget_current_pipeline "Direct link to PipelineDecorator.get_current_pipeline")

**_classmethod_ get\_current\_pipeline()**
...
### PipelineDecorator.get\_logger [​](https://clear.ml/docs/latest/docs/references/sdk/automation_controller_pipelinedecorator/\#pipelinedecoratorget_logger "Direct link to PipelineDecorator.get_logger")
...
### get\_parameters [​](https://clear.ml/docs/latest/docs/references/sdk/automation_controller_pipelinedecorator/\#get_parameters "Direct link to get_parameters")
...
### get\_pipeline\_dag [​](https://clear.ml/docs/latest/docs/references/sdk/automation_controller_pipelinedecorator/\#get_pipeline_dag "Direct link to get_pipeline_dag")
...
### get\_processed\_nodes [​](https://clear.ml/docs/latest/docs/references/sdk/automation_controller_pipelinedecorator/\#get_processed_nodes "Direct link to get_processed_nodes")
...
### get\_running\_nodes [​](https://clear.ml/docs/latest/docs/references/sdk/automation_controller_pipelinedecorator/\#get_running_nodes "Direct link to get_running_nodes")
...
### is\_running [​](https://clear.ml/docs/latest/docs/references/sdk/automation_controller_pipelinedecorator/\#is_running "Direct link to is_running")
...
### is\_successful [​](https://clear.ml/docs/latest/docs/references/sdk/automation_controller_pipelinedecorator/\#is_successful "Direct link to is_successful")
...
### PipelineDecorator.pipeline [​](https://clear.ml/docs/latest/docs/references/sdk/automation_controller_pipelinedecorator/\#pipelinedecoratorpipeline "Direct link to PipelineDecorator.pipeline")

\* _classmethod pipeline(\_func=None, , name, project, version=None, return\_value=None, default\_queue=None, pool\_frequency=0.2, add\_pipeline\_tags=False, target\_project=None, abort\_on\_failure=False, pipeline\_execution\_queue='services', multi\_instance\_support=False, add\_run\_number=True, args\_map=None, start\_controller\_locally=False, retry\_on\_failure=None, docker=None, docker\_args=None, docker\_bash\_setup\_script=None, packages=None, repo=None, repo\_branch=None, repo\_commit=None, artifact\_serialization\_function=None, artifact\_deserialization\_function=None, output\_uri=None, skip\_global\_imports=False, working\_dir=None, enable\_local\_imports=True)_
...
- **Parameters**
  ...
  - **return\_value** (`Optional`\[`str`\]) – Optional, Provide an artifact name to store the pipeline function return object
    Notice, If not provided the pipeline will not store the pipeline function return value.

  - **default\_queue** (`Optional`\[`str`\]) – default pipeline step queue
  ...
  - **pipeline\_execution\_queue** (`Optional`\[`str`\]) – remote pipeline execution queue (default ‘services’ queue).
    If None is passed, execute the pipeline logic locally (pipeline steps are still executed remotely)

  - **multi\_instance\_support** (`bool`) – If True, allow multiple calls to the same pipeline function,
    ...
    If multi\_instance\_support==’parallel’ then the pipeline calls are executed in parallel,
    in the parallel case the function calls return None, to collect all pipeline results call
    PipelineDecorator.wait\_for\_multi\_pipelines().
    Default False, no multi instance pipeline support.

  - **add\_run\_number** (`bool`) – If True (default), add the run number of the pipeline to the pipeline name.
    Example, the second time we launch the pipeline “best pipeline”, we rename it to “best pipeline #2”

  - **args\_map** (`Optional`\[`Dict`\[`str`, `List`\[`str`\]\]\]) – Map arguments to their specific configuration section. Arguments not included in this map
    ...
    - paramD: Args/paramD
  - **start\_controller\_locally** (`bool`) – If True, start the controller on the local machine. The steps will run
    remotely if PipelineDecorator.run\_locally or PipelineDecorator.debug\_pipeline are not called.
    Default: False
...
```
  ...
  - **\_func** ( _Optional_ _\[_ _Any_ _\]_ ) –
- **Return type**
...
### PipelineDecorator.run\_locally [​](https://clear.ml/docs/latest/docs/references/sdk/automation_controller_pipelinedecorator/\#pipelinedecoratorrun_locally "Direct link to PipelineDecorator.run_locally")

**_classmethod_ run\_locally()**
...
### PipelineDecorator.set\_default\_execution\_queue [​](https://clear.ml/docs/latest/docs/references/sdk/automation_controller_pipelinedecorator/\#pipelinedecoratorset_default_execution_queue "Direct link to PipelineDecorator.set_default_execution_queue")

**_classmethod_ set\_default\_execution\_queue(default\_execution\_queue)**
...
### set\_pipeline\_execution\_time\_limit [​](https://clear.ml/docs/latest/docs/references/sdk/automation_controller_pipelinedecorator/\#set_pipeline_execution_time_limit "Direct link to set_pipeline_execution_time_limit")
...
### start [​](https://clear.ml/docs/latest/docs/references/sdk/automation_controller_pipelinedecorator/\#start "Direct link to start")
...
### start\_locally [​](https://clear.ml/docs/latest/docs/references/sdk/automation_controller_pipelinedecorator/\#start_locally "Direct link to start_locally")
...
### stop [​](https://clear.ml/docs/latest/docs/references/sdk/automation_controller_pipelinedecorator/\#stop "Direct link to stop")
...
### update\_execution\_plot [​](https://clear.ml/docs/latest/docs/references/sdk/automation_controller_pipelinedecorator/\#update_execution_plot "Direct link to update_execution_plot")
...
### PipelineDecorator.upload\_artifact [​](https://clear.ml/docs/latest/docs/references/sdk/automation_controller_pipelinedecorator/\#pipelinedecoratorupload_artifact "Direct link to PipelineDecorator.upload_artifact")
...
### PipelineDecorator.upload\_model [​](https://clear.ml/docs/latest/docs/references/sdk/automation_controller_pipelinedecorator/\#pipelinedecoratorupload_model "Direct link to PipelineDecorator.upload_model")
...
### wait [​](https://clear.ml/docs/latest/docs/references/sdk/automation_controller_pipelinedecorator/\#wait "Direct link to wait")
...
### PipelineDecorator.wait\_for\_multi\_pipelines [​](https://clear.ml/docs/latest/docs/references/sdk/automation_controller_pipelinedecorator/\#pipelinedecoratorwait_for_multi_pipelines "Direct link to PipelineDecorator.wait_for_multi_pipelines")

**_classmethod_ wait\_for\_multi\_pipelines()**
...
- [_class_ automation.controller.PipelineDecorator(name, project, version=None, pool\_frequency=0.2, add\_pipeline\_tags=False, target\_project=None, abort\_on\_failure=False, add\_run\_number=True, retry\_on\_failure=None, docker=None, docker\_args=None, docker\_bash\_setup\_script=None, packages=None, repo=None, repo\_branch=None, repo\_commit=None, artifact\_serialization\_function=None, artifact\_deserialization\_function=None, output\_uri=None, skip\_global\_imports=False, working\_dir=None, enable\_local\_imports=True)](https://clear.ml/docs/latest/docs/references/sdk/automation_controller_pipelinedecorator/#class-automationcontrollerpipelinedecoratorname-project-versionnone-pool_frequency02-add_pipeline_tagsfalse-target_projectnone-abort_on_failurefalse-add_run_numbertrue-retry_on_failurenone-dockernone-docker_argsnone-docker_bash_setup_scriptnone-packagesnone-reponone-repo_branchnone-repo_commitnone-artifact_serialization_functionnone-artifact_deserialization_functionnone-output_urinone-skip_global_importsfalse-working_dirnone-enable_local_importstrue)
  - [add\_function\_step](https://clear.ml/docs/latest/docs/references/sdk/automation_controller_pipelinedecorator/#add_function_step)
  - [add\_parameter](https://clear.ml/docs/latest/docs/references/sdk/automation_controller_pipelinedecorator/#add_parameter)
  - [add\_step](https://clear.ml/docs/latest/docs/references/sdk/automation_controller_pipelinedecorator/#add_step)
  - [add\_tags](https://clear.ml/docs/latest/docs/references/sdk/automation_controller_pipelinedecorator/#add_tags)
  - [PipelineDecorator.clone](https://clear.ml/docs/latest/docs/references/sdk/automation_controller_pipelinedecorator/#pipelinedecoratorclone)
  ...
  - [connect\_configuration](https://clear.ml/docs/latest/docs/references/sdk/automation_controller_pipelinedecorator/#connect_configuration)
  - [PipelineDecorator.create](https://clear.ml/docs/latest/docs/references/sdk/automation_controller_pipelinedecorator/#pipelinedecoratorcreate)
  - [create\_draft](https://clear.ml/docs/latest/docs/references/sdk/automation_controller_pipelinedecorator/#create_draft)
  - [PipelineDecorator.debug\_pipeline](https://clear.ml/docs/latest/docs/references/sdk/automation_controller_pipelinedecorator/#pipelinedecoratordebug_pipeline)
  - [elapsed](https://clear.ml/docs/latest/docs/references/sdk/automation_controller_pipelinedecorator/#elapsed)
  - [PipelineDecorator.enqueue](https://clear.ml/docs/latest/docs/references/sdk/automation_controller_pipelinedecorator/#pipelinedecoratorenqueue)
  - [PipelineDecorator.get](https://clear.ml/docs/latest/docs/references/sdk/automation_controller_pipelinedecorator/#pipelinedecoratorget)
  - [PipelineDecorator.get\_current\_pipeline](https://clear.ml/docs/latest/docs/references/sdk/automation_controller_pipelinedecorator/#pipelinedecoratorget_current_pipeline)
  - [PipelineDecorator.get\_logger](https://clear.ml/docs/latest/docs/references/sdk/automation_controller_pipelinedecorator/#pipelinedecoratorget_logger)
  - [get\_parameters](https://clear.ml/docs/latest/docs/references/sdk/automation_controller_pipelinedecorator/#get_parameters)
  - [get\_pipeline\_dag](https://clear.ml/docs/latest/docs/references/sdk/automation_controller_pipelinedecorator/#get_pipeline_dag)
  - [get\_processed\_nodes](https://clear.ml/docs/latest/docs/references/sdk/automation_controller_pipelinedecorator/#get_processed_nodes)
  - [get\_running\_nodes](https://clear.ml/docs/latest/docs/references/sdk/automation_controller_pipelinedecorator/#get_running_nodes)
  - [is\_running](https://clear.ml/docs/latest/docs/references/sdk/automation_controller_pipelinedecorator/#is_running)
  - [is\_successful](https://clear.ml/docs/latest/docs/references/sdk/automation_controller_pipelinedecorator/#is_successful)
  - [PipelineDecorator.pipeline](https://clear.ml/docs/latest/docs/references/sdk/automation_controller_pipelinedecorator/#pipelinedecoratorpipeline)
  - [PipelineDecorator.run\_locally](https://clear.ml/docs/latest/docs/references/sdk/automation_controller_pipelinedecorator/#pipelinedecoratorrun_locally)
  - [PipelineDecorator.set\_default\_execution\_queue](https://clear.ml/docs/latest/docs/references/sdk/automation_controller_pipelinedecorator/#pipelinedecoratorset_default_execution_queue)
  - [set\_pipeline\_execution\_time\_limit](https://clear.ml/docs/latest/docs/references/sdk/automation_controller_pipelinedecorator/#set_pipeline_execution_time_limit)
  - [start](https://clear.ml/docs/latest/docs/references/sdk/automation_controller_pipelinedecorator/#start)
  - [start\_locally](https://clear.ml/docs/latest/docs/references/sdk/automation_controller_pipelinedecorator/#start_locally)
  - [stop](https://clear.ml/docs/latest/docs/references/sdk/automation_controller_pipelinedecorator/#stop)
  - [update\_execution\_plot](https://clear.ml/docs/latest/docs/references/sdk/automation_controller_pipelinedecorator/#update_execution_plot)
  - [PipelineDecorator.upload\_artifact](https://clear.ml/docs/latest/docs/references/sdk/automation_controller_pipelinedecorator/#pipelinedecoratorupload_artifact)
  - [PipelineDecorator.upload\_model](https://clear.ml/docs/latest/docs/references/sdk/automation_controller_pipelinedecorator/#pipelinedecoratorupload_model)
  - [wait](https://clear.ml/docs/latest/docs/references/sdk/automation_controller_pipelinedecorator/#wait)
  - [PipelineDecorator.wait\_for\_multi\_pipelines](https://clear.ml/docs/latest/docs/references/sdk/automation_controller_pipelinedecorator/#pipelinedecoratorwait_for_multi_pipelines)