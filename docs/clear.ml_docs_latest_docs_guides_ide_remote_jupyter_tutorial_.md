---
url: "https://clear.ml/docs/latest/docs/guides/ide/remote_jupyter_tutorial/"
title: "Remote Jupyter Tutorial | ClearML"
---

[Skip to main content](https://clear.ml/docs/latest/docs/guides/ide/remote_jupyter_tutorial/#__docusaurus_skipToContent_fallback)
...
## Prerequisites [​](https://clear.ml/docs/latest/docs/guides/ide/remote_jupyter_tutorial/\#prerequisites "Direct link to Prerequisites")

- `clearml-session` package installed (`pip install clearml-session`)
- At least one `clearml-agent` running on a **remote** host. See [installation details](https://clear.ml/docs/latest/docs/clearml_agent/clearml_agent_deployment_bare_metal#installation).
...
## Steps [​](https://clear.ml/docs/latest/docs/guides/ide/remote_jupyter_tutorial/\#steps "Direct link to Steps")

### Step 1: Launch `clearml-session` [​](https://clear.ml/docs/latest/docs/guides/ide/remote_jupyter_tutorial/\#step-1-launch-clearml-session "Direct link to step-1-launch-clearml-session")
...
### Step 2: Launch Interactive Session [​](https://clear.ml/docs/latest/docs/guides/ide/remote_jupyter_tutorial/\#step-2-launch-interactive-session "Direct link to Step 2: Launch Interactive Session")
...
### Step 3: Connect to Remote Notebook [​](https://clear.ml/docs/latest/docs/guides/ide/remote_jupyter_tutorial/\#step-3-connect-to-remote-notebook "Direct link to Step 3: Connect to Remote Notebook")
...
### Step 4: Execute Code [​](https://clear.ml/docs/latest/docs/guides/ide/remote_jupyter_tutorial/\#step-4-execute-code "Direct link to Step 4: Execute Code")

1. Open up a new Notebook.

2. In the first cell of the notebook, clone the [ClearML repository](https://github.com/clearml/clearml):
...
3. In the second cell of the notebook, run this [script](https://github.com/clearml/clearml/blob/master/examples/frameworks/keras/keras_tensorboard.py)
...
### Step 5: Shut Down Remote Session [​](https://clear.ml/docs/latest/docs/guides/ide/remote_jupyter_tutorial/\#step-5-shut-down-remote-session "Direct link to Step 5: Shut Down Remote Session")
...
- [Prerequisites](https://clear.ml/docs/latest/docs/guides/ide/remote_jupyter_tutorial/#prerequisites)
- [Steps](https://clear.ml/docs/latest/docs/guides/ide/remote_jupyter_tutorial/#steps)
  - [Step 1: Launch `clearml-session`](https://clear.ml/docs/latest/docs/guides/ide/remote_jupyter_tutorial/#step-1-launch-clearml-session)
  - [Step 2: Launch Interactive Session](https://clear.ml/docs/latest/docs/guides/ide/remote_jupyter_tutorial/#step-2-launch-interactive-session)
  - [Step 3: Connect to Remote Notebook](https://clear.ml/docs/latest/docs/guides/ide/remote_jupyter_tutorial/#step-3-connect-to-remote-notebook)
  - [Step 4: Execute Code](https://clear.ml/docs/latest/docs/guides/ide/remote_jupyter_tutorial/#step-4-execute-code)
  - [Step 5: Shut Down Remote Session](https://clear.ml/docs/latest/docs/guides/ide/remote_jupyter_tutorial/#step-5-shut-down-remote-session)