---
url: "https://clear.ml/docs/latest/docs/guides/ui/building_leader_board/"
title: "Tracking Leaderboards | ClearML"
---

[Skip to main content](https://clear.ml/docs/latest/docs/guides/ui/building_leader_board/#__docusaurus_skipToContent_fallback)
...
using a customized [task table](https://clear.ml/docs/latest/docs/webapp/webapp_exp_table) with auto refresh for continual updates.
...
## Step 1: Select a Project [​](https://clear.ml/docs/latest/docs/guides/ui/building_leader_board/\#step-1-select-a-project "Direct link to Step 1: Select a Project")

The leaderboard will track tasks in one or all projects.

Begin by opening the [ClearML Web UI](https://clear.ml/docs/latest/docs/webapp/webapp_overview) and selecting a project, by doing one of the following:

- On the Dashboard, click a project card or **VIEW ALL**.
- On the Projects page, click a project card or the **All projects** card.

## Step 2: Filter the Tasks [​](https://clear.ml/docs/latest/docs/guides/ui/building_leader_board/\#step-2-filter-the-tasks "Direct link to Step 2: Filter the Tasks")
...
## Step 3: Hide the Default Columns [​](https://clear.ml/docs/latest/docs/guides/ui/building_leader_board/\#step-3-hide-the-default-columns "Direct link to Step 3: Hide the Default Columns")
...
## Step 4: Show Metrics or Hyperparameters [​](https://clear.ml/docs/latest/docs/guides/ui/building_leader_board/\#step-4-show-metrics-or-hyperparameters "Direct link to Step 4: Show Metrics or Hyperparameters")
...
1. Click settings.
2. For metrics, click **\+ METRIC**, expand a metric category, and then select the metric checkboxes of those to show in
...
## Step 5: Enable Auto Refresh [​](https://clear.ml/docs/latest/docs/guides/ui/building_leader_board/\#step-5-enable-auto-refresh "Direct link to Step 5: Enable Auto Refresh")
...
## Step 6: Save the Tracking Leaderboard [​](https://clear.ml/docs/latest/docs/guides/ui/building_leader_board/\#step-6-save-the-tracking-leaderboard "Direct link to Step 6: Save the Tracking Leaderboard")
...
- [Step 1: Select a Project](https://clear.ml/docs/latest/docs/guides/ui/building_leader_board/#step-1-select-a-project)
- [Step 2: Filter the Tasks](https://clear.ml/docs/latest/docs/guides/ui/building_leader_board/#step-2-filter-the-tasks)
- [Step 3: Hide the Default Columns](https://clear.ml/docs/latest/docs/guides/ui/building_leader_board/#step-3-hide-the-default-columns)
- [Step 4: Show Metrics or Hyperparameters](https://clear.ml/docs/latest/docs/guides/ui/building_leader_board/#step-4-show-metrics-or-hyperparameters)
- [Step 5: Enable Auto Refresh](https://clear.ml/docs/latest/docs/guides/ui/building_leader_board/#step-5-enable-auto-refresh)
- [Step 6: Save the Tracking Leaderboard](https://clear.ml/docs/latest/docs/guides/ui/building_leader_board/#step-6-save-the-tracking-leaderboard)