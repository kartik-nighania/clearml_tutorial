---
url: "https://clear.ml/docs/latest/docs/integrations/autokeras/"
title: "AutoKeras | ClearML"
---

[Skip to main content](https://clear.ml/docs/latest/docs/integrations/autokeras/#__docusaurus_skipToContent_fallback)
...
If you are not already using ClearML, see [Getting Started](https://clear.ml/docs/latest/docs/clearml_sdk/clearml_sdk_setup) for setup
instructions.
...
See an example of AutoKeras and ClearML in action [here](https://clear.ml/docs/latest/docs/guides/frameworks/autokeras/autokeras_imdb_example).

![Task scalars](https://clear.ml/docs/latest/assets/images/examples_keras_14-be9723b5914248d3e6469bb28f150a97.png)

## Automatic Logging Control [​](https://clear.ml/docs/latest/docs/integrations/autokeras/\#automatic-logging-control "Direct link to Automatic Logging Control")
...
## Manual Logging [​](https://clear.ml/docs/latest/docs/integrations/autokeras/\#manual-logging "Direct link to Manual Logging")
...
## Remote Execution [​](https://clear.ml/docs/latest/docs/integrations/autokeras/\#remote-execution "Direct link to Remote Execution")
...
### Reproducing Task Runs [​](https://clear.ml/docs/latest/docs/integrations/autokeras/\#reproducing-task-runs "Direct link to Reproducing Task Runs")
...
### Executing a Task Remotely [​](https://clear.ml/docs/latest/docs/integrations/autokeras/\#executing-a-task-remotely "Direct link to Executing a Task Remotely")
...
- [Automatic Logging Control](https://clear.ml/docs/latest/docs/integrations/autokeras/#automatic-logging-control)
- [Manual Logging](https://clear.ml/docs/latest/docs/integrations/autokeras/#manual-logging)
- [Remote Execution](https://clear.ml/docs/latest/docs/integrations/autokeras/#remote-execution)
  - [Reproducing Task Runs](https://clear.ml/docs/latest/docs/integrations/autokeras/#reproducing-task-runs)
  - [Executing a Task Remotely](https://clear.ml/docs/latest/docs/integrations/autokeras/#executing-a-task-remotely)