---
url: "https://clear.ml/docs/latest/docs/guides/services/aws_autoscaler/"
title: "ClearML AWS Autoscaler Service | ClearML"
---

[Skip to main content](https://clear.ml/docs/latest/docs/guides/services/aws_autoscaler/#__docusaurus_skipToContent_fallback)
...
## Running the ClearML AWS Autoscaler [​](https://clear.ml/docs/latest/docs/guides/services/aws_autoscaler/\#running-the-clearml-aws-autoscaler "Direct link to Running the ClearML AWS Autoscaler")

Run the ClearML AWS autoscaler in one of these ways:

- Run the [aws\_autoscaler.py](https://github.com/clearml/clearml/blob/master/examples/services/aws-autoscaler/aws_autoscaler.py)
script locally
- Launch through your [`services` queue](https://clear.ml/docs/latest/docs/clearml_agent/clearml_agent_services_mode)
...
(see [step 5](https://clear.ml/docs/latest/docs/guides/services/aws_autoscaler/#step_5)):
...
### Running the Script [​](https://clear.ml/docs/latest/docs/guides/services/aws_autoscaler/\#running-the-script "Direct link to Running the Script")

Self-deployed ClearML server

A template `AWS Auto-Scaler` task is available in the `DevOps Services` project.
You can clone it, adapt its [configuration](https://clear.ml/docs/latest/docs/guides/services/aws_autoscaler/#configuration) to your needs, and enqueue it for execution directly from the ClearML UI.
...
6. Configure the AWS autoscaler budget. For each queue that will be used in the budget, enter the maximum number of
...
8. The ClearML AWS autoscaler polls instances, and if instances have been idle for the maximum idle time that was specified,
...
### Remote Execution [​](https://clear.ml/docs/latest/docs/guides/services/aws_autoscaler/\#remote-execution "Direct link to Remote Execution")

Using the `--remote` command line option will enqueue the autoscaler to your [`services` queue](https://clear.ml/docs/latest/docs/clearml_agent/clearml_agent_services_mode)
...
## WebApp [​](https://clear.ml/docs/latest/docs/guides/services/aws_autoscaler/\#webapp "Direct link to WebApp")

### Configuration [​](https://clear.ml/docs/latest/docs/guides/services/aws_autoscaler/\#configuration "Direct link to Configuration")

The values configured through the wizard are stored in the task's hyperparameters and configuration objects by using the
[`Task.connect()`](https://clear.ml/docs/latest/docs/references/sdk/task#connect) and [`Task.set_configuration_object()`](https://clear.ml/docs/latest/docs/references/sdk/task#set_configuration_object)
...
![Autoscaler configuration](https://clear.ml/docs/latest/assets/images/examples_aws_autoscaler_config-c1b5a13c3a72cf247865a0173cef3dce.png)
...
in [services mode](https://clear.ml/docs/latest/docs/clearml_agent/clearml_agent_services_mode) for such service tasks).

### Console [​](https://clear.ml/docs/latest/docs/guides/services/aws_autoscaler/\#console "Direct link to Console")

All other console output appears in the task's **CONSOLE**.

![Autoscaler console](https://clear.ml/docs/latest/assets/images/examples_aws_autoscaler_console-3e3347d451a9647f6a105008ade8cab7.png)

- [Running the ClearML AWS Autoscaler](https://clear.ml/docs/latest/docs/guides/services/aws_autoscaler/#running-the-clearml-aws-autoscaler)
  - [Running the Script](https://clear.ml/docs/latest/docs/guides/services/aws_autoscaler/#running-the-script)
  - [Remote Execution](https://clear.ml/docs/latest/docs/guides/services/aws_autoscaler/#remote-execution)
- [WebApp](https://clear.ml/docs/latest/docs/guides/services/aws_autoscaler/#webapp)
  - [Configuration](https://clear.ml/docs/latest/docs/guides/services/aws_autoscaler/#configuration)
  - [Console](https://clear.ml/docs/latest/docs/guides/services/aws_autoscaler/#console)