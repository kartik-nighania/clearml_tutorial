---
url: "https://clear.ml/docs/latest/docs/release_notes/clearml_server/open_source/ver_0_15/"
title: "Version 0.15 | ClearML"
---

[Skip to main content](https://clear.ml/docs/latest/docs/release_notes/clearml_server/open_source/ver_0_15/#__docusaurus_skipToContent_fallback)
...
### Trains Server 0.15.1 [​](https://clear.ml/docs/latest/docs/release_notes/clearml_server/open_source/ver_0_15/\#trains-server-0151 "Direct link to Trains Server 0.15.1")
...
### Trains Server 0.15.0 [​](https://clear.ml/docs/latest/docs/release_notes/clearml_server/open_source/ver_0_15/\#trains-server-0150 "Direct link to Trains Server 0.15.0")
...
- [Trains Server 0.15.1](https://clear.ml/docs/latest/docs/release_notes/clearml_server/open_source/ver_0_15/#trains-server-0151)
- [Trains Server 0.15.0](https://clear.ml/docs/latest/docs/release_notes/clearml_server/open_source/ver_0_15/#trains-server-0150)