---
url: "https://clear.ml/docs/latest/docs/release_notes/clearml_agent/ver_0_16/"
title: "Version 0.16 | ClearML"
---

[Skip to main content](https://clear.ml/docs/latest/docs/release_notes/clearml_agent/ver_0_16/#__docusaurus_skipToContent_fallback)
...
### Trains Agent 0.16.2 [​](https://clear.ml/docs/latest/docs/release_notes/clearml_agent/ver_0_16/\#trains-agent-0162 "Direct link to Trains Agent 0.16.2")

**Features**

- conda:
  - Add `agent.package_manager.conda_env_as_base_docker` allowing "docker\_cmd" to contain link to a full pre-packaged conda environment (`tar.gz` created by `conda-pack`). Use `TRAINS_CONDA_ENV_PACKAGE` environment variable to specify `conda tar.gz` file.
...
- Allow specifying `cudatoolkit` version in the "installed packages" section when using conda as package manager ( [GitHub trains Issue 229](https://github.com/clearml/clearml/issues/229)).
...
### Trains Agent 0.16.1 [​](https://clear.ml/docs/latest/docs/release_notes/clearml_agent/ver_0_16/\#trains-agent-0161 "Direct link to Trains Agent 0.16.1")
...
### Trains Agent 0.16.0 [​](https://clear.ml/docs/latest/docs/release_notes/clearml_agent/ver_0_16/\#trains-agent-0160 "Direct link to Trains Agent 0.16.0")
...
- [Trains Agent 0.16.2](https://clear.ml/docs/latest/docs/release_notes/clearml_agent/ver_0_16/#trains-agent-0162)
- [Trains Agent 0.16.1](https://clear.ml/docs/latest/docs/release_notes/clearml_agent/ver_0_16/#trains-agent-0161)
- [Trains Agent 0.16.0](https://clear.ml/docs/latest/docs/release_notes/clearml_agent/ver_0_16/#trains-agent-0160)