---
url: "https://clear.ml/docs/latest/docs/webapp/applications/apps_model_deployment/"
title: "vLLM Model Deployment | ClearML"
---

[Skip to main content](https://clear.ml/docs/latest/docs/webapp/applications/apps_model_deployment/#__docusaurus_skipToContent_fallback)
...
- Status indicator
  - ![Active instance](https://clear.ml/docs/latest/icons/ico-model-active.svg) \- App instance is running and is actively in use
  - ![Loading instance](https://clear.ml/docs/latest/icons/ico-model-loading.svg) \- App instance is setting up
  - ![Idle instance](https://clear.ml/docs/latest/icons/ico-model-idle.svg) \- App instance is idle
  - ![Stopped instance](https://clear.ml/docs/latest/icons/ico-model-stopped.svg) \- App instance is stopped
...
![vLLM Model Deployment App](https://clear.ml/docs/latest/assets/images/apps_model_deployment-f217e00803fa5e552848507a3b30adc5.png#light-mode-only)![vLLM Model Deployment App](https://clear.ml/docs/latest/assets/images/apps_model_deployment_dark-f3d8d6ba6ad96b8759bd2ca2db6fb28a.png#dark-mode-only)
...
## vLLM Model Deployment Instance Configuration [​](https://clear.ml/docs/latest/docs/webapp/applications/apps_model_deployment/\#vllm-model-deployment-instance-configuration "Direct link to vLLM Model Deployment Instance Configuration")
...
### Configuration Options [​](https://clear.ml/docs/latest/docs/webapp/applications/apps_model_deployment/\#configuration-options "Direct link to Configuration Options")
...
- **Queue**: The [ClearML Queue](https://clear.ml/docs/latest/docs/fundamentals/agents_and_queues#what-is-a-queue) to which the vLLM Model Deployment app
...
![vLLM Model Deployment app form](https://clear.ml/docs/latest/assets/images/apps_model_deployment_form-17f411d7fdb7b55c906aad2169130684.png#light-mode-only)![vLLM Model Deployment app form](https://clear.ml/docs/latest/assets/images/apps_model_deployment_form_dark-bd2a17449b7e167a0774de5f2885eb95.png#dark-mode-only)

- [vLLM Model Deployment Instance Configuration](https://clear.ml/docs/latest/docs/webapp/applications/apps_model_deployment/#vllm-model-deployment-instance-configuration)
  - [Configuration Options](https://clear.ml/docs/latest/docs/webapp/applications/apps_model_deployment/#configuration-options)