---
url: "https://clear.ml/docs/latest/docs/deploying_clearml/enterprise_deploy/change_artifact_links/"
title: "Changing ClearML Artifacts Links | ClearML"
---

[Skip to main content](https://clear.ml/docs/latest/docs/deploying_clearml/enterprise_deploy/change_artifact_links/#__docusaurus_skipToContent_fallback)
...
## Preparation [​](https://clear.ml/docs/latest/docs/deploying_clearml/enterprise_deploy/change_artifact_links/\#preparation "Direct link to Preparation")

### Version Confirmation [​](https://clear.ml/docs/latest/docs/deploying_clearml/enterprise_deploy/change_artifact_links/\#version-confirmation "Direct link to Version Confirmation")
...
### Backup [​](https://clear.ml/docs/latest/docs/deploying_clearml/enterprise_deploy/change_artifact_links/\#backup "Direct link to Backup")
...
## Fixing MongoDB links [​](https://clear.ml/docs/latest/docs/deploying_clearml/enterprise_deploy/change_artifact_links/\#fixing-mongodb-links "Direct link to Fixing MongoDB links")
...
1. Access the `apiserver` Docker container:
   ...
   - In Kubernetes:
     ...
     ```
2. Navigate to the script location in the `upgrade` folder:
...
## Fixing the ElasticSearch Links [​](https://clear.ml/docs/latest/docs/deploying_clearml/enterprise_deploy/change_artifact_links/\#fixing-the-elasticsearch-links "Direct link to Fixing the ElasticSearch Links")
...
- [Preparation](https://clear.ml/docs/latest/docs/deploying_clearml/enterprise_deploy/change_artifact_links/#preparation)
  - [Version Confirmation](https://clear.ml/docs/latest/docs/deploying_clearml/enterprise_deploy/change_artifact_links/#version-confirmation)
  - [Backup](https://clear.ml/docs/latest/docs/deploying_clearml/enterprise_deploy/change_artifact_links/#backup)
- [Fixing MongoDB links](https://clear.ml/docs/latest/docs/deploying_clearml/enterprise_deploy/change_artifact_links/#fixing-mongodb-links)
- [Fixing the ElasticSearch Links](https://clear.ml/docs/latest/docs/deploying_clearml/enterprise_deploy/change_artifact_links/#fixing-the-elasticsearch-links)