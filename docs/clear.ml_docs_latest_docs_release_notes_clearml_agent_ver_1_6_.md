---
url: "https://clear.ml/docs/latest/docs/release_notes/clearml_agent/ver_1_6/"
title: "Version 1.6 | ClearML"
---

[Skip to main content](https://clear.ml/docs/latest/docs/release_notes/clearml_agent/ver_1_6/#__docusaurus_skipToContent_fallback)

If you ❤️ ️ **ClearML**, ⭐️ us on [GitHub](https://github.com/clearml/clearml)!

On this page

### ClearML Agent 1.6.1 [​](https://clear.ml/docs/latest/docs/release_notes/clearml_agent/ver_1_6/\#clearml-agent-161 "Direct link to ClearML Agent 1.6.1")

**Bug Fix**

- Fix `requests` requirement lower constraint breaks backwards compatibility for Python 3.6

### ClearML Agent 1.6.0 [​](https://clear.ml/docs/latest/docs/release_notes/clearml_agent/ver_1_6/\#clearml-agent-160 "Direct link to ClearML Agent 1.6.0")
...
- [ClearML Agent 1.6.1](https://clear.ml/docs/latest/docs/release_notes/clearml_agent/ver_1_6/#clearml-agent-161)
- [ClearML Agent 1.6.0](https://clear.ml/docs/latest/docs/release_notes/clearml_agent/ver_1_6/#clearml-agent-160)