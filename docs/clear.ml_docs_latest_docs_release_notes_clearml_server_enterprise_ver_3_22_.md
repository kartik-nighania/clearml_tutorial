---
url: "https://clear.ml/docs/latest/docs/release_notes/clearml_server/enterprise/ver_3_22/"
title: "Version 3.22 | ClearML"
---

[Skip to main content](https://clear.ml/docs/latest/docs/release_notes/clearml_server/enterprise/ver_3_22/#__docusaurus_skipToContent_fallback)

If you ❤️ ️ **ClearML**, ⭐️ us on [GitHub](https://github.com/clearml/clearml)!

On this page

### Enterprise Server 3.22.6 [​](https://clear.ml/docs/latest/docs/release_notes/clearml_server/enterprise/ver_3_22/\#enterprise-server-3226 "Direct link to Enterprise Server 3.22.6")
...
### Enterprise Server 3.22.5 [​](https://clear.ml/docs/latest/docs/release_notes/clearml_server/enterprise/ver_3_22/\#enterprise-server-3225 "Direct link to Enterprise Server 3.22.5")

**Bug Fix**

- Fix users in the Queue Admins user group cannot modify queues

### Enterprise Server 3.22.4 [​](https://clear.ml/docs/latest/docs/release_notes/clearml_server/enterprise/ver_3_22/\#enterprise-server-3224 "Direct link to Enterprise Server 3.22.4")

**New Feature**

- Add support for group integration in Keycloak SSO with environment variables

### Enterprise Server 3.22.3 [​](https://clear.ml/docs/latest/docs/release_notes/clearml_server/enterprise/ver_3_22/\#enterprise-server-3223 "Direct link to Enterprise Server 3.22.3")
...
### Enterprise Server 3.22.2 [​](https://clear.ml/docs/latest/docs/release_notes/clearml_server/enterprise/ver_3_22/\#enterprise-server-3222 "Direct link to Enterprise Server 3.22.2")

**New Feature**

- Add fractional GPU support to the UI resource dashboard

### Enterprise Server 3.22.1 [​](https://clear.ml/docs/latest/docs/release_notes/clearml_server/enterprise/ver_3_22/\#enterprise-server-3221 "Direct link to Enterprise Server 3.22.1")
...
### Enterprise Server 3.22.0 [​](https://clear.ml/docs/latest/docs/release_notes/clearml_server/enterprise/ver_3_22/\#enterprise-server-3220 "Direct link to Enterprise Server 3.22.0")
...
- [Enterprise Server 3.22.6](https://clear.ml/docs/latest/docs/release_notes/clearml_server/enterprise/ver_3_22/#enterprise-server-3226)
- [Enterprise Server 3.22.5](https://clear.ml/docs/latest/docs/release_notes/clearml_server/enterprise/ver_3_22/#enterprise-server-3225)
- [Enterprise Server 3.22.4](https://clear.ml/docs/latest/docs/release_notes/clearml_server/enterprise/ver_3_22/#enterprise-server-3224)
- [Enterprise Server 3.22.3](https://clear.ml/docs/latest/docs/release_notes/clearml_server/enterprise/ver_3_22/#enterprise-server-3223)
- [Enterprise Server 3.22.2](https://clear.ml/docs/latest/docs/release_notes/clearml_server/enterprise/ver_3_22/#enterprise-server-3222)
- [Enterprise Server 3.22.1](https://clear.ml/docs/latest/docs/release_notes/clearml_server/enterprise/ver_3_22/#enterprise-server-3221)
- [Enterprise Server 3.22.0](https://clear.ml/docs/latest/docs/release_notes/clearml_server/enterprise/ver_3_22/#enterprise-server-3220)