---
url: "https://clear.ml/docs/latest/docs/release_notes/sdk/open_source/ver_0_17/"
title: "Version 0.17 | ClearML"
---

[Skip to main content](https://clear.ml/docs/latest/docs/release_notes/sdk/open_source/ver_0_17/#__docusaurus_skipToContent_fallback)

If you ❤️ ️ **ClearML**, ⭐️ us on [GitHub](https://github.com/clearml/clearml)!

On this page

### ClearML 0.17.5 [​](https://clear.ml/docs/latest/docs/release_notes/sdk/open_source/ver_0_17/\#clearml-0175 "Direct link to ClearML 0.17.5")
...
### ClearML 0.17.4 [​](https://clear.ml/docs/latest/docs/release_notes/sdk/open_source/ver_0_17/\#clearml-0174 "Direct link to ClearML 0.17.4")
...
### ClearML 0.17.3 [​](https://clear.ml/docs/latest/docs/release_notes/sdk/open_source/ver_0_17/\#clearml-0173 "Direct link to ClearML 0.17.3")
...
- Add `Task.init(..., output_uri=True)`, which will use the default files\_server as output uri.
...
### ClearML 0.17.2 [​](https://clear.ml/docs/latest/docs/release_notes/sdk/open_source/ver_0_17/\#clearml-0172 "Direct link to ClearML 0.17.2")

**Bug Fix**

- Fix broken `clearml-task` CLI.

### ClearML 0.17.1 [​](https://clear.ml/docs/latest/docs/release_notes/sdk/open_source/ver_0_17/\#clearml-0171 "Direct link to ClearML 0.17.1")

**Bug Fix**

- `clearml-task` CLI link fixed.

### ClearML 0.17.0 [​](https://clear.ml/docs/latest/docs/release_notes/sdk/open_source/ver_0_17/\#clearml-0170 "Direct link to ClearML 0.17.0")

**Features**

- Renamed `trains` as `clearml` (see [clearml](https://github.com/clearml/clearml) in GitHub).
- Add `clearml-data` CLI for Differential Dataset Management & Versioning (see [details](https://clear.ml/docs/latest/docs/clearml_data/)).
- Add `clearml-task` CLI for creating (importing) code into **ClearML** (see [details](https://clear.ml/docs/latest/docs/apps/clearml_task)).
...
- [ClearML 0.17.5](https://clear.ml/docs/latest/docs/release_notes/sdk/open_source/ver_0_17/#clearml-0175)
- [ClearML 0.17.4](https://clear.ml/docs/latest/docs/release_notes/sdk/open_source/ver_0_17/#clearml-0174)
- [ClearML 0.17.3](https://clear.ml/docs/latest/docs/release_notes/sdk/open_source/ver_0_17/#clearml-0173)
- [ClearML 0.17.2](https://clear.ml/docs/latest/docs/release_notes/sdk/open_source/ver_0_17/#clearml-0172)
- [ClearML 0.17.1](https://clear.ml/docs/latest/docs/release_notes/sdk/open_source/ver_0_17/#clearml-0171)
- [ClearML 0.17.0](https://clear.ml/docs/latest/docs/release_notes/sdk/open_source/ver_0_17/#clearml-0170)