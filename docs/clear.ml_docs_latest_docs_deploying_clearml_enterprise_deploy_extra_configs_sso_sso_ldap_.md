---
url: "https://clear.ml/docs/latest/docs/deploying_clearml/enterprise_deploy/extra_configs/sso/sso_ldap/"
title: "LDAP | ClearML"
---

[Skip to main content](https://clear.ml/docs/latest/docs/deploying_clearml/enterprise_deploy/extra_configs/sso/sso_ldap/#__docusaurus_skipToContent_fallback)
...
## Configure ClearML Server [​](https://clear.ml/docs/latest/docs/deploying_clearml/enterprise_deploy/extra_configs/sso/sso_ldap/\#configure-clearml-server "Direct link to Configure ClearML Server")
...
### LDAP Secure Transport (TLS / LDAPS) [​](https://clear.ml/docs/latest/docs/deploying_clearml/enterprise_deploy/extra_configs/sso/sso_ldap/\#ldap-secure-transport-tls--ldaps "Direct link to LDAP Secure Transport (TLS / LDAPS)")
...
#### Server Certificate Validation [​](https://clear.ml/docs/latest/docs/deploying_clearml/enterprise_deploy/extra_configs/sso/sso_ldap/\#server-certificate-validation "Direct link to Server Certificate Validation")
...
2. Set the path to the certificate so the apiserver can find it:
...
#### Client Certificates [​](https://clear.ml/docs/latest/docs/deploying_clearml/enterprise_deploy/extra_configs/sso/sso_ldap/\#client-certificates "Direct link to Client Certificates")
...
### Retrieving Email and Display Name [​](https://clear.ml/docs/latest/docs/deploying_clearml/enterprise_deploy/extra_configs/sso/sso_ldap/\#retrieving-email-and-display-name "Direct link to Retrieving Email and Display Name")
...
### Configuring a User as a ClearML Admin [​](https://clear.ml/docs/latest/docs/deploying_clearml/enterprise_deploy/extra_configs/sso/sso_ldap/\#configuring-a-user-as-a-clearml-admin "Direct link to Configuring a User as a ClearML Admin")
...
### User or Domain Whitelisting [​](https://clear.ml/docs/latest/docs/deploying_clearml/enterprise_deploy/extra_configs/sso/sso_ldap/\#user-or-domain-whitelisting "Direct link to User or Domain Whitelisting")
...
#### Adding Users to the Whitelist [​](https://clear.ml/docs/latest/docs/deploying_clearml/enterprise_deploy/extra_configs/sso/sso_ldap/\#adding-users-to-the-whitelist "Direct link to Adding Users to the Whitelist")

You can add users to the whitelist via the UI or API.

**To add via the UI:**

- Open the [User management](https://clear.ml/docs/latest/docs/webapp/settings/webapp_settings_users) admin UI page
...
#### Whitelisting Domains [​](https://clear.ml/docs/latest/docs/deploying_clearml/enterprise_deploy/extra_configs/sso/sso_ldap/\#whitelisting-domains "Direct link to Whitelisting Domains")
...
#### Enabling Whitelisting [​](https://clear.ml/docs/latest/docs/deploying_clearml/enterprise_deploy/extra_configs/sso/sso_ldap/\#enabling-whitelisting "Direct link to Enabling Whitelisting")
...
- [Configure ClearML Server](https://clear.ml/docs/latest/docs/deploying_clearml/enterprise_deploy/extra_configs/sso/sso_ldap/#configure-clearml-server)
  - [LDAP Secure Transport (TLS / LDAPS)](https://clear.ml/docs/latest/docs/deploying_clearml/enterprise_deploy/extra_configs/sso/sso_ldap/#ldap-secure-transport-tls--ldaps)
  - [Retrieving Email and Display Name](https://clear.ml/docs/latest/docs/deploying_clearml/enterprise_deploy/extra_configs/sso/sso_ldap/#retrieving-email-and-display-name)
  - [Configuring a User as a ClearML Admin](https://clear.ml/docs/latest/docs/deploying_clearml/enterprise_deploy/extra_configs/sso/sso_ldap/#configuring-a-user-as-a-clearml-admin)
  - [User or Domain Whitelisting](https://clear.ml/docs/latest/docs/deploying_clearml/enterprise_deploy/extra_configs/sso/sso_ldap/#user-or-domain-whitelisting)