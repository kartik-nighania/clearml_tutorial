---
url: "https://clear.ml/docs/latest/docs/clearml_agent/clearml_agent_conditional_template/"
title: "Conditional Templates | ClearML"
---

[Skip to main content](https://clear.ml/docs/latest/docs/clearml_agent/clearml_agent_conditional_template/#__docusaurus_skipToContent_fallback)
...
## Example Configuration [​](https://clear.ml/docs/latest/docs/clearml_agent/clearml_agent_conditional_template/\#example-configuration "Direct link to Example Configuration")
...
- [Example Configuration](https://clear.ml/docs/latest/docs/clearml_agent/clearml_agent_conditional_template/#example-configuration)