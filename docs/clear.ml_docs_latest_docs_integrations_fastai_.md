---
url: "https://clear.ml/docs/latest/docs/integrations/fastai/"
title: "Fast.ai | ClearML"
---

[Skip to main content](https://clear.ml/docs/latest/docs/integrations/fastai/#__docusaurus_skipToContent_fallback)
...
See an example of `fastai` and ClearML in action [here](https://clear.ml/docs/latest/docs/guides/frameworks/fastai/fastai_with_tensorboard).

![Task scalars](https://clear.ml/docs/latest/assets/images/examples_reporting_fastai_01-133f32ac1d65360df927870d871b8440.png#light-mode-only)![Task scalars](https://clear.ml/docs/latest/assets/images/examples_reporting_fastai_01_dark-1192bbf72e12c6071f09636fe5427ef5.png#dark-mode-only)

## Automatic Logging Control [​](https://clear.ml/docs/latest/docs/integrations/fastai/\#automatic-logging-control "Direct link to Automatic Logging Control")
...
## Manual Logging [​](https://clear.ml/docs/latest/docs/integrations/fastai/\#manual-logging "Direct link to Manual Logging")
...
## Remote Execution [​](https://clear.ml/docs/latest/docs/integrations/fastai/\#remote-execution "Direct link to Remote Execution")
...
### Reproducing Task Runs [​](https://clear.ml/docs/latest/docs/integrations/fastai/\#reproducing-task-runs "Direct link to Reproducing Task Runs")
...
### Executing a Task Remotely [​](https://clear.ml/docs/latest/docs/integrations/fastai/\#executing-a-task-remotely "Direct link to Executing a Task Remotely")
...
- [Automatic Logging Control](https://clear.ml/docs/latest/docs/integrations/fastai/#automatic-logging-control)
- [Manual Logging](https://clear.ml/docs/latest/docs/integrations/fastai/#manual-logging)
- [Remote Execution](https://clear.ml/docs/latest/docs/integrations/fastai/#remote-execution)
  - [Reproducing Task Runs](https://clear.ml/docs/latest/docs/integrations/fastai/#reproducing-task-runs)
  - [Executing a Task Remotely](https://clear.ml/docs/latest/docs/integrations/fastai/#executing-a-task-remotely)