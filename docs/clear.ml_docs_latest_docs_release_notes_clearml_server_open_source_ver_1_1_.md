---
url: "https://clear.ml/docs/latest/docs/release_notes/clearml_server/open_source/ver_1_1/"
title: "Version 1.1 | ClearML"
---

[Skip to main content](https://clear.ml/docs/latest/docs/release_notes/clearml_server/open_source/ver_1_1/#__docusaurus_skipToContent_fallback)

If you ❤️ ️ **ClearML**, ⭐️ us on [GitHub](https://github.com/clearml/clearml)!

On this page

### ClearML Server 1.1.0 [​](https://clear.ml/docs/latest/docs/release_notes/clearml_server/open_source/ver_1_1/\#clearml-server-110 "Direct link to ClearML Server 1.1.0")
...
- Allow setting status\_message in `tasks.update`
...
- Fix experiment details UI failure opening hyperparameter sections beginning with `#` ( [#79](https://github.com/clearml/clearml-server/issues/79))
...
- Fix filtering on hyperparameters ( [ClearML #385](https://github.com/clearml/clearml/issues/385) [Slack Channel](https://clearml.slack.com/archives/CTK20V944/p1626600582284700))
...
- [ClearML Server 1.1.0](https://clear.ml/docs/latest/docs/release_notes/clearml_server/open_source/ver_1_1/#clearml-server-110)