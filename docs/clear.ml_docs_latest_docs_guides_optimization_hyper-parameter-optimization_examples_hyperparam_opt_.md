---
url: "https://clear.ml/docs/latest/docs/guides/optimization/hyper-parameter-optimization/examples_hyperparam_opt/"
title: "Hyperparameter Optimization | ClearML"
---

[Skip to main content](https://clear.ml/docs/latest/docs/guides/optimization/hyper-parameter-optimization/examples_hyperparam_opt/#__docusaurus_skipToContent_fallback)

If you ❤️ ️ **ClearML**, ⭐️ us on [GitHub](https://github.com/clearml/clearml)!

On this page

The [hyper\_parameter\_optimizer.py](https://github.com/clearml/clearml/blob/master/examples/optimization/hyper-parameter-optimization/hyper_parameter_optimizer.py)
example script demonstrates hyperparameter optimization (HPO), which is automated by using ClearML.

## Set the Search Strategy for Optimization [​](https://clear.ml/docs/latest/docs/guides/optimization/hyper-parameter-optimization/examples_hyperparam_opt/\#set-the-search-strategy-for-optimization "Direct link to Set the Search Strategy for Optimization")
...
- Optuna hyperparameter optimization - [`automation.optuna.OptimizerOptuna`](https://clear.ml/docs/latest/docs/references/sdk/hpo_optuna_optuna_optimizeroptuna).
For more information about Optuna, see the [Optuna](https://optuna.org/) documentation.

- BOHB - [`automation.hpbandster.OptimizerBOHB`](https://clear.ml/docs/latest/docs/references/sdk/hpo_hpbandster_bandster_optimizerbohb).
...
- Random uniform sampling of hyperparameter strategy - [`automation.RandomSearch`](https://clear.ml/docs/latest/docs/references/sdk/hpo_optimization_randomsearch)
...
The search strategy class that is chosen will be passed to the [`automation.HyperParameterOptimizer`](https://clear.ml/docs/latest/docs/references/sdk/hpo_optimization_hyperparameteroptimizer)
object later.
...
## Define a Callback [​](https://clear.ml/docs/latest/docs/guides/optimization/hyper-parameter-optimization/examples_hyperparam_opt/\#define-a-callback "Direct link to Define a Callback")
...
## Initialize the Optimization Task [​](https://clear.ml/docs/latest/docs/guides/optimization/hyper-parameter-optimization/examples_hyperparam_opt/\#initialize-the-optimization-task "Direct link to Initialize the Optimization Task")

Initialize the Task, which will be stored in ClearML Server when the code runs. After the code runs at least once, it
can be [reproduced](https://clear.ml/docs/latest/docs/webapp/webapp_exp_reproducing) and [tuned](https://clear.ml/docs/latest/docs/webapp/webapp_exp_tuning).
...
## Set Up the Arguments [​](https://clear.ml/docs/latest/docs/guides/optimization/hyper-parameter-optimization/examples_hyperparam_opt/\#set-up-the-arguments "Direct link to Set Up the Arguments")

Create an arguments dictionary that contains the ID of the Task to optimize, and a Boolean indicating whether the
optimizer will run as a service, see [Running as a service](https://clear.ml/docs/latest/docs/guides/optimization/hyper-parameter-optimization/examples_hyperparam_opt/#running-as-a-service).
...
## Creating the Optimizer Object [​](https://clear.ml/docs/latest/docs/guides/optimization/hyper-parameter-optimization/examples_hyperparam_opt/\#creating-the-optimizer-object "Direct link to Creating the Optimizer Object")

Initialize an [`automation.HyperParameterOptimizer`](https://clear.ml/docs/latest/docs/references/sdk/hpo_optimization_hyperparameteroptimizer)
...
- Hyperparameter ranges to sample, instantiating them as ClearML automation objects using [`automation.UniformIntegerParameterRange`](https://clear.ml/docs/latest/docs/references/sdk/hpo_parameters_uniformintegerparameterrange)
and [`automation.DiscreteParameterRange`](https://clear.ml/docs/latest/docs/references/sdk/hpo_parameters_discreteparameterrange):
...
If you are using the Optuna framework (see [Set the Search Strategy for Optimization](https://clear.ml/docs/latest/docs/guides/optimization/hyper-parameter-optimization/examples_hyperparam_opt/#set-the-search-strategy-for-optimization)),
...
- Optimization strategy (see [Set the search strategy for optimization](https://clear.ml/docs/latest/docs/guides/optimization/hyper-parameter-optimization/examples_hyperparam_opt/#set-the-search-strategy-for-optimization)):
...
## Running as a Service [​](https://clear.ml/docs/latest/docs/guides/optimization/hyper-parameter-optimization/examples_hyperparam_opt/\#running-as-a-service "Direct link to Running as a Service")

To run the optimization as a service, set the `run_as_service` argument to `true`. For more information about
running as a service, see [Services Mode](https://clear.ml/docs/latest/docs/clearml_agent/clearml_agent_services_mode).
...
## Optimize [​](https://clear.ml/docs/latest/docs/guides/optimization/hyper-parameter-optimization/examples_hyperparam_opt/\#optimize "Direct link to Optimize")

The optimizer is ready. Set the report period and [start](https://clear.ml/docs/latest/docs/references/sdk/hpo_optimization_hyperparameteroptimizer#start)
...
- [Set the Search Strategy for Optimization](https://clear.ml/docs/latest/docs/guides/optimization/hyper-parameter-optimization/examples_hyperparam_opt/#set-the-search-strategy-for-optimization)
- [Define a Callback](https://clear.ml/docs/latest/docs/guides/optimization/hyper-parameter-optimization/examples_hyperparam_opt/#define-a-callback)
- [Initialize the Optimization Task](https://clear.ml/docs/latest/docs/guides/optimization/hyper-parameter-optimization/examples_hyperparam_opt/#initialize-the-optimization-task)
- [Set Up the Arguments](https://clear.ml/docs/latest/docs/guides/optimization/hyper-parameter-optimization/examples_hyperparam_opt/#set-up-the-arguments)
- [Creating the Optimizer Object](https://clear.ml/docs/latest/docs/guides/optimization/hyper-parameter-optimization/examples_hyperparam_opt/#creating-the-optimizer-object)
- [Running as a Service](https://clear.ml/docs/latest/docs/guides/optimization/hyper-parameter-optimization/examples_hyperparam_opt/#running-as-a-service)
- [Optimize](https://clear.ml/docs/latest/docs/guides/optimization/hyper-parameter-optimization/examples_hyperparam_opt/#optimize)