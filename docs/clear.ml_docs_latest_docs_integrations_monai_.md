---
url: "https://clear.ml/docs/latest/docs/integrations/monai/"
title: "MONAI | ClearML"
---

[Skip to main content](https://clear.ml/docs/latest/docs/integrations/monai/#__docusaurus_skipToContent_fallback)
...
imaging. You can integrate ClearML into your code using MONAI's built-in handlers: [`ClearMLImageHandler`, `ClearMLStatsHandler`](https://clear.ml/docs/latest/docs/integrations/monai/#clearmlimagehandler-and-clearmlstatshandler),
and [`ModelCheckpoint`](https://clear.ml/docs/latest/docs/integrations/monai/#modelcheckpoint).

## ClearMLImageHandler and ClearMLStatsHandler [​](https://clear.ml/docs/latest/docs/integrations/monai/\#clearmlimagehandler-and-clearmlstatshandler "Direct link to ClearMLImageHandler and ClearMLStatsHandler")

Use the `ClearMLImageHandler` and the `ClearMLStatsHandler` to log images and metrics respectively to ClearML.
`ClearMLImageHandler` extends all functionality from [`TensorBoardImageHandler`](https://monai.readthedocs.io/en/1.5.0/handlers.html#tensorboard-handlers),
used for visualizing images, labels, and outputs. `ClearMLStatsHandler` extends all functionality from [`TensorBoardStatsHandler`](https://monai.readthedocs.io/en/1.5.0/handlers.html#tensorboard-handlers),
...
When the code runs with either of these handlers, it creates a [ClearML Task](https://clear.ml/docs/latest/docs/fundamentals/task) called `monai_experiment` in the `MONAI` project. To
...
![Debug Samples](https://clear.ml/docs/latest/assets/images/monai_clearml_debug_samples-e5ad0d6eade547f4bfb5c6917d3388be.png)

View the logged metrics in the WebApp, in the task's **Scalars** tab.

![MONAI scalars](https://clear.ml/docs/latest/assets/images/monai_clearml_scalars-9a39cd984992d6480147a892ec49a872.png)

## ModelCheckpoint [​](https://clear.ml/docs/latest/docs/integrations/monai/\#modelcheckpoint "Direct link to ModelCheckpoint")
...
![MONAI models](https://clear.ml/docs/latest/assets/images/monai_clearml_models-7d78e7a9f15107628670301aeff4c225.png)

- [ClearMLImageHandler and ClearMLStatsHandler](https://clear.ml/docs/latest/docs/integrations/monai/#clearmlimagehandler-and-clearmlstatshandler)
- [ModelCheckpoint](https://clear.ml/docs/latest/docs/integrations/monai/#modelcheckpoint)