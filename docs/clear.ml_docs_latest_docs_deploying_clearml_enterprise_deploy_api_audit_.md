---
url: "https://clear.ml/docs/latest/docs/deploying_clearml/enterprise_deploy/api_audit/"
title: "Setting up API Auditing | ClearML"
---

[Skip to main content](https://clear.ml/docs/latest/docs/deploying_clearml/enterprise_deploy/api_audit/#__docusaurus_skipToContent_fallback)
...
## Standard Python Logger (Recommended) [​](https://clear.ml/docs/latest/docs/deploying_clearml/enterprise_deploy/api_audit/\#standard-python-logger-recommended "Direct link to Standard Python Logger (Recommended)")
...
## Fluentd (Alternative) [​](https://clear.ml/docs/latest/docs/deploying_clearml/enterprise_deploy/api_audit/\#fluentd-alternative "Direct link to Fluentd (Alternative)")
...
### Configuration [​](https://clear.ml/docs/latest/docs/deploying_clearml/enterprise_deploy/api_audit/\#configuration "Direct link to Configuration")
...
## Elastic (Alternative) [​](https://clear.ml/docs/latest/docs/deploying_clearml/enterprise_deploy/api_audit/\#elastic-alternative "Direct link to Elastic (Alternative)")
...
### Configuration [​](https://clear.ml/docs/latest/docs/deploying_clearml/enterprise_deploy/api_audit/\#configuration-1 "Direct link to Configuration")
...
## Verifying Logging Configuration [​](https://clear.ml/docs/latest/docs/deploying_clearml/enterprise_deploy/api_audit/\#verifying-logging-configuration "Direct link to Verifying Logging Configuration")
...
### Option 1: UI Activity [​](https://clear.ml/docs/latest/docs/deploying_clearml/enterprise_deploy/api_audit/\#option-1-ui-activity "Direct link to Option 1: UI Activity")
...
### Option 2: Direct API Call [​](https://clear.ml/docs/latest/docs/deploying_clearml/enterprise_deploy/api_audit/\#option-2-direct-api-call "Direct link to Option 2: Direct API Call")
...
## Customizing API Logs [​](https://clear.ml/docs/latest/docs/deploying_clearml/enterprise_deploy/api_audit/\#customizing-api-logs "Direct link to Customizing API Logs")
...
### Logging Options Per Endpoint [​](https://clear.ml/docs/latest/docs/deploying_clearml/enterprise_deploy/api_audit/\#logging-options-per-endpoint "Direct link to Logging Options Per Endpoint")
...
### Default Logging Behavior [​](https://clear.ml/docs/latest/docs/deploying_clearml/enterprise_deploy/api_audit/\#default-logging-behavior "Direct link to Default Logging Behavior")
...
### Per-Endpoint Logging [​](https://clear.ml/docs/latest/docs/deploying_clearml/enterprise_deploy/api_audit/\#per-endpoint-logging "Direct link to Per-Endpoint Logging")
...
### Logging Specific Request Fields [​](https://clear.ml/docs/latest/docs/deploying_clearml/enterprise_deploy/api_audit/\#logging-specific-request-fields "Direct link to Logging Specific Request Fields")
...
### Identity Redaction [​](https://clear.ml/docs/latest/docs/deploying_clearml/enterprise_deploy/api_audit/\#identity-redaction "Direct link to Identity Redaction")
...
### Time-Based Index/Tag Suffixing [​](https://clear.ml/docs/latest/docs/deploying_clearml/enterprise_deploy/api_audit/\#time-based-indextag-suffixing "Direct link to Time-Based Index/Tag Suffixing")
...
- [Standard Python Logger (Recommended)](https://clear.ml/docs/latest/docs/deploying_clearml/enterprise_deploy/api_audit/#standard-python-logger-recommended)
- [Fluentd (Alternative)](https://clear.ml/docs/latest/docs/deploying_clearml/enterprise_deploy/api_audit/#fluentd-alternative)
  - [Configuration](https://clear.ml/docs/latest/docs/deploying_clearml/enterprise_deploy/api_audit/#configuration)
- [Elastic (Alternative)](https://clear.ml/docs/latest/docs/deploying_clearml/enterprise_deploy/api_audit/#elastic-alternative)
  - [Configuration](https://clear.ml/docs/latest/docs/deploying_clearml/enterprise_deploy/api_audit/#configuration-1)
- [Verifying Logging Configuration](https://clear.ml/docs/latest/docs/deploying_clearml/enterprise_deploy/api_audit/#verifying-logging-configuration)
  - [Option 1: UI Activity](https://clear.ml/docs/latest/docs/deploying_clearml/enterprise_deploy/api_audit/#option-1-ui-activity)
  - [Option 2: Direct API Call](https://clear.ml/docs/latest/docs/deploying_clearml/enterprise_deploy/api_audit/#option-2-direct-api-call)
- [Customizing API Logs](https://clear.ml/docs/latest/docs/deploying_clearml/enterprise_deploy/api_audit/#customizing-api-logs)
  - [Logging Options Per Endpoint](https://clear.ml/docs/latest/docs/deploying_clearml/enterprise_deploy/api_audit/#logging-options-per-endpoint)
  - [Default Logging Behavior](https://clear.ml/docs/latest/docs/deploying_clearml/enterprise_deploy/api_audit/#default-logging-behavior)
  - [Per-Endpoint Logging](https://clear.ml/docs/latest/docs/deploying_clearml/enterprise_deploy/api_audit/#per-endpoint-logging)
  - [Logging Specific Request Fields](https://clear.ml/docs/latest/docs/deploying_clearml/enterprise_deploy/api_audit/#logging-specific-request-fields)
  - [Identity Redaction](https://clear.ml/docs/latest/docs/deploying_clearml/enterprise_deploy/api_audit/#identity-redaction)
  - [Time-Based Index/Tag Suffixing](https://clear.ml/docs/latest/docs/deploying_clearml/enterprise_deploy/api_audit/#time-based-indextag-suffixing)