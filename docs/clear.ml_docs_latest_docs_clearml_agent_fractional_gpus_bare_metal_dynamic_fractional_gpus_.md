---
url: "https://clear.ml/docs/latest/docs/clearml_agent/fractional_gpus/bare_metal_dynamic_fractional_gpus/"
title: "Dynamic GPU Fractions on Bare Metal and VMs | ClearML"
---

[Skip to main content](https://clear.ml/docs/latest/docs/clearml_agent/fractional_gpus/bare_metal_dynamic_fractional_gpus/#__docusaurus_skipToContent_fallback)
...
## Deployment [​](https://clear.ml/docs/latest/docs/clearml_agent/fractional_gpus/bare_metal_dynamic_fractional_gpus/\#deployment "Direct link to Deployment")
...
2. Start the ClearML agent with dynamic GPU allocation. Use `--gpus` to specify the active GPUs, and use the `--queue`
...
## Example Workflow [​](https://clear.ml/docs/latest/docs/clearml_agent/fractional_gpus/bare_metal_dynamic_fractional_gpus/\#example-workflow "Direct link to Example Workflow")
...
- [Deployment](https://clear.ml/docs/latest/docs/clearml_agent/fractional_gpus/bare_metal_dynamic_fractional_gpus/#deployment)
- [Example Workflow](https://clear.ml/docs/latest/docs/clearml_agent/fractional_gpus/bare_metal_dynamic_fractional_gpus/#example-workflow)