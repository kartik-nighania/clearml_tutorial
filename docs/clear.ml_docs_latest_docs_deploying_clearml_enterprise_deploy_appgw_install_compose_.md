---
url: "https://clear.ml/docs/latest/docs/deploying_clearml/enterprise_deploy/appgw_install_compose/"
title: "Docker-Compose Deployment | ClearML"
---

[Skip to main content](https://clear.ml/docs/latest/docs/deploying_clearml/enterprise_deploy/appgw_install_compose/#__docusaurus_skipToContent_fallback)
...
## Requirements [​](https://clear.ml/docs/latest/docs/deploying_clearml/enterprise_deploy/appgw_install_compose/\#requirements "Direct link to Requirements")
...
## Host Configurations [​](https://clear.ml/docs/latest/docs/deploying_clearml/enterprise_deploy/appgw_install_compose/\#host-configurations "Direct link to Host Configurations")

### Docker Installation [​](https://clear.ml/docs/latest/docs/deploying_clearml/enterprise_deploy/appgw_install_compose/\#docker-installation "Direct link to Docker Installation")
...
### Docker-compose File [​](https://clear.ml/docs/latest/docs/deploying_clearml/enterprise_deploy/appgw_install_compose/\#docker-compose-file "Direct link to Docker-compose File")
...
- `ROUTER_NAME`: In the case of [multiple routers on the same tenant](https://clear.ml/docs/latest/docs/deploying_clearml/enterprise_deploy/appgw_install_compose/#multiple-router-in-the-same-tenant), each router
...
### Advanced Configuration [​](https://clear.ml/docs/latest/docs/deploying_clearml/enterprise_deploy/appgw_install_compose/\#advanced-configuration "Direct link to Advanced Configuration")

#### Using Open HTTP [​](https://clear.ml/docs/latest/docs/deploying_clearml/enterprise_deploy/appgw_install_compose/\#using-open-http "Direct link to Using Open HTTP")
...
#### Multiple Router in the Same Tenant [​](https://clear.ml/docs/latest/docs/deploying_clearml/enterprise_deploy/appgw_install_compose/\#multiple-router-in-the-same-tenant "Direct link to Multiple Router in the Same Tenant")
...
##### Example Configuration [​](https://clear.ml/docs/latest/docs/deploying_clearml/enterprise_deploy/appgw_install_compose/\#example-configuration "Direct link to Example Configuration")
...
Make sure `LISTEN_QUEUE_NAME` is set in the [`docker-compose` environment variables](https://clear.ml/docs/latest/docs/deploying_clearml/enterprise_deploy/appgw_install_compose/#docker-compose-file) for each router instance.

## Monitoring and Testing the Gateway [​](https://clear.ml/docs/latest/docs/deploying_clearml/enterprise_deploy/appgw_install_compose/\#monitoring-and-testing-the-gateway "Direct link to Monitoring and Testing the Gateway")
...
- [Requirements](https://clear.ml/docs/latest/docs/deploying_clearml/enterprise_deploy/appgw_install_compose/#requirements)
- [Host Configurations](https://clear.ml/docs/latest/docs/deploying_clearml/enterprise_deploy/appgw_install_compose/#host-configurations)
  - [Docker Installation](https://clear.ml/docs/latest/docs/deploying_clearml/enterprise_deploy/appgw_install_compose/#docker-installation)
  - [Docker-compose File](https://clear.ml/docs/latest/docs/deploying_clearml/enterprise_deploy/appgw_install_compose/#docker-compose-file)
  - [Advanced Configuration](https://clear.ml/docs/latest/docs/deploying_clearml/enterprise_deploy/appgw_install_compose/#advanced-configuration)
- [Monitoring and Testing the Gateway](https://clear.ml/docs/latest/docs/deploying_clearml/enterprise_deploy/appgw_install_compose/#monitoring-and-testing-the-gateway)