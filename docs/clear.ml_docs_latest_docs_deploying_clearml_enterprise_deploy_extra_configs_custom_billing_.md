---
url: "https://clear.ml/docs/latest/docs/deploying_clearml/enterprise_deploy/extra_configs/custom_billing/"
title: "Custom Events | ClearML"
---

[Skip to main content](https://clear.ml/docs/latest/docs/deploying_clearml/enterprise_deploy/extra_configs/custom_billing/#__docusaurus_skipToContent_fallback)
...
## Enabling Custom Events in ClearML Server [​](https://clear.ml/docs/latest/docs/deploying_clearml/enterprise_deploy/extra_configs/custom_billing/\#enabling-custom-events-in-clearml-server "Direct link to Enabling Custom Events in ClearML Server")
...
### Configure Per-Tenant Custom Event Fields [​](https://clear.ml/docs/latest/docs/deploying_clearml/enterprise_deploy/extra_configs/custom_billing/\#configure-per-tenant-custom-event-fields "Direct link to Configure Per-Tenant Custom Event Fields")
...
## Sending Custom Events to the API Server [​](https://clear.ml/docs/latest/docs/deploying_clearml/enterprise_deploy/extra_configs/custom_billing/\#sending-custom-events-to-the-api-server "Direct link to Sending Custom Events to the API Server")
...
### Install custom-events [​](https://clear.ml/docs/latest/docs/deploying_clearml/enterprise_deploy/extra_configs/custom_billing/\#install-custom-events "Direct link to Install custom-events")
...
#### Prepare Values [​](https://clear.ml/docs/latest/docs/deploying_clearml/enterprise_deploy/extra_configs/custom_billing/\#prepare-values "Direct link to Prepare Values")
...
#### Install [​](https://clear.ml/docs/latest/docs/deploying_clearml/enterprise_deploy/extra_configs/custom_billing/\#install "Direct link to Install")
...
- [Enabling Custom Events in ClearML Server](https://clear.ml/docs/latest/docs/deploying_clearml/enterprise_deploy/extra_configs/custom_billing/#enabling-custom-events-in-clearml-server)
  - [Configure Per-Tenant Custom Event Fields](https://clear.ml/docs/latest/docs/deploying_clearml/enterprise_deploy/extra_configs/custom_billing/#configure-per-tenant-custom-event-fields)
- [Sending Custom Events to the API Server](https://clear.ml/docs/latest/docs/deploying_clearml/enterprise_deploy/extra_configs/custom_billing/#sending-custom-events-to-the-api-server)
  - [Install custom-events](https://clear.ml/docs/latest/docs/deploying_clearml/enterprise_deploy/extra_configs/custom_billing/#install-custom-events)