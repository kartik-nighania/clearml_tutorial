---
url: "https://clear.ml/docs/latest/docs/guides/frameworks/pytorch/pytorch_tensorboardx/"
title: "PyTorch TensorBoardX | ClearML"
---

[Skip to main content](https://clear.ml/docs/latest/docs/guides/frameworks/pytorch/pytorch_tensorboardx/#__docusaurus_skipToContent_fallback)
...
## Scalars [​](https://clear.ml/docs/latest/docs/guides/frameworks/pytorch/pytorch_tensorboardx/\#scalars "Direct link to Scalars")

The loss and accuracy metric scalar plots, along with the resource utilization plots, which are titled **:monitor: machine**,
appear in the task's page in the [web UI](https://clear.ml/docs/latest/docs/webapp/webapp_overview), under **SCALARS**.
...
## Hyperparameters [​](https://clear.ml/docs/latest/docs/guides/frameworks/pytorch/pytorch_tensorboardx/\#hyperparameters "Direct link to Hyperparameters")
...
## Log [​](https://clear.ml/docs/latest/docs/guides/frameworks/pytorch/pytorch_tensorboardx/\#log "Direct link to Log")
...
## Artifacts [​](https://clear.ml/docs/latest/docs/guides/frameworks/pytorch/pytorch_tensorboardx/\#artifacts "Direct link to Artifacts")
...
- [Scalars](https://clear.ml/docs/latest/docs/guides/frameworks/pytorch/pytorch_tensorboardx/#scalars)
- [Hyperparameters](https://clear.ml/docs/latest/docs/guides/frameworks/pytorch/pytorch_tensorboardx/#hyperparameters)
- [Log](https://clear.ml/docs/latest/docs/guides/frameworks/pytorch/pytorch_tensorboardx/#log)
- [Artifacts](https://clear.ml/docs/latest/docs/guides/frameworks/pytorch/pytorch_tensorboardx/#artifacts)