---
url: "https://clear.ml/docs/latest/docs/release_notes/clearml_server/open_source/ver_1_9/"
title: "Version 1.9 | ClearML"
---

[Skip to main content](https://clear.ml/docs/latest/docs/release_notes/clearml_server/open_source/ver_1_9/#__docusaurus_skipToContent_fallback)

If you ❤️ ️ **ClearML**, ⭐️ us on [GitHub](https://github.com/clearml/clearml)!

On this page

### ClearML Server 1.9.2 [​](https://clear.ml/docs/latest/docs/release_notes/clearml_server/open_source/ver_1_9/\#clearml-server-192 "Direct link to ClearML Server 1.9.2")
...
### ClearML Server 1.9.1 [​](https://clear.ml/docs/latest/docs/release_notes/clearml_server/open_source/ver_1_9/\#clearml-server-191 "Direct link to ClearML Server 1.9.1")
...
### ClearML Server 1.9.0 [​](https://clear.ml/docs/latest/docs/release_notes/clearml_server/open_source/ver_1_9/\#clearml-server-190 "Direct link to ClearML Server 1.9.0")
...
- [ClearML Server 1.9.2](https://clear.ml/docs/latest/docs/release_notes/clearml_server/open_source/ver_1_9/#clearml-server-192)
- [ClearML Server 1.9.1](https://clear.ml/docs/latest/docs/release_notes/clearml_server/open_source/ver_1_9/#clearml-server-191)
- [ClearML Server 1.9.0](https://clear.ml/docs/latest/docs/release_notes/clearml_server/open_source/ver_1_9/#clearml-server-190)