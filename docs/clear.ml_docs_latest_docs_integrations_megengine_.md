---
url: "https://clear.ml/docs/latest/docs/integrations/megengine/"
title: "MegEngine | ClearML"
---

[Skip to main content](https://clear.ml/docs/latest/docs/integrations/megengine/#__docusaurus_skipToContent_fallback)
...
See MegEngine and ClearML in action in a [code example](https://clear.ml/docs/latest/docs/guides/frameworks/megengine/megengine_mnist).

## Automatic Logging Control [​](https://clear.ml/docs/latest/docs/integrations/megengine/\#automatic-logging-control "Direct link to Automatic Logging Control")
...
## Manual Logging [​](https://clear.ml/docs/latest/docs/integrations/megengine/\#manual-logging "Direct link to Manual Logging")
...
## Remote Execution [​](https://clear.ml/docs/latest/docs/integrations/megengine/\#remote-execution "Direct link to Remote Execution")
...
### Reproducing Task Runs [​](https://clear.ml/docs/latest/docs/integrations/megengine/\#reproducing-task-runs "Direct link to Reproducing Task Runs")
...
### Executing a Task Remotely [​](https://clear.ml/docs/latest/docs/integrations/megengine/\#executing-a-task-remotely "Direct link to Executing a Task Remotely")
...
## Hyperparameter Optimization [​](https://clear.ml/docs/latest/docs/integrations/megengine/\#hyperparameter-optimization "Direct link to Hyperparameter Optimization")
...
- [Automatic Logging Control](https://clear.ml/docs/latest/docs/integrations/megengine/#automatic-logging-control)
- [Manual Logging](https://clear.ml/docs/latest/docs/integrations/megengine/#manual-logging)
- [Remote Execution](https://clear.ml/docs/latest/docs/integrations/megengine/#remote-execution)
  - [Reproducing Task Runs](https://clear.ml/docs/latest/docs/integrations/megengine/#reproducing-task-runs)
  - [Executing a Task Remotely](https://clear.ml/docs/latest/docs/integrations/megengine/#executing-a-task-remotely)
- [Hyperparameter Optimization](https://clear.ml/docs/latest/docs/integrations/megengine/#hyperparameter-optimization)