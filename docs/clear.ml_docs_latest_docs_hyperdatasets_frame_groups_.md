---
url: "https://clear.ml/docs/latest/docs/hyperdatasets/frame_groups/"
title: "FrameGroups | ClearML"
---

[Skip to main content](https://clear.ml/docs/latest/docs/hyperdatasets/frame_groups/#__docusaurus_skipToContent_fallback)
...
[View and edit](https://clear.ml/docs/latest/docs/hyperdatasets/webapp/webapp_datasets_frames) FrameGroups and the SingleFrames they contain
...
## Usage [​](https://clear.ml/docs/latest/docs/hyperdatasets/frame_groups/\#usage "Direct link to Usage")

### Creating a FrameGroup [​](https://clear.ml/docs/latest/docs/hyperdatasets/frame_groups/\#creating-a-framegroup "Direct link to Creating a FrameGroup")
...
### Adding FrameGroups to a Dataset Version [​](https://clear.ml/docs/latest/docs/hyperdatasets/frame_groups/\#adding-framegroups-to-a-dataset-version "Direct link to Adding FrameGroups to a Dataset Version")
...
4. Add that list to a DatasetVersion using the [`DatasetVersion.add_frames()`](https://clear.ml/docs/latest/docs/references/hyperdataset/hyperdatasetversion#add_frames)
...
### Accessing a FrameGroup [​](https://clear.ml/docs/latest/docs/hyperdatasets/frame_groups/\#accessing-a-framegroup "Direct link to Accessing a FrameGroup")

To access a FrameGroup, use [`DatasetVersion.get_single_frame()`](https://clear.ml/docs/latest/docs/references/hyperdataset/hyperdatasetversion#datasetversionget_single_frame),
just like when [accessing a SingleFrame](https://clear.ml/docs/latest/docs/hyperdatasets/single_frames#accessing-singleframes):
...
### Updating FrameGroups [​](https://clear.ml/docs/latest/docs/hyperdatasets/frame_groups/\#updating-framegroups "Direct link to Updating FrameGroups")

Updating FrameGroups is similar to [updating SingleFrames](https://clear.ml/docs/latest/docs/hyperdatasets/single_frames#updating-singleframes), except that each
...
### Deleting Frames [​](https://clear.ml/docs/latest/docs/hyperdatasets/frame_groups/\#deleting-frames "Direct link to Deleting Frames")

To delete a FrameGroup, use the [`DatasetVersion.delete_frames()`](https://clear.ml/docs/latest/docs/references/hyperdataset/hyperdatasetversion#delete_frames)
...
- [Usage](https://clear.ml/docs/latest/docs/hyperdatasets/frame_groups/#usage)
  - [Creating a FrameGroup](https://clear.ml/docs/latest/docs/hyperdatasets/frame_groups/#creating-a-framegroup)
  - [Adding FrameGroups to a Dataset Version](https://clear.ml/docs/latest/docs/hyperdatasets/frame_groups/#adding-framegroups-to-a-dataset-version)
  - [Accessing a FrameGroup](https://clear.ml/docs/latest/docs/hyperdatasets/frame_groups/#accessing-a-framegroup)
  - [Updating FrameGroups](https://clear.ml/docs/latest/docs/hyperdatasets/frame_groups/#updating-framegroups)
  - [Deleting Frames](https://clear.ml/docs/latest/docs/hyperdatasets/frame_groups/#deleting-frames)