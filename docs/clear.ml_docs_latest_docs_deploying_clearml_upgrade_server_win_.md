---
url: "https://clear.ml/docs/latest/docs/deploying_clearml/upgrade_server_win/"
title: "Windows | ClearML"
---

[Skip to main content](https://clear.ml/docs/latest/docs/deploying_clearml/upgrade_server_win/#__docusaurus_skipToContent_fallback)
...
2. Execute one of the following commands, depending upon the version that is being upgraded:
   ...
   - Upgrading from **Trains Server** to **ClearML Server**:
     ...
     ```
3. Backing up data is recommended, and if the configuration folder is not empty, backing up the configuration.
...
4. If upgrading from **Trains Server** version 0.15 or older to **ClearML Server**, do the following:
...
5. If upgrading from ClearML Server version 1.1 or older, you need to migrate your data before upgrading your server. See instructions [here](https://clear.ml/docs/latest/docs/deploying_clearml/clearml_server_mongo44_migration).
