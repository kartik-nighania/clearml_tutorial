---
url: "https://clear.ml/docs/latest/docs/guides/services/slack_alerts/"
title: "Monitoring Service Posting Slack Alerts | ClearML"
---

[Skip to main content](https://clear.ml/docs/latest/docs/guides/services/slack_alerts/#__docusaurus_skipToContent_fallback)
...
![Slack alert example](https://clear.ml/docs/latest/assets/images/examples_slack_alerts-c913fc137100020660bb235541b4d933.png#light-mode-only)![Slack alert example](https://clear.ml/docs/latest/assets/images/examples_slack_alerts_dark-c262c57275b8dc2901814280d818a649.png#dark-mode-only)

## Creating a Slackbot [​](https://clear.ml/docs/latest/docs/guides/services/slack_alerts/\#creating-a-slackbot "Direct link to Creating a Slackbot")
...
2. Go to [https://api.slack.com/apps/new](https://api.slack.com/apps/new).
3. In **App Name**, enter an app name. For example, "ClearML Bot".
4. In **Development Slack Workspace**, select a workspace.
5. Click **Create App**.
...
8. In **OAuth & Permissions**, under **Scopes**, click **Add an OAuth Scope**, and then select the following permissions
on the list:
...
## Running the Script [​](https://clear.ml/docs/latest/docs/guides/services/slack_alerts/\#running-the-script "Direct link to Running the Script")

Self-deployed ClearML server

A template `Slack Alerts` task is available in the `DevOps Services` project. You can clone it, adapt its [configuration](https://clear.ml/docs/latest/docs/guides/services/slack_alerts/#configuration)
to your needs and enqueue for execution directly from the ClearML UI.

Run the monitoring service in one of these ways:

- Run locally
- Run in ClearML Agent [services mode](https://clear.ml/docs/latest/docs/clearml_agent/clearml_agent_services_mode)
...
## Configuration [​](https://clear.ml/docs/latest/docs/guides/services/slack_alerts/\#configuration "Direct link to Configuration")
...
![Monitoring configuration](https://clear.ml/docs/latest/assets/images/examples_slack_config-01a6b7fb28714174b131e8d58690f6fe.png)

The task can be reused to launch another monitor instance: clone the task, edit its parameters, and enqueue the task for
execution (you'll typically want to use a ClearML Agent running in [services mode](https://clear.ml/docs/latest/docs/clearml_agent/clearml_agent_services_mode)
for such service tasks).

## Console [​](https://clear.ml/docs/latest/docs/guides/services/slack_alerts/\#console "Direct link to Console")

All console output appears in the task's **CONSOLE** page.

## Additional Information about slack\_alerts.py [​](https://clear.ml/docs/latest/docs/guides/services/slack_alerts/\#additional-information-about-slack_alertspy "Direct link to Additional Information about slack_alerts.py")
...
- `process_task`\- Get the information for a Task, post a Slack message, and output to console.
  ...
  - Allows skipping failed Tasks, if a Task ran for few iterations. Calls [`Task.get_last_iteration`](https://clear.ml/docs/latest/docs/references/sdk/task#get_last_iteration)
    to get the number of iterations.
  - Builds the Slack message which includes the most recent output to the console (retrieved by calling [`Task.get_reported_console_output()`](https://clear.ml/docs/latest/docs/references/sdk/task#get_reported_console_output)),
    and the URL of the Task's output log in the ClearML Web UI (retrieved by calling [`Task.get_output_log_web_page()`](https://clear.ml/docs/latest/docs/references/sdk/task#get_output_log_web_page)).

You can run the example remotely by calling [`Task.execute_remotely()`](https://clear.ml/docs/latest/docs/references/sdk/task#execute_remotely).

To interface to Slack, the example uses `slack_sdk.WebClient` and `slack_sdk.errors.SlackApiError`.

- [Creating a Slackbot](https://clear.ml/docs/latest/docs/guides/services/slack_alerts/#creating-a-slackbot)
- [Running the Script](https://clear.ml/docs/latest/docs/guides/services/slack_alerts/#running-the-script)
- [Configuration](https://clear.ml/docs/latest/docs/guides/services/slack_alerts/#configuration)
- [Console](https://clear.ml/docs/latest/docs/guides/services/slack_alerts/#console)
- [Additional Information about slack\_alerts.py](https://clear.ml/docs/latest/docs/guides/services/slack_alerts/#additional-information-about-slack_alertspy)