---
url: "https://clear.ml/docs/latest/docs/clearml_agent/dynamic_edit_task_pod_template/"
title: "Dynamic Task Pod Templates | ClearML"
---

[Skip to main content](https://clear.ml/docs/latest/docs/clearml_agent/dynamic_edit_task_pod_template/#__docusaurus_skipToContent_fallback)
...
## Agent Configuration [​](https://clear.ml/docs/latest/docs/clearml_agent/dynamic_edit_task_pod_template/\#agent-configuration "Direct link to Agent Configuration")
...
- `task_data` (object) - [Task object](https://clear.ml/docs/latest/docs/references/sdk/task) (as returned by the `tasks.get_by_id` API call). For example, use `task_data.project` to get the task's project ID.
- `task_dict` (dictionary) - Dictionary representation of a [Task object](https://clear.ml/docs/latest/docs/references/sdk/task). Access fields with dictionary keys. For example: `task_dict['id']`
- `providers_info` (dictionary) - [Identity provider](https://clear.ml/docs/latest/docs/user_management/identity_providers) info containing optional information collected for the user running this task
...
### Usage [​](https://clear.ml/docs/latest/docs/clearml_agent/dynamic_edit_task_pod_template/\#usage "Direct link to Usage")
...
## Examples [​](https://clear.ml/docs/latest/docs/clearml_agent/dynamic_edit_task_pod_template/\#examples "Direct link to Examples")

### Example: Edit Template Based on ENV Var [​](https://clear.ml/docs/latest/docs/clearml_agent/dynamic_edit_task_pod_template/\#example-edit-template-based-on-env-var "Direct link to Example: Edit Template Based on ENV Var")
...
### Example: Inject NFS Mount Path [​](https://clear.ml/docs/latest/docs/clearml_agent/dynamic_edit_task_pod_template/\#example-inject-nfs-mount-path "Direct link to Example: Inject NFS Mount Path")
...
### Example: Bind PVC Resource to Task Pod [​](https://clear.ml/docs/latest/docs/clearml_agent/dynamic_edit_task_pod_template/\#example-bind-pvc-resource-to-task-pod "Direct link to Example: Bind PVC Resource to Task Pod")
...
- [Agent Configuration](https://clear.ml/docs/latest/docs/clearml_agent/dynamic_edit_task_pod_template/#agent-configuration)
  - [Usage](https://clear.ml/docs/latest/docs/clearml_agent/dynamic_edit_task_pod_template/#usage)
- [Examples](https://clear.ml/docs/latest/docs/clearml_agent/dynamic_edit_task_pod_template/#examples)
  - [Example: Edit Template Based on ENV Var](https://clear.ml/docs/latest/docs/clearml_agent/dynamic_edit_task_pod_template/#example-edit-template-based-on-env-var)
  - [Example: Inject NFS Mount Path](https://clear.ml/docs/latest/docs/clearml_agent/dynamic_edit_task_pod_template/#example-inject-nfs-mount-path)
  - [Example: Bind PVC Resource to Task Pod](https://clear.ml/docs/latest/docs/clearml_agent/dynamic_edit_task_pod_template/#example-bind-pvc-resource-to-task-pod)