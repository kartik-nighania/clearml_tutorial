---
url: "https://clear.ml/docs/latest/docs/release_notes/clearml_server/open_source/ver_1_6/"
title: "Version 1.6 | ClearML"
---

[Skip to main content](https://clear.ml/docs/latest/docs/release_notes/clearml_server/open_source/ver_1_6/#__docusaurus_skipToContent_fallback)

If you ❤️ ️ **ClearML**, ⭐️ us on [GitHub](https://github.com/clearml/clearml)!

On this page

### ClearML Server 1.6.0 [​](https://clear.ml/docs/latest/docs/release_notes/clearml_server/open_source/ver_1_6/\#clearml-server-160 "Direct link to ClearML Server 1.6.0")

**New Features and Improvements**

- New ClearML Datasets UI pages for tracking dataset versions and exploring version lineage and contents
- Add history navigation to experiments plots UI page ( [ClearML #81](https://github.com/clearml/clearml/issues/81) and [#255](https://github.com/clearml/clearml/issues/255)):
...
UI page ( [ClearML #400](https://github.com/clearml/clearml/issues/400))
- Add "show hidden projects" control ( [ClearML #694](https://github.com/clearml/clearml/issues/694))
- Improve UI projects page setting persistence - User's last chosen settings for recent/name sorting and team/personal
filter is saved ( [ClearML #353](https://github.com/clearml/clearml/issues/353))
...
- Fix experiment selection with 'Shift' key in UI experiment table not working ( [#139](https://github.com/clearml/clearml-server/issues/139))
- Fix UI search error message interferes with inputting search query ( [#138](https://github.com/clearml/clearml-server/issues/138))
- Fix refresh breaks UI breadcrumbs ClearML Server ( [#142](https://github.com/clearml/clearml-server/issues/142))
...
- [ClearML Server 1.6.0](https://clear.ml/docs/latest/docs/release_notes/clearml_server/open_source/ver_1_6/#clearml-server-160)