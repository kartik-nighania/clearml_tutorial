---
url: "https://clear.ml/docs/latest/docs/release_notes/clearml_server/open_source/ver_1_15/"
title: "Version 1.15 | ClearML"
---

[Skip to main content](https://clear.ml/docs/latest/docs/release_notes/clearml_server/open_source/ver_1_15/#__docusaurus_skipToContent_fallback)

If you ❤️ ️ **ClearML**, ⭐️ us on [GitHub](https://github.com/clearml/clearml)!

On this page

### ClearML Server 1.15.1 [​](https://clear.ml/docs/latest/docs/release_notes/clearml_server/open_source/ver_1_15/\#clearml-server-1151 "Direct link to ClearML Server 1.15.1")
...
### ClearML Server 1.15.0 [​](https://clear.ml/docs/latest/docs/release_notes/clearml_server/open_source/ver_1_15/\#clearml-server-1150 "Direct link to ClearML Server 1.15.0")
...
- [ClearML Server 1.15.1](https://clear.ml/docs/latest/docs/release_notes/clearml_server/open_source/ver_1_15/#clearml-server-1151)
- [ClearML Server 1.15.0](https://clear.ml/docs/latest/docs/release_notes/clearml_server/open_source/ver_1_15/#clearml-server-1150)