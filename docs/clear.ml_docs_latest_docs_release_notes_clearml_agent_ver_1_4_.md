---
url: "https://clear.ml/docs/latest/docs/release_notes/clearml_agent/ver_1_4/"
title: "Version 1.4 | ClearML"
---

[Skip to main content](https://clear.ml/docs/latest/docs/release_notes/clearml_agent/ver_1_4/#__docusaurus_skipToContent_fallback)

If you ❤️ ️ **ClearML**, ⭐️ us on [GitHub](https://github.com/clearml/clearml)!

On this page

### ClearML Agent 1.4.1 [​](https://clear.ml/docs/latest/docs/release_notes/clearml_agent/ver_1_4/\#clearml-agent-141 "Direct link to ClearML Agent 1.4.1")
...
### ClearML Agent 1.4.0 [​](https://clear.ml/docs/latest/docs/release_notes/clearml_agent/ver_1_4/\#clearml-agent-140 "Direct link to ClearML Agent 1.4.0")
...
- Fix name not escaped as regex (all services "get\_all" use regex for name)
...
- K8s glue
  ...
  - Fix debug mode
- Fixed documentation ( [#117](https://github.com/clearml/clearml-agent/pull/117))

- [ClearML Agent 1.4.1](https://clear.ml/docs/latest/docs/release_notes/clearml_agent/ver_1_4/#clearml-agent-141)
- [ClearML Agent 1.4.0](https://clear.ml/docs/latest/docs/release_notes/clearml_agent/ver_1_4/#clearml-agent-140)