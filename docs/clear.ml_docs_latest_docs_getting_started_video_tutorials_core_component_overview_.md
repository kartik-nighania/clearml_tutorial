---
url: "https://clear.ml/docs/latest/docs/getting_started/video_tutorials/core_component_overview/"
title: "Core Component Overview | ClearML"
---

[Skip to main content](https://clear.ml/docs/latest/docs/getting_started/video_tutorials/core_component_overview/#__docusaurus_skipToContent_fallback)

If you ❤️ ️ **ClearML**, ⭐️ us on [GitHub](https://github.com/clearml/clearml)!

On this page

## Video Tutorial [​](https://clear.ml/docs/latest/docs/getting_started/video_tutorials/core_component_overview/\#video-tutorial "Direct link to Video Tutorial")

1 - Core Component Overview - YouTube

Tap to unmute

[1 - Core Component Overview](https://www.youtube.com/watch?v=s3k9ntmQmD4) [ClearML](https://www.youtube.com/channel/UCDYdA4hjckRLRVBrCoKenCQ)
...
- [Video Tutorial](https://clear.ml/docs/latest/docs/getting_started/video_tutorials/core_component_overview/#video-tutorial)