---
url: "https://clear.ml/docs/latest/docs/deploying_clearml/enterprise_deploy/vpc_aws/"
title: "AWS VPC | ClearML"
---

[Skip to main content](https://clear.ml/docs/latest/docs/deploying_clearml/enterprise_deploy/vpc_aws/#__docusaurus_skipToContent_fallback)
...
## Prerequisites [​](https://clear.ml/docs/latest/docs/deploying_clearml/enterprise_deploy/vpc_aws/\#prerequisites "Direct link to Prerequisites")
...
## Instance Setup [​](https://clear.ml/docs/latest/docs/deploying_clearml/enterprise_deploy/vpc_aws/\#instance-setup "Direct link to Instance Setup")

note

It is recommended to use a VPC with IPv6 enabled for future usage expansion.

### Create Security Groups for the Server and Load Balancer [​](https://clear.ml/docs/latest/docs/deploying_clearml/enterprise_deploy/vpc_aws/\#create-security-groups-for-the-server-and-load-balancer "Direct link to Create Security Groups for the Server and Load Balancer")
...
2. Create a security group for the main server (`clearml-main`):
   - Ingress:
...
### Create an IAM Role for the Server [​](https://clear.ml/docs/latest/docs/deploying_clearml/enterprise_deploy/vpc_aws/\#create-an-iam-role-for-the-server "Direct link to Create an IAM Role for the Server")
...
### Create Instance [​](https://clear.ml/docs/latest/docs/deploying_clearml/enterprise_deploy/vpc_aws/\#create-instance "Direct link to Create Instance")
...
## Configuration and Software Deployment [​](https://clear.ml/docs/latest/docs/deploying_clearml/enterprise_deploy/vpc_aws/\#configuration-and-software-deployment "Direct link to Configuration and Software Deployment")

### Install Dependencies [​](https://clear.ml/docs/latest/docs/deploying_clearml/enterprise_deploy/vpc_aws/\#install-dependencies "Direct link to Install Dependencies")
...
### Version Deployment [​](https://clear.ml/docs/latest/docs/deploying_clearml/enterprise_deploy/vpc_aws/\#version-deployment "Direct link to Version Deployment")
...
## Load Balancer [​](https://clear.ml/docs/latest/docs/deploying_clearml/enterprise_deploy/vpc_aws/\#load-balancer "Direct link to Load Balancer")
...
1. Security group: As defined [above](https://clear.ml/docs/latest/docs/deploying_clearml/enterprise_deploy/vpc_aws/#create-security-groups-for-the-server-and-load-balancer) for the load balancer
...
## Backups [​](https://clear.ml/docs/latest/docs/deploying_clearml/enterprise_deploy/vpc_aws/\#backups "Direct link to Backups")

### File Server [​](https://clear.ml/docs/latest/docs/deploying_clearml/enterprise_deploy/vpc_aws/\#file-server "Direct link to File Server")
...
### Elastic [​](https://clear.ml/docs/latest/docs/deploying_clearml/enterprise_deploy/vpc_aws/\#elastic "Direct link to Elastic")

#### Create the Backup Repo [​](https://clear.ml/docs/latest/docs/deploying_clearml/enterprise_deploy/vpc_aws/\#create-the-backup-repo "Direct link to Create the Backup Repo")
...
#### Backing Up [​](https://clear.ml/docs/latest/docs/deploying_clearml/enterprise_deploy/vpc_aws/\#backing-up "Direct link to Backing Up")
...
### MongoDB [​](https://clear.ml/docs/latest/docs/deploying_clearml/enterprise_deploy/vpc_aws/\#mongodb "Direct link to MongoDB")
...
## Monitoring [​](https://clear.ml/docs/latest/docs/deploying_clearml/enterprise_deploy/vpc_aws/\#monitoring "Direct link to Monitoring")
...
## Maintenance [​](https://clear.ml/docs/latest/docs/deploying_clearml/enterprise_deploy/vpc_aws/\#maintenance "Direct link to Maintenance")

### Removing App Containers [​](https://clear.ml/docs/latest/docs/deploying_clearml/enterprise_deploy/vpc_aws/\#removing-app-containers "Direct link to Removing App Containers")
...
- [Prerequisites](https://clear.ml/docs/latest/docs/deploying_clearml/enterprise_deploy/vpc_aws/#prerequisites)
- [Instance Setup](https://clear.ml/docs/latest/docs/deploying_clearml/enterprise_deploy/vpc_aws/#instance-setup)
  - [Create Security Groups for the Server and Load Balancer](https://clear.ml/docs/latest/docs/deploying_clearml/enterprise_deploy/vpc_aws/#create-security-groups-for-the-server-and-load-balancer)
  - [Create an IAM Role for the Server](https://clear.ml/docs/latest/docs/deploying_clearml/enterprise_deploy/vpc_aws/#create-an-iam-role-for-the-server)
  - [Create Instance](https://clear.ml/docs/latest/docs/deploying_clearml/enterprise_deploy/vpc_aws/#create-instance)
- [Configuration and Software Deployment](https://clear.ml/docs/latest/docs/deploying_clearml/enterprise_deploy/vpc_aws/#configuration-and-software-deployment)
  - [Install Dependencies](https://clear.ml/docs/latest/docs/deploying_clearml/enterprise_deploy/vpc_aws/#install-dependencies)
  - [Version Deployment](https://clear.ml/docs/latest/docs/deploying_clearml/enterprise_deploy/vpc_aws/#version-deployment)
- [Load Balancer](https://clear.ml/docs/latest/docs/deploying_clearml/enterprise_deploy/vpc_aws/#load-balancer)
- [Backups](https://clear.ml/docs/latest/docs/deploying_clearml/enterprise_deploy/vpc_aws/#backups)
  - [File Server](https://clear.ml/docs/latest/docs/deploying_clearml/enterprise_deploy/vpc_aws/#file-server)
  - [Elastic](https://clear.ml/docs/latest/docs/deploying_clearml/enterprise_deploy/vpc_aws/#elastic)
  - [MongoDB](https://clear.ml/docs/latest/docs/deploying_clearml/enterprise_deploy/vpc_aws/#mongodb)
- [Monitoring](https://clear.ml/docs/latest/docs/deploying_clearml/enterprise_deploy/vpc_aws/#monitoring)
- [Maintenance](https://clear.ml/docs/latest/docs/deploying_clearml/enterprise_deploy/vpc_aws/#maintenance)
  - [Removing App Containers](https://clear.ml/docs/latest/docs/deploying_clearml/enterprise_deploy/vpc_aws/#removing-app-containers)