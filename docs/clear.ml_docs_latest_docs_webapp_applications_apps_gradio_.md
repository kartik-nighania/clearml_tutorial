---
url: "https://clear.ml/docs/latest/docs/webapp/applications/apps_gradio/"
title: "Gradio Launcher | ClearML"
---

[Skip to main content](https://clear.ml/docs/latest/docs/webapp/applications/apps_gradio/#__docusaurus_skipToContent_fallback)
...
Once you start a Gradio launcher instance, you will be provided with an [externally accessible link](https://clear.ml/docs/latest/docs/webapp/applications/apps_gradio/#traffic_router) to
...
- Gradio App status indicator
  - ![Active server](https://clear.ml/docs/latest/icons/ico-gradio-active.svg) \- App is running and is actively in use
  - ![Loading server](https://clear.ml/docs/latest/icons/ico-gradio-loading.svg) \- App is setting up
  - ![Idle server](https://clear.ml/docs/latest/icons/ico-gradio-idle.svg) \- App is idle
  - ![Stopped server](https://clear.ml/docs/latest/icons/ico-gradio-stopped.svg) \- App is stopped
- Idle time
...
![Gradio Dashboard](https://clear.ml/docs/latest/assets/images/apps_gradio-526f91d258c969f41b10ad6fad6016dd.png#light-mode-only)![Gradio Dashboard](https://clear.ml/docs/latest/assets/images/apps_gradio_dark-6049a850b6d661610a3fc78f45e0cd1d.png#dark-mode-only)

## Gradio Launcher Instance Configuration [​](https://clear.ml/docs/latest/docs/webapp/applications/apps_gradio/\#gradio-launcher-instance-configuration "Direct link to Gradio Launcher Instance Configuration")
...
### Configuration Options [​](https://clear.ml/docs/latest/docs/webapp/applications/apps_gradio/\#configuration-options "Direct link to Configuration Options")
...
- **Queue** \- The [ClearML Queue](https://clear.ml/docs/latest/docs/fundamentals/agents_and_queues#what-is-a-queue) to which the Gradio launcher
...
- [Gradio Launcher Instance Configuration](https://clear.ml/docs/latest/docs/webapp/applications/apps_gradio/#gradio-launcher-instance-configuration)
  - [Configuration Options](https://clear.ml/docs/latest/docs/webapp/applications/apps_gradio/#configuration-options)