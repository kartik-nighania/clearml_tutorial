---
url: "https://clear.ml/docs/latest/docs/integrations/yolov5/"
title: "YOLOv5 | ClearML"
---

[Skip to main content](https://clear.ml/docs/latest/docs/integrations/yolov5/#__docusaurus_skipToContent_fallback)
...
- Version and easily access your custom training data with [ClearML Data](https://clear.ml/docs/latest/docs/clearml_data/)
- Remotely train and monitor your YOLOv5 training runs using [ClearML Agent](https://clear.ml/docs/latest/docs/clearml_agent)
- Get the very best mAP using ClearML [Hyperparameter Optimization](https://clear.ml/docs/latest/docs/getting_started/hpo)
- Turn your newly trained YOLOv5 model into an API with just a few commands using [ClearML Serving](https://clear.ml/docs/latest/docs/clearml_serving/)

## Setup [​](https://clear.ml/docs/latest/docs/integrations/yolov5/\#setup "Direct link to Setup")
...
## Training YOLOv5 with ClearML [​](https://clear.ml/docs/latest/docs/integrations/yolov5/\#training-yolov5-with-clearml "Direct link to Training YOLOv5 with ClearML")
...
All of this is captured into a [ClearML Task](https://clear.ml/docs/latest/docs/fundamentals/task). By default, a task called `Training` is created
...
Additionally, you can view all of your YOLOv5 runs tracked by ClearML in the [Task Table](https://clear.ml/docs/latest/docs/webapp/webapp_model_table).
...
## Dataset Version Management [​](https://clear.ml/docs/latest/docs/integrations/yolov5/\#dataset-version-management "Direct link to Dataset Version Management")

Versioning your data separately from your code makes it easier to access the dataset version you need for your
tasks. [ClearML Data](https://clear.ml/docs/latest/docs/clearml_data/) makes data easily accessible from every machine, and links
data and tasks for better traceability.

### Prepare Your Dataset [​](https://clear.ml/docs/latest/docs/integrations/yolov5/\#prepare-your-dataset "Direct link to Prepare Your Dataset")
...
### Upload Your Dataset [​](https://clear.ml/docs/latest/docs/integrations/yolov5/\#upload-your-dataset "Direct link to Upload Your Dataset")
...
### Run Training Using a ClearML Dataset [​](https://clear.ml/docs/latest/docs/integrations/yolov5/\#run-training-using-a-clearml-dataset "Direct link to Run Training Using a ClearML Dataset")
...
## Remote Execution [​](https://clear.ml/docs/latest/docs/integrations/yolov5/\#remote-execution "Direct link to Remote Execution")
...
### Reproducing Task Runs [​](https://clear.ml/docs/latest/docs/integrations/yolov5/\#reproducing-task-runs "Direct link to Reproducing Task Runs")
...
### Executing a Task Remotely [​](https://clear.ml/docs/latest/docs/integrations/yolov5/\#executing-a-task-remotely "Direct link to Executing a Task Remotely")
...
## Hyperparameter Optimization [​](https://clear.ml/docs/latest/docs/integrations/yolov5/\#hyperparameter-optimization "Direct link to Hyperparameter Optimization")
...
- [Setup](https://clear.ml/docs/latest/docs/integrations/yolov5/#setup)
- [Training YOLOv5 with ClearML](https://clear.ml/docs/latest/docs/integrations/yolov5/#training-yolov5-with-clearml)
- [Dataset Version Management](https://clear.ml/docs/latest/docs/integrations/yolov5/#dataset-version-management)
  - [Prepare Your Dataset](https://clear.ml/docs/latest/docs/integrations/yolov5/#prepare-your-dataset)
  - [Upload Your Dataset](https://clear.ml/docs/latest/docs/integrations/yolov5/#upload-your-dataset)
  - [Run Training Using a ClearML Dataset](https://clear.ml/docs/latest/docs/integrations/yolov5/#run-training-using-a-clearml-dataset)
- [Remote Execution](https://clear.ml/docs/latest/docs/integrations/yolov5/#remote-execution)
  - [Reproducing Task Runs](https://clear.ml/docs/latest/docs/integrations/yolov5/#reproducing-task-runs)
  - [Executing a Task Remotely](https://clear.ml/docs/latest/docs/integrations/yolov5/#executing-a-task-remotely)
- [Hyperparameter Optimization](https://clear.ml/docs/latest/docs/integrations/yolov5/#hyperparameter-optimization)