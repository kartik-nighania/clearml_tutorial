---
url: "https://clear.ml/docs/latest/docs/best_practices/data_scientist_best_practices/"
title: "Best Practices | ClearML"
---

[Skip to main content](https://clear.ml/docs/latest/docs/best_practices/data_scientist_best_practices/#__docusaurus_skipToContent_fallback)
...
## Develop Locally [​](https://clear.ml/docs/latest/docs/best_practices/data_scientist_best_practices/\#develop-locally "Direct link to Develop Locally")
...
- [ClearML SDK](https://clear.ml/docs/latest/docs/clearml_sdk/) should be integrated into your code (check out [ClearML Setup](https://clear.ml/docs/latest/docs/clearml_sdk/clearml_sdk_setup)).
This helps visualizing the results and tracking progress.
- [ClearML Agent](https://clear.ml/docs/latest/docs/clearml_agent) helps moving your work to other machines without the hassle of rebuilding the environment every time,
...
- [ClearML Session](https://clear.ml/docs/latest/docs/apps/clearml_session) helps with developing on remote machines, in the same way that you'd develop on your local laptop!

## Train Remotely [​](https://clear.ml/docs/latest/docs/best_practices/data_scientist_best_practices/\#train-remotely "Direct link to Train Remotely")
...
- [ClearML SDK](https://clear.ml/docs/latest/docs/clearml_sdk/) ensures that all the metrics, parameters and Models are automatically logged and can later be
accessed, [compared](https://clear.ml/docs/latest/docs/webapp/webapp_exp_comparing) and [tracked](https://clear.ml/docs/latest/docs/webapp/webapp_exp_track_visual).
- [ClearML Agent](https://clear.ml/docs/latest/docs/clearml_agent) does the heavy lifting. It reproduces the execution environment, clones your code,
applies code patches, manages parameters (including overriding them on the fly), executes the code, and queues multiple tasks.
It can even [build](https://clear.ml/docs/latest/docs/getting_started/clearml_agent_docker_exec#exporting-a-task-into-a-standalone-docker-container) the container for you!
- [ClearML Pipelines](https://clear.ml/docs/latest/docs/pipelines/) ensure that steps run in the same order,
...
## Track EVERYTHING [​](https://clear.ml/docs/latest/docs/best_practices/data_scientist_best_practices/\#track-everything "Direct link to Track EVERYTHING")
...
## Visibility Matters [​](https://clear.ml/docs/latest/docs/best_practices/data_scientist_best_practices/\#visibility-matters "Direct link to Visibility Matters")
...
- [Develop Locally](https://clear.ml/docs/latest/docs/best_practices/data_scientist_best_practices/#develop-locally)
- [Train Remotely](https://clear.ml/docs/latest/docs/best_practices/data_scientist_best_practices/#train-remotely)
- [Track EVERYTHING](https://clear.ml/docs/latest/docs/best_practices/data_scientist_best_practices/#track-everything)
- [Visibility Matters](https://clear.ml/docs/latest/docs/best_practices/data_scientist_best_practices/#visibility-matters)