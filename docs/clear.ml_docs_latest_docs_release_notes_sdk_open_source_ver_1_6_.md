---
url: "https://clear.ml/docs/latest/docs/release_notes/sdk/open_source/ver_1_6/"
title: "Version 1.6 | ClearML"
---

[Skip to main content](https://clear.ml/docs/latest/docs/release_notes/sdk/open_source/ver_1_6/#__docusaurus_skipToContent_fallback)

If you ❤️ ️ **ClearML**, ⭐️ us on [GitHub](https://github.com/clearml/clearml)!

On this page

### ClearML 1.6.4 [​](https://clear.ml/docs/latest/docs/release_notes/sdk/open_source/ver_1_6/\#clearml-164 "Direct link to ClearML 1.6.4")

**Bug Fix**

- Fix `APIClient` fails when calling `get_all` endpoints with API 2.20 (affects CLI tools such as `clearml-session`)

### ClearML 1.6.3 [​](https://clear.ml/docs/latest/docs/release_notes/sdk/open_source/ver_1_6/\#clearml-163 "Direct link to ClearML 1.6.3")

**New Features and Improvements**

- Add option to specify an endpoint URL when creating S3 resource service ( [#673](https://github.com/clearml/clearml/issues/673))
...
- Fix dataset download ( [#713](https://github.com/clearml/clearml/issues/713))
- Fix lock is not released after dataset cache is downloaded ( [#671](https://github.com/clearml/clearml/issues/671))
- Fix deadlock might occur when using process pool large number processes ( [#674](https://github.com/clearml/clearml/issues/674))
- Fix 'series' not appearing on UI when using `logger.report_table()` ( [#684](https://github.com/clearml/clearml/issues/684))
- Fix `Task.init()` docstring to include behavior when executing remotely ( [#737](https://github.com/clearml/clearml/pull/737))
- Fix `KeyError` when running remotely and no params were passed to click ( [ClearML Agent #111](https://github.com/clearml/clearml-agent/issues/111))
...
### ClearML 1.6.2 [​](https://clear.ml/docs/latest/docs/release_notes/sdk/open_source/ver_1_6/\#clearml-162 "Direct link to ClearML 1.6.2")

**Bug Fix**

- Fix format string construction sometimes causing delayed evaluation errors ( [#706](https://github.com/clearml/clearml/issues/706))

### ClearML 1.6.1 [​](https://clear.ml/docs/latest/docs/release_notes/sdk/open_source/ver_1_6/\#clearml-161 "Direct link to ClearML 1.6.1")
...
### ClearML 1.6.0 [​](https://clear.ml/docs/latest/docs/release_notes/sdk/open_source/ver_1_6/\#clearml-160 "Direct link to ClearML 1.6.0")
...
- Fix `Task.get_project()` to return more than 500 entries ( [#612](https://github.com/clearml/clearml/issues/612))
...
- [ClearML 1.6.4](https://clear.ml/docs/latest/docs/release_notes/sdk/open_source/ver_1_6/#clearml-164)
- [ClearML 1.6.3](https://clear.ml/docs/latest/docs/release_notes/sdk/open_source/ver_1_6/#clearml-163)
- [ClearML 1.6.2](https://clear.ml/docs/latest/docs/release_notes/sdk/open_source/ver_1_6/#clearml-162)
- [ClearML 1.6.1](https://clear.ml/docs/latest/docs/release_notes/sdk/open_source/ver_1_6/#clearml-161)
- [ClearML 1.6.0](https://clear.ml/docs/latest/docs/release_notes/sdk/open_source/ver_1_6/#clearml-160)