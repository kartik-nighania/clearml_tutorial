---
url: "https://clear.ml/docs/latest/docs/hyperdatasets/sources/"
title: "Sources | ClearML"
---

[Skip to main content](https://clear.ml/docs/latest/docs/hyperdatasets/sources/#__docusaurus_skipToContent_fallback)
...
- Sources for [masks](https://clear.ml/docs/latest/docs/hyperdatasets/masks) used in semantic segmentation
- Image [previews](https://clear.ml/docs/latest/docs/hyperdatasets/previews), which are thumbnails used in the ClearML Enterprise WebApp (UI).
...
## Examples [​](https://clear.ml/docs/latest/docs/hyperdatasets/sources/\#examples "Direct link to Examples")

The examples below demonstrate the `sources` section of a Frame for different types of content.

### Example 1: Video Sources [​](https://clear.ml/docs/latest/docs/hyperdatasets/sources/\#example-1-video-sources "Direct link to Example 1: Video Sources")
...
\
### Example 2: Images Sources [​](https://clear.ml/docs/latest/docs/hyperdatasets/sources/\#example-2-images-sources "Direct link to Example 2: Images Sources")\
\
...
\
### Example 3: Sources and Regions of Interest [​](https://clear.ml/docs/latest/docs/hyperdatasets/sources/\#example-3-sources-and-regions-of-interest "Direct link to Example 3: Sources and Regions of Interest")\
\
...
\
- [Examples](https://clear.ml/docs/latest/docs/hyperdatasets/sources/#examples)\
  - [Example 1: Video Sources](https://clear.ml/docs/latest/docs/hyperdatasets/sources/#example-1-video-sources)\
  - [Example 2: Images Sources](https://clear.ml/docs/latest/docs/hyperdatasets/sources/#example-2-images-sources)\
  - [Example 3: Sources and Regions of Interest](https://clear.ml/docs/latest/docs/hyperdatasets/sources/#example-3-sources-and-regions-of-interest)