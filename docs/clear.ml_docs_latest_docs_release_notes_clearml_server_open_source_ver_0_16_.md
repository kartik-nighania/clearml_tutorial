---
url: "https://clear.ml/docs/latest/docs/release_notes/clearml_server/open_source/ver_0_16/"
title: "Version 0.16 | ClearML"
---

[Skip to main content](https://clear.ml/docs/latest/docs/release_notes/clearml_server/open_source/ver_0_16/#__docusaurus_skipToContent_fallback)
...
### Trains Server 0.16.1 [​](https://clear.ml/docs/latest/docs/release_notes/clearml_server/open_source/ver_0_16/\#trains-server-0161 "Direct link to Trains Server 0.16.1")

important

Upgrading to this version requires a manual [data migration](https://clear.ml/docs/latest/docs/deploying_clearml/clearml_server_es7_migration).
...
### Trains Server 0.16.0 [​](https://clear.ml/docs/latest/docs/release_notes/clearml_server/open_source/ver_0_16/\#trains-server-0160 "Direct link to Trains Server 0.16.0")
...
- Add experiment hyperparameter grouping:
  ...
  - Add TensorFlow definitions group ( **CONFIGURATIONS / HYPER PARAMETERS / TF\_DEFINE**).
...
- Move to ElasticSearch 7. Requires manual [data migration](https://clear.ml/docs/latest/docs/deploying_clearml/clearml_server_es7_migration).
...
- [Trains Server 0.16.1](https://clear.ml/docs/latest/docs/release_notes/clearml_server/open_source/ver_0_16/#trains-server-0161)
- [Trains Server 0.16.0](https://clear.ml/docs/latest/docs/release_notes/clearml_server/open_source/ver_0_16/#trains-server-0160)