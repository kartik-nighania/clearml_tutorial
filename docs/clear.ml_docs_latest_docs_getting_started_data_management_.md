---
url: "https://clear.ml/docs/latest/docs/getting_started/data_management/"
title: "Managing Your Data | ClearML"
---

[Skip to main content](https://clear.ml/docs/latest/docs/getting_started/data_management/#__docusaurus_skipToContent_fallback)
...
[ClearML Data](https://clear.ml/docs/latest/docs/clearml_data/) lets you:
...
- `clearml.Dataset` \- A Python interface for creating, retrieving, managing, and using datasets. See [SDK](https://clear.ml/docs/latest/docs/clearml_data/clearml_data_sdk)
for an overview of the basic methods of the Dataset module.
- `clearml-data` \- A CLI utility for creating, uploading, and managing datasets. See [CLI](https://clear.ml/docs/latest/docs/clearml_data/clearml_data_cli)
for a reference of `clearml-data` commands.
- Hyper-Datasets - ClearML's advanced queryable dataset management solution. For more information, see [Hyper-Datasets](https://clear.ml/docs/latest/docs/hyperdatasets/overview)
...
## Creating Dataset [​](https://clear.ml/docs/latest/docs/getting_started/data_management/\#creating-dataset "Direct link to Creating Dataset")
...
2. Add data to the dataset using `clearml-data sync` and passing the path of the folder to be added to the dataset.
...
## Preprocessing Data [​](https://clear.ml/docs/latest/docs/getting_started/data_management/\#preprocessing-data "Direct link to Preprocessing Data")
...
2. Access a dataset using [`Dataset.get()`](https://clear.ml/docs/latest/docs/references/sdk/dataset#datasetget):
...
3. Get a local mutable copy of the dataset using [`Dataset.get_mutable_local_copy`](https://clear.ml/docs/latest/docs/references/sdk/dataset#get_mutable_local_copy).
...
4. Preprocess the data, including modifying some files in the `./work_dataset` folder.

5. Create a new version of the dataset:
...
6. Add the modified data to the dataset:
...
7. Remove the `latest` tag from the previous dataset and add the tag to the new dataset:
...
## Training [​](https://clear.ml/docs/latest/docs/getting_started/data_management/\#training "Direct link to Training")
...
- [Creating Dataset](https://clear.ml/docs/latest/docs/getting_started/data_management/#creating-dataset)
- [Preprocessing Data](https://clear.ml/docs/latest/docs/getting_started/data_management/#preprocessing-data)
- [Training](https://clear.ml/docs/latest/docs/getting_started/data_management/#training)