---
url: "https://clear.ml/docs/latest/docs/clearml_agent/fractional_gpus/cdmo/"
title: "Managing GPU Fractions with ClearML Dynamic MIG Operator (CDMO) | ClearML"
---

[Skip to main content](https://clear.ml/docs/latest/docs/clearml_agent/fractional_gpus/cdmo/#__docusaurus_skipToContent_fallback)
...
## Installation [​](https://clear.ml/docs/latest/docs/clearml_agent/fractional_gpus/cdmo/\#installation "Direct link to Installation")

### Requirements [​](https://clear.ml/docs/latest/docs/clearml_agent/fractional_gpus/cdmo/\#requirements "Direct link to Requirements")
...
### Installing CDMO [​](https://clear.ml/docs/latest/docs/clearml_agent/fractional_gpus/cdmo/\#installing-cdmo "Direct link to Installing CDMO")
...
2. Create a `cdmo-values.override.yaml` file with the following content:
...
3. Install the CDMO Helm Chart using the previous override file:
...
4. Enable the NVIDIA MIG support on your cluster by running the following command on all nodes with a MIG-supported GPU
...
5. Label all MIG-enabled GPU nodes `<NODE_NAME>` from the previous step:
...
## Assigning MIG Profiles to Workloads [​](https://clear.ml/docs/latest/docs/clearml_agent/fractional_gpus/cdmo/\#assigning-mig-profiles-to-workloads "Direct link to Assigning MIG Profiles to Workloads")

ClearML Agents deployed on Kubernetes support per-queue [customization](https://clear.ml/docs/latest/docs/clearml_agent/clearml_agent_custom_workload) of workload
pod definitions.
...
## Disabling MIGs [​](https://clear.ml/docs/latest/docs/clearml_agent/fractional_gpus/cdmo/\#disabling-migs "Direct link to Disabling MIGs")
...
- [Installation](https://clear.ml/docs/latest/docs/clearml_agent/fractional_gpus/cdmo/#installation)
  - [Requirements](https://clear.ml/docs/latest/docs/clearml_agent/fractional_gpus/cdmo/#requirements)
  - [Installing CDMO](https://clear.ml/docs/latest/docs/clearml_agent/fractional_gpus/cdmo/#installing-cdmo)
- [Assigning MIG Profiles to Workloads](https://clear.ml/docs/latest/docs/clearml_agent/fractional_gpus/cdmo/#assigning-mig-profiles-to-workloads)
- [Disabling MIGs](https://clear.ml/docs/latest/docs/clearml_agent/fractional_gpus/cdmo/#disabling-migs)