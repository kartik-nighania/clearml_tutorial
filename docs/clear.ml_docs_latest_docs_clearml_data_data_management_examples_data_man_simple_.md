---
url: "https://clear.ml/docs/latest/docs/clearml_data/data_management_examples/data_man_simple/"
title: "Data Management from CLI | ClearML"
---

[Skip to main content](https://clear.ml/docs/latest/docs/clearml_data/data_management_examples/data_man_simple/#__docusaurus_skipToContent_fallback)
...
## Prerequisites [​](https://clear.ml/docs/latest/docs/clearml_data/data_management_examples/data_man_simple/\#prerequisites "Direct link to Prerequisites")

1. First, make sure that you have cloned the [clearml](https://github.com/clearml/clearml) repository. It contains all
the needed files.

2. Open terminal and change directory to the cloned repository's examples folder:
...
## Creating Initial Dataset [​](https://clear.ml/docs/latest/docs/clearml_data/data_management_examples/data_man_simple/\#creating-initial-dataset "Direct link to Creating Initial Dataset")
...
2. Add a folder. File addition is recursive, so it's enough to point at the folder
...
this can be configured with the `--storage` flag to any of ClearML's supported storage mediums (see [storage](https://clear.ml/docs/latest/docs/integrations/storage)).
...
## Listing Dataset Content [​](https://clear.ml/docs/latest/docs/clearml_data/data_management_examples/data_man_simple/\#listing-dataset-content "Direct link to Listing Dataset Content")
...
## Creating a Child Dataset [​](https://clear.ml/docs/latest/docs/clearml_data/data_management_examples/data_man_simple/\#creating-a-child-dataset "Direct link to Creating a Child Dataset")
...
3. Remove a file. You need to specify the file's full path (within the dataset, not locally) to remove it.
...
5. Look again at the files in the dataset:
...
- [Prerequisites](https://clear.ml/docs/latest/docs/clearml_data/data_management_examples/data_man_simple/#prerequisites)
- [Creating Initial Dataset](https://clear.ml/docs/latest/docs/clearml_data/data_management_examples/data_man_simple/#creating-initial-dataset)
- [Listing Dataset Content](https://clear.ml/docs/latest/docs/clearml_data/data_management_examples/data_man_simple/#listing-dataset-content)
- [Creating a Child Dataset](https://clear.ml/docs/latest/docs/clearml_data/data_management_examples/data_man_simple/#creating-a-child-dataset)