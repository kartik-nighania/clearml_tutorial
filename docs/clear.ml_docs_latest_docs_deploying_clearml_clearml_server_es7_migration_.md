---
url: "https://clear.ml/docs/latest/docs/deploying_clearml/clearml_server_es7_migration/"
title: "Upgrading Server from v0.15 or Older to ClearML Server | ClearML"
---

[Skip to main content](https://clear.ml/docs/latest/docs/deploying_clearml/clearml_server_es7_migration/#__docusaurus_skipToContent_fallback)
...
### Prerequisites [​](https://clear.ml/docs/latest/docs/deploying_clearml/clearml_server_es7_migration/\#prerequisites "Direct link to Prerequisites")
...
### Migrating the Data [​](https://clear.ml/docs/latest/docs/deploying_clearml/clearml_server_es7_migration/\#migrating-the-data "Direct link to Migrating the Data")
...
### Verifying the Data Migration [​](https://clear.ml/docs/latest/docs/deploying_clearml/clearml_server_es7_migration/\#verifying-the-data-migration "Direct link to Verifying the Data Migration")
...
[GitHub issues](https://github.com/clearml/clearml-server/issues), and the **ClearML Server** sections of the [FAQ](https://clear.ml/docs/latest/docs/faq).

### Upgrading to ClearML Server v.1.2 or Newer [​](https://clear.ml/docs/latest/docs/deploying_clearml/clearml_server_es7_migration/\#upgrading-to-clearml-server-v12-or-newer "Direct link to Upgrading to ClearML Server v.1.2 or Newer")

If you are upgrading your ClearML Server to version 1.2 or newer, you will need to migrate your database contents to be
compatible with the new version. See instructions [here](https://clear.ml/docs/latest/docs/deploying_clearml/clearml_server_mongo44_migration). Otherwise, continue the instructions below.

### Completing the Installation [​](https://clear.ml/docs/latest/docs/deploying_clearml/clearml_server_es7_migration/\#completing-the-installation "Direct link to Completing the Installation")
...
- [Prerequisites](https://clear.ml/docs/latest/docs/deploying_clearml/clearml_server_es7_migration/#prerequisites)
- [Migrating the Data](https://clear.ml/docs/latest/docs/deploying_clearml/clearml_server_es7_migration/#migrating-the-data)
- [Verifying the Data Migration](https://clear.ml/docs/latest/docs/deploying_clearml/clearml_server_es7_migration/#verifying-the-data-migration)
- [Upgrading to ClearML Server v.1.2 or Newer](https://clear.ml/docs/latest/docs/deploying_clearml/clearml_server_es7_migration/#upgrading-to-clearml-server-v12-or-newer)
- [Completing the Installation](https://clear.ml/docs/latest/docs/deploying_clearml/clearml_server_es7_migration/#completing-the-installation)