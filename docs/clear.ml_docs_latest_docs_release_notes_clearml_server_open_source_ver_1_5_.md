---
url: "https://clear.ml/docs/latest/docs/release_notes/clearml_server/open_source/ver_1_5/"
title: "Version 1.5 | ClearML"
---

[Skip to main content](https://clear.ml/docs/latest/docs/release_notes/clearml_server/open_source/ver_1_5/#__docusaurus_skipToContent_fallback)

If you ❤️ ️ **ClearML**, ⭐️ us on [GitHub](https://github.com/clearml/clearml)!

On this page

### ClearML Server 1.5.0 [​](https://clear.ml/docs/latest/docs/release_notes/clearml_server/open_source/ver_1_5/\#clearml-server-150 "Direct link to ClearML Server 1.5.0")
...
- Add UI adherence to user specified plot dimensions ( [ClearML #587](https://github.com/clearml/clearml/issues/587))
- Add row highlight to experiment textual comparison UI ( [ClearML #581](https://github.com/clearml/clearml/issues/581))
...
- Fix UI experiment debug samples disappearing after refresh ( [#136](https://github.com/clearml/clearml-server/issues/136))
- Fix deleting tasks sometimes raises errors ( [ClearML #632](https://github.com/clearml/clearml/issues/632))
...
- [ClearML Server 1.5.0](https://clear.ml/docs/latest/docs/release_notes/clearml_server/open_source/ver_1_5/#clearml-server-150)