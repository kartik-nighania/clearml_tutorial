---
url: "https://clear.ml/docs/latest/docs/webapp/settings/webapp_settings_id_providers/"
title: "Identity Providers | ClearML"
---

[Skip to main content](https://clear.ml/docs/latest/docs/webapp/settings/webapp_settings_id_providers/#__docusaurus_skipToContent_fallback)
...
5. Click **Test Provider** to make sure that the connection is working. This calls the identity provider, and displays
...
![Test provider window](https://clear.ml/docs/latest/assets/images/settings_sso_provider_test-3cc7f1ab325e1176e65b6c2e6d37a451.png)
...
![Identity provider chart](https://clear.ml/docs/latest/assets/images/settings_identity_chart-62667972b703cb743a8755929e114aa7.png#light-mode-only)![Identity provider chart](https://clear.ml/docs/latest/assets/images/settings_identity_chart_dark-cbe48f935758a01f0349d3be8cb8bcef.png#dark-mode-only)