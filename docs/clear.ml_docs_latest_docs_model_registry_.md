...
[Skip to main content](https://clear.ml/docs/latest/docs/model_registry/#__docusaurus_skipToContent_fallback)

If you ❤️ ️ **ClearML**, ⭐️ us on [GitHub](https://github.com/clearml/clearml)!

On this page

Model management for experiment tracking! -- 🧠 WISDOM NUGGET - YouTube

Tap to unmute

[Model management for experiment tracking! -- 🧠 WISDOM NUGGET](https://www.youtube.com/watch?v=lAiw2HqHlWo) [ClearML](https://www.youtube.com/channel/UCDYdA4hjckRLRVBrCoKenCQ)
...
Create a visual web interface and interactively demo your models using the [Gradio](https://clear.ml/docs/latest/docs/webapp/applications/apps_gradio)
and [Streamlit](https://clear.ml/docs/latest/docs/webapp/applications/apps_streamlit) launcher apps (available under the ClearML Enterprise plan).

[ClearML Serving](https://clear.ml/docs/latest/docs/clearml_serving/) lets you deploy your models, and continue updating them as you
continue to train and test new model versions.

## Registering Models [​](https://clear.ml/docs/latest/docs/model_registry/\#registering-models "Direct link to Registering Models")

ClearML supports automatic and manual registration of models to the model catalog.

### Automatic Logging [​](https://clear.ml/docs/latest/docs/model_registry/\#automatic-logging "Direct link to Automatic Logging")

ClearML automatically logs models created/loaded through popular frameworks like TensorFlow or scikit-learn; all you
need to do is [instantiate a ClearML Task](https://clear.ml/docs/latest/docs/clearml_sdk/task_sdk#task-creation) in your code. ClearML stores the
...
You may want more control over which models are logged. Use the `auto_connect_framework` parameter of [`Task.init()`](https://clear.ml/docs/latest/docs/references/sdk/task#taskinit)
...
See [Automatic Logging](https://clear.ml/docs/latest/docs/clearml_sdk/task_sdk#automatic-logging) for more information about controlling model logging.

### Manual Logging [​](https://clear.ml/docs/latest/docs/model_registry/\#manual-logging "Direct link to Manual Logging")

You can explicitly specify a task’s models using ClearML `InputModel` and `OutputModel` classes.

#### InputModel [​](https://clear.ml/docs/latest/docs/model_registry/\#inputmodel "Direct link to InputModel")

Use the [`InputModel`](https://clear.ml/docs/latest/docs/references/sdk/model_inputmodel) class to load either a model that is already registered in
...
#### OutputModel [​](https://clear.ml/docs/latest/docs/model_registry/\#outputmodel "Direct link to OutputModel")

Use the [`OutputModel`](https://clear.ml/docs/latest/docs/references/sdk/model_outputmodel) class to log your task outputs. An OutputModel object
is instantiated with a task object as an argument (see [`task`](https://clear.ml/docs/latest/docs/references/sdk/model_outputmodel) parameter), so it's
...
with [`Task.update_output_model()`](https://clear.ml/docs/latest/docs/references/sdk/task#update_output_model) or [`OutputModel.update_weights()`](https://clear.ml/docs/latest/docs/references/sdk/model_outputmodel#update_weights).
...
## Analyzing Models [​](https://clear.ml/docs/latest/docs/model_registry/\#analyzing-models "Direct link to Analyzing Models")
...
label enumeration, and general information, click the model name, which is a hyperlink to the [model's detail page](https://clear.ml/docs/latest/docs/webapp/webapp_model_viewing).
...
You can [compare models](https://clear.ml/docs/latest/docs/webapp/webapp_model_comparing) through the web UI, allowing you to easily identify,
...
## Working with Models [​](https://clear.ml/docs/latest/docs/model_registry/\#working-with-models "Direct link to Working with Models")
...
1. Clone a task
2. Go to the task's **Artifacts** tab
3. Hover over an input model's `Model name` field and click **Edit**. Then click ![Edit Pencil](https://clear.ml/docs/latest/icons/ico-edit.svg).
...
### Querying Models [​](https://clear.ml/docs/latest/docs/model_registry/\#querying-models "Direct link to Querying Models")
...
See [Querying Models](https://clear.ml/docs/latest/docs/clearml_sdk/model_sdk#querying-models) for more information and examples.

### SDK Interface [​](https://clear.ml/docs/latest/docs/model_registry/\#sdk-interface "Direct link to SDK Interface")

Once you have retrieved a model object, you can work with it programmatically.

See the [Model SDK interface](https://clear.ml/docs/latest/docs/clearml_sdk/model_sdk) for an overview of model classes' Pythonic methods. See a
detailed list of all available methods in the [Model](https://clear.ml/docs/latest/docs/references/sdk/model_model), [OutputModel](https://clear.ml/docs/latest/docs/references/sdk/model_outputmodel),
and [InputModel](https://clear.ml/docs/latest/docs/references/sdk/model_inputmodel) reference pages.

## Creating Visual Web Interface [​](https://clear.ml/docs/latest/docs/model_registry/\#creating-visual-web-interface "Direct link to Creating Visual Web Interface")
...
Create a visual web interface and interactively demo your models using the [Gradio](https://clear.ml/docs/latest/docs/webapp/applications/apps_gradio)
and [Streamlit](https://clear.ml/docs/latest/docs/webapp/applications/apps_streamlit) launcher apps.
...
## Serving Models [​](https://clear.ml/docs/latest/docs/model_registry/\#serving-models "Direct link to Serving Models")

[ClearML Serving](https://clear.ml/docs/latest/docs/clearml_serving/) provides a command line utility for model deployment and
...
See [ClearML Serving](https://clear.ml/docs/latest/docs/clearml_serving/) for more information.

- [Registering Models](https://clear.ml/docs/latest/docs/model_registry/#registering-models)
  - [Automatic Logging](https://clear.ml/docs/latest/docs/model_registry/#automatic-logging)
  - [Manual Logging](https://clear.ml/docs/latest/docs/model_registry/#manual-logging)
- [Analyzing Models](https://clear.ml/docs/latest/docs/model_registry/#analyzing-models)
- [Working with Models](https://clear.ml/docs/latest/docs/model_registry/#working-with-models)
  - [Querying Models](https://clear.ml/docs/latest/docs/model_registry/#querying-models)
  - [SDK Interface](https://clear.ml/docs/latest/docs/model_registry/#sdk-interface)
- [Creating Visual Web Interface](https://clear.ml/docs/latest/docs/model_registry/#creating-visual-web-interface)
- [Serving Models](https://clear.ml/docs/latest/docs/model_registry/#serving-models)