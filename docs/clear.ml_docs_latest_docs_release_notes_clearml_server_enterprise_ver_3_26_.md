---
url: "https://clear.ml/docs/latest/docs/release_notes/clearml_server/enterprise/ver_3_26/"
title: "Version 3.26 | ClearML"
---

[Skip to main content](https://clear.ml/docs/latest/docs/release_notes/clearml_server/enterprise/ver_3_26/#__docusaurus_skipToContent_fallback)

If you ❤️ ️ **ClearML**, ⭐️ us on [GitHub](https://github.com/clearml/clearml)!

On this page

### Enterprise Server 3.26.10 [​](https://clear.ml/docs/latest/docs/release_notes/clearml_server/enterprise/ver_3_26/\#enterprise-server-32610 "Direct link to Enterprise Server 3.26.10")

**Improvements**

- Improve security

### Enterprise Server 3.26.9 [​](https://clear.ml/docs/latest/docs/release_notes/clearml_server/enterprise/ver_3_26/\#enterprise-server-3269 "Direct link to Enterprise Server 3.26.9")
...
### Enterprise Server 3.26.8 [​](https://clear.ml/docs/latest/docs/release_notes/clearml_server/enterprise/ver_3_26/\#enterprise-server-3268 "Direct link to Enterprise Server 3.26.8")
...
### Enterprise Server 3.26.7 [​](https://clear.ml/docs/latest/docs/release_notes/clearml_server/enterprise/ver_3_26/\#enterprise-server-3267 "Direct link to Enterprise Server 3.26.7")
...
### Enterprise Server 3.26.6 [​](https://clear.ml/docs/latest/docs/release_notes/clearml_server/enterprise/ver_3_26/\#enterprise-server-3266 "Direct link to Enterprise Server 3.26.6")

**Bug Fix**

- Fix Task cleaner fails with password-protected external MongoDB

### Enterprise Server 3.26.5 [​](https://clear.ml/docs/latest/docs/release_notes/clearml_server/enterprise/ver_3_26/\#enterprise-server-3265 "Direct link to Enterprise Server 3.26.5")

**New Feature**

- Enable customization of server console log messages

### Enterprise Server 3.26.3 [​](https://clear.ml/docs/latest/docs/release_notes/clearml_server/enterprise/ver_3_26/\#enterprise-server-3263 "Direct link to Enterprise Server 3.26.3")
...
### Enterprise Server 3.26.1 [​](https://clear.ml/docs/latest/docs/release_notes/clearml_server/enterprise/ver_3_26/\#enterprise-server-3261 "Direct link to Enterprise Server 3.26.1")
...
### Enterprise Server 3.26.0 [​](https://clear.ml/docs/latest/docs/release_notes/clearml_server/enterprise/ver_3_26/\#enterprise-server-3260 "Direct link to Enterprise Server 3.26.0")

Application Gateway Compatibility
...
- [Enterprise Server 3.26.10](https://clear.ml/docs/latest/docs/release_notes/clearml_server/enterprise/ver_3_26/#enterprise-server-32610)
- [Enterprise Server 3.26.9](https://clear.ml/docs/latest/docs/release_notes/clearml_server/enterprise/ver_3_26/#enterprise-server-3269)
- [Enterprise Server 3.26.8](https://clear.ml/docs/latest/docs/release_notes/clearml_server/enterprise/ver_3_26/#enterprise-server-3268)
- [Enterprise Server 3.26.7](https://clear.ml/docs/latest/docs/release_notes/clearml_server/enterprise/ver_3_26/#enterprise-server-3267)
- [Enterprise Server 3.26.6](https://clear.ml/docs/latest/docs/release_notes/clearml_server/enterprise/ver_3_26/#enterprise-server-3266)
- [Enterprise Server 3.26.5](https://clear.ml/docs/latest/docs/release_notes/clearml_server/enterprise/ver_3_26/#enterprise-server-3265)
- [Enterprise Server 3.26.3](https://clear.ml/docs/latest/docs/release_notes/clearml_server/enterprise/ver_3_26/#enterprise-server-3263)
- [Enterprise Server 3.26.1](https://clear.ml/docs/latest/docs/release_notes/clearml_server/enterprise/ver_3_26/#enterprise-server-3261)
- [Enterprise Server 3.26.0](https://clear.ml/docs/latest/docs/release_notes/clearml_server/enterprise/ver_3_26/#enterprise-server-3260)