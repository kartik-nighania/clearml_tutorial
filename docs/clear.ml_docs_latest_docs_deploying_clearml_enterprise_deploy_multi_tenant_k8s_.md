---
url: "https://clear.ml/docs/latest/docs/deploying_clearml/enterprise_deploy/multi_tenant_k8s/"
title: "Multi-Tenant Service on Kubernetes | ClearML"
---

[Skip to main content](https://clear.ml/docs/latest/docs/deploying_clearml/enterprise_deploy/multi_tenant_k8s/#__docusaurus_skipToContent_fallback)
...
## ClearML Server [​](https://clear.ml/docs/latest/docs/deploying_clearml/enterprise_deploy/multi_tenant_k8s/\#clearml-server "Direct link to ClearML Server")

To install the ClearML Server, follow the [ClearML Kubernetes Installation guide](https://clear.ml/docs/latest/docs/deploying_clearml/enterprise_deploy/k8s).
...
For configuring SSO, see the [SSO (Identity Provider) Setup guide](https://clear.ml/docs/latest/docs/user_management/identity_providers).

### Create a Tenant [​](https://clear.ml/docs/latest/docs/deploying_clearml/enterprise_deploy/multi_tenant_k8s/\#create-a-tenant "Direct link to Create a Tenant")
...
You can use this set of credentials to set up a [ClearML Agent](https://clear.ml/docs/latest/docs/clearml_agent/clearml_agent_deployment_k8s#agent-with-an-enterprise-server)
or [App Gateway](https://clear.ml/docs/latest/docs/deploying_clearml/enterprise_deploy/appgw) for the new Tenant.


#### Create IDP/SSO Sign-in Rules [​](https://clear.ml/docs/latest/docs/deploying_clearml/enterprise_deploy/multi_tenant_k8s/\#create-idpsso-sign-in-rules "Direct link to Create IDP/SSO Sign-in Rules")
...
##### View Current Login Routing Rules [​](https://clear.ml/docs/latest/docs/deploying_clearml/enterprise_deploy/multi_tenant_k8s/\#view-current-login-routing-rules "Direct link to View Current Login Routing Rules")
...
### Feature Control by User Group [​](https://clear.ml/docs/latest/docs/deploying_clearml/enterprise_deploy/multi_tenant_k8s/\#feature-control-by-user-group "Direct link to Feature Control by User Group")
...
See a list of available features under [Available Features](https://clear.ml/docs/latest/docs/deploying_clearml/enterprise_deploy/multi_tenant_k8s/#available-features).

## Workers [​](https://clear.ml/docs/latest/docs/deploying_clearml/enterprise_deploy/multi_tenant_k8s/\#workers "Direct link to Workers")

To install and configure the ClearML components that run user workloads, refer to:

- [ClearML Enterprise Agent](https://clear.ml/docs/latest/docs/clearml_agent/clearml_agent_deployment_k8s#agent-with-an-enterprise-server)
- [App Gateway](https://clear.ml/docs/latest/docs/deploying_clearml/enterprise_deploy/appgw).

note

Make sure to set up Agent and App Gateway using a Tenant's admin user credentials created with the Tenant creation APIs
described [above](https://clear.ml/docs/latest/docs/deploying_clearml/enterprise_deploy/multi_tenant_k8s/#create-a-tenant).

### Tenant Separation [​](https://clear.ml/docs/latest/docs/deploying_clearml/enterprise_deploy/multi_tenant_k8s/\#tenant-separation "Direct link to Tenant Separation")
...
## Additional Configuration [​](https://clear.ml/docs/latest/docs/deploying_clearml/enterprise_deploy/multi_tenant_k8s/\#additional-configuration "Direct link to Additional Configuration")

### Override Options for New Tenants [​](https://clear.ml/docs/latest/docs/deploying_clearml/enterprise_deploy/multi_tenant_k8s/\#override-options-for-new-tenants "Direct link to Override Options for New Tenants")
...
### Global Features Limits [​](https://clear.ml/docs/latest/docs/deploying_clearml/enterprise_deploy/multi_tenant_k8s/\#global-features-limits "Direct link to Global Features Limits")
...
For the complete list of available features, see [Available Features](https://clear.ml/docs/latest/docs/deploying_clearml/enterprise_deploy/multi_tenant_k8s/#available-features).

### Configuring Groups [​](https://clear.ml/docs/latest/docs/deploying_clearml/enterprise_deploy/multi_tenant_k8s/\#configuring-groups "Direct link to Configuring Groups")
...
#### Group Types [​](https://clear.ml/docs/latest/docs/deploying_clearml/enterprise_deploy/multi_tenant_k8s/\#group-types "Direct link to Group Types")
...
the UI. For more information, see [Users & Groups](https://clear.ml/docs/latest/docs/webapp/settings/webapp_settings_users).
...
#### Configuring Cross-Tenant Groups [​](https://clear.ml/docs/latest/docs/deploying_clearml/enterprise_deploy/multi_tenant_k8s/\#configuring-cross-tenant-groups "Direct link to Configuring Cross-Tenant Groups")
...
##### Configuration Variables [​](https://clear.ml/docs/latest/docs/deploying_clearml/enterprise_deploy/multi_tenant_k8s/\#configuration-variables "Direct link to Configuration Variables")
...
##### Example Configuration [​](https://clear.ml/docs/latest/docs/deploying_clearml/enterprise_deploy/multi_tenant_k8s/\#example-configuration "Direct link to Example Configuration")
...
### Feature Assignment Strategy [​](https://clear.ml/docs/latest/docs/deploying_clearml/enterprise_deploy/multi_tenant_k8s/\#feature-assignment-strategy "Direct link to Feature Assignment Strategy")
...
#### Combining Features [​](https://clear.ml/docs/latest/docs/deploying_clearml/enterprise_deploy/multi_tenant_k8s/\#combining-features "Direct link to Combining Features")
...
#### Configuring the Default 'users' Group [​](https://clear.ml/docs/latest/docs/deploying_clearml/enterprise_deploy/multi_tenant_k8s/\#configuring-the-default-users-group "Direct link to Configuring the Default 'users' Group")
...
#### Setting Server-Level or Tenant-level Features [​](https://clear.ml/docs/latest/docs/deploying_clearml/enterprise_deploy/multi_tenant_k8s/\#setting-server-level-or-tenant-level-features "Direct link to Setting Server-Level or Tenant-level Features")

To assign a feature to a group, that feature must first be enabled globally (server-level) or per tenant.

##### Enabling Features Globally [​](https://clear.ml/docs/latest/docs/deploying_clearml/enterprise_deploy/multi_tenant_k8s/\#enabling-features-globally "Direct link to Enabling Features Globally")
...
##### Enabling Features Per Tenant [​](https://clear.ml/docs/latest/docs/deploying_clearml/enterprise_deploy/multi_tenant_k8s/\#enabling-features-per-tenant "Direct link to Enabling Features Per Tenant")
...
#### Example: Granting All Features for Admins [​](https://clear.ml/docs/latest/docs/deploying_clearml/enterprise_deploy/multi_tenant_k8s/\#example-granting-all-features-for-admins "Direct link to Example: Granting All Features for Admins")

While the `admins` group has inherent administrative privileges, you might want to explicitly ensure they have access to
_all_ configurable features defined via the `features` list, especially if you've restricted the default `users` group
...
### Per-Tenant Applications Settings [​](https://clear.ml/docs/latest/docs/deploying_clearml/enterprise_deploy/multi_tenant_k8s/\#per-tenant-applications-settings "Direct link to Per-Tenant Applications Settings")
...
## Available Features [​](https://clear.ml/docs/latest/docs/deploying_clearml/enterprise_deploy/multi_tenant_k8s/\#available-features "Direct link to Available Features")
...
| `permissions` | Enables editing of Role-Based Access Control (RBAC) rules. | ![No](https://clear.ml/docs/latest/icons/ico-optional-no.svg) |
| `applications` | Allows users to work with [ClearML Applications](https://clear.ml/docs/latest/docs/webapp/applications/apps_overview) (viewing, running). | Excludes management operations (upload/delete). |
| `app_management` | Allows application management operations: upload, delete, enable, disable. | ![No](https://clear.ml/docs/latest/icons/ico-optional-no.svg) |
| `experiments` | Allows working with experiments. | _Deprecated/Not Used._ All users have access regardless of this flag. |
| `queues` | Allows working with queues. | _Deprecated/Not Used._ All users have access regardless of this flag. |
| `queue_management` | Allows create, update, and delete operations on queues. | ![No](https://clear.ml/docs/latest/icons/ico-optional-no.svg) |
| `data_management` | Controls access to [Hyper-Datasets](https://clear.ml/docs/latest/docs/hyperdatasets/overview). | Access may also depend on `apiserver.services.excluded`. |
| `config_vault` | Enables the [configuration vaults](https://clear.ml/docs/latest/docs/webapp/settings/webapp_settings_profile#configuration-vault) feature. | ![No](https://clear.ml/docs/latest/icons/ico-optional-no.svg) |
| `pipelines` | Enables access to Pipelines (building and running). | ![No](https://clear.ml/docs/latest/icons/ico-optional-no.svg) |
| `reports` | Enables access to [Reports](https://clear.ml/docs/latest/docs/webapp/webapp_reports). | ![No](https://clear.ml/docs/latest/icons/ico-optional-no.svg) |
| `resource_dashboard` | Enables access to the [orchestration dashboard](https://clear.ml/docs/latest/docs/webapp/webapp_orchestration_dash) feature. | ![No](https://clear.ml/docs/latest/icons/ico-optional-no.svg) |
| `sso_management` | Enables the SSO (Single Sign-On) configuration wizard. | ![No](https://clear.ml/docs/latest/icons/ico-optional-no.svg) |
| `service_users` | Enables support for creating and managing service accounts (API keys). | ![No](https://clear.ml/docs/latest/icons/ico-optional-no.svg) |
| `resource_policy` | Enables the [Resource Policies](https://clear.ml/docs/latest/docs/webapp/resource_policies) feature. | May default to a trial feature if not explicitly enabled. |
| `model_serving` | Enables access to the [Model Endpoints](https://clear.ml/docs/latest/docs/webapp/webapp_model_endpoints) feature. | ![No](https://clear.ml/docs/latest/icons/ico-optional-no.svg) |
| `show_dashboard` | Makes the "Dashboard" menu item visible in the UI sidebar. | ![No](https://clear.ml/docs/latest/icons/ico-optional-no.svg) |
| `show_model_view` | Makes the "Models" menu item visible in the UI sidebar. | ![No](https://clear.ml/docs/latest/icons/ico-optional-no.svg) |
| `show_projects` | Makes the "Projects" menu item visible in the UI sidebar. | ![No](https://clear.ml/docs/latest/icons/ico-optional-no.svg) |
...
- [ClearML Server](https://clear.ml/docs/latest/docs/deploying_clearml/enterprise_deploy/multi_tenant_k8s/#clearml-server)
  - [Create a Tenant](https://clear.ml/docs/latest/docs/deploying_clearml/enterprise_deploy/multi_tenant_k8s/#create-a-tenant)
  - [Feature Control by User Group](https://clear.ml/docs/latest/docs/deploying_clearml/enterprise_deploy/multi_tenant_k8s/#feature-control-by-user-group)
- [Workers](https://clear.ml/docs/latest/docs/deploying_clearml/enterprise_deploy/multi_tenant_k8s/#workers)
  - [Tenant Separation](https://clear.ml/docs/latest/docs/deploying_clearml/enterprise_deploy/multi_tenant_k8s/#tenant-separation)
- [Additional Configuration](https://clear.ml/docs/latest/docs/deploying_clearml/enterprise_deploy/multi_tenant_k8s/#additional-configuration)
  - [Override Options for New Tenants](https://clear.ml/docs/latest/docs/deploying_clearml/enterprise_deploy/multi_tenant_k8s/#override-options-for-new-tenants)
  - [Global Features Limits](https://clear.ml/docs/latest/docs/deploying_clearml/enterprise_deploy/multi_tenant_k8s/#global-features-limits)
  - [Configuring Groups](https://clear.ml/docs/latest/docs/deploying_clearml/enterprise_deploy/multi_tenant_k8s/#configuring-groups)
  - [Feature Assignment Strategy](https://clear.ml/docs/latest/docs/deploying_clearml/enterprise_deploy/multi_tenant_k8s/#feature-assignment-strategy)
  - [Per-Tenant Applications Settings](https://clear.ml/docs/latest/docs/deploying_clearml/enterprise_deploy/multi_tenant_k8s/#per-tenant-applications-settings)
- [Available Features](https://clear.ml/docs/latest/docs/deploying_clearml/enterprise_deploy/multi_tenant_k8s/#available-features)