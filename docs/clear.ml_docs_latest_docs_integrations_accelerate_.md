---
url: "https://clear.ml/docs/latest/docs/integrations/accelerate/"
title: "Accelerate | ClearML"
---

[Skip to main content](https://clear.ml/docs/latest/docs/integrations/accelerate/#__docusaurus_skipToContent_fallback)
...
## Setup [​](https://clear.ml/docs/latest/docs/integrations/accelerate/\#setup "Direct link to Setup")

To use Accelerate's ClearML tracker, make sure that `clearml` is [installed and set up](https://clear.ml/docs/latest/docs/clearml_sdk/clearml_sdk_setup#install-clearml)
...
You can also pass parameters to [`Task.init()`](https://clear.ml/docs/latest/docs/references/sdk/task#taskinit) by adding a nested dictionary
...
![Accelerate params](https://clear.ml/docs/latest/assets/images/integrations_accelerate_params-373670bef98ee761e8118775dffd335a.png)

## Logging [​](https://clear.ml/docs/latest/docs/integrations/accelerate/\#logging "Direct link to Logging")

### Scalars [​](https://clear.ml/docs/latest/docs/integrations/accelerate/\#scalars "Direct link to Scalars")
...
### Images and Table Plots [​](https://clear.ml/docs/latest/docs/integrations/accelerate/\#images-and-table-plots "Direct link to Images and Table Plots")
...
#### Logging Images [​](https://clear.ml/docs/latest/docs/integrations/accelerate/\#logging-images "Direct link to Logging Images")
...
#### Logging Plots [​](https://clear.ml/docs/latest/docs/integrations/accelerate/\#logging-plots "Direct link to Logging Plots")
...
### Additional Logging Options [​](https://clear.ml/docs/latest/docs/integrations/accelerate/\#additional-logging-options "Direct link to Additional Logging Options")
...
## Close Task [​](https://clear.ml/docs/latest/docs/integrations/accelerate/\#close-task "Direct link to Close Task")
...
- [Setup](https://clear.ml/docs/latest/docs/integrations/accelerate/#setup)
- [Logging](https://clear.ml/docs/latest/docs/integrations/accelerate/#logging)
  - [Scalars](https://clear.ml/docs/latest/docs/integrations/accelerate/#scalars)
  - [Images and Table Plots](https://clear.ml/docs/latest/docs/integrations/accelerate/#images-and-table-plots)
  - [Additional Logging Options](https://clear.ml/docs/latest/docs/integrations/accelerate/#additional-logging-options)
- [Close Task](https://clear.ml/docs/latest/docs/integrations/accelerate/#close-task)