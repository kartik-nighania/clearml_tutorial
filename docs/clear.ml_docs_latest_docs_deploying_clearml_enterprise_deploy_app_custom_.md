---
url: "https://clear.ml/docs/latest/docs/deploying_clearml/enterprise_deploy/app_custom/"
title: "Custom Applications | ClearML"
---

[Skip to main content](https://clear.ml/docs/latest/docs/deploying_clearml/enterprise_deploy/app_custom/#__docusaurus_skipToContent_fallback)
...
## Configuration File [​](https://clear.ml/docs/latest/docs/deploying_clearml/enterprise_deploy/app_custom/\#configuration-file "Direct link to Configuration File")
...
### General [​](https://clear.ml/docs/latest/docs/deploying_clearml/enterprise_deploy/app_custom/\#general "Direct link to General")
...
- `icon` ( _Optional_) \- Small image to display in the ClearML web UI as an icon for the application. Can be a public web url or an image in the application’s assets directory (described below)
- `no_info_html` ( _Optional_) \- HTML content to display as a placeholder for the dashboard when no instance is available. Can be a public web url or a file in the application’s assets directory (described below)
...
- `badges` ( _Optional_) \- List of strings to display as a badge/label in the UI
- `resumable` \- Boolean indication whether a running application instance can be restarted if required. Default is false.
- `category` ( _Optional_) \- Way to separate apps into different tabs in the ClearML web UI
- `featured` ( _Optional_) \- Value affecting the order of applications. Lower values are displayed first. Defaults to 500

#### Example [​](https://clear.ml/docs/latest/docs/deploying_clearml/enterprise_deploy/app_custom/\#example "Direct link to Example")
...
### Task [​](https://clear.ml/docs/latest/docs/deploying_clearml/enterprise_deploy/app_custom/\#task "Direct link to Task")
...
### Wizard [​](https://clear.ml/docs/latest/docs/deploying_clearml/enterprise_deploy/app_custom/\#wizard "Direct link to Wizard")
...
Need to specify the `name` of the previous field and a `value` dictionary, in which each key is a potential value of the previous field and each value is the default value for the default\_conditional\_field.
...
#### Example [​](https://clear.ml/docs/latest/docs/deploying_clearml/enterprise_deploy/app_custom/\#example-2 "Direct link to Example")
...
![Bool choice](<Base64-Image-Removed>)![Bool choice](<Base64-Image-Removed>)
...
![Conditional string field](https://clear.ml/docs/latest/assets/images/app_cond_str-86abcd54b7e053a53cbf8259b3b15c5d.png#light-mode-only)![Conditional string field](https://clear.ml/docs/latest/assets/images/app_cond_str_dark-f23db4fab1d9934e45b53746593701fb.png#dark-mode-only)
...
![Project selection](<Base64-Image-Removed>)![Project selection](<Base64-Image-Removed>)
...
![Group with single field](https://clear.ml/docs/latest/assets/images/app_group-f92c1d4b315284ba084f726ca9a7a2f2.png#light-mode-only)![Group with single field](https://clear.ml/docs/latest/assets/images/app_group_dark-777bfb6bfbf6790647be70230fdfb8a6.png#dark-mode-only)


### Dashboard [​](https://clear.ml/docs/latest/docs/deploying_clearml/enterprise_deploy/app_custom/\#dashboard "Direct link to Dashboard")
...
#### Example [​](https://clear.ml/docs/latest/docs/deploying_clearml/enterprise_deploy/app_custom/\#example-3 "Direct link to Example")
...
![HTML elements](https://clear.ml/docs/latest/assets/images/app_html_elements-ec657419d25510b6f67a132df168e91b.png#light-mode-only)![HTML elements](https://clear.ml/docs/latest/assets/images/app_html_elements_dark-e8ccd5746bfde01d0596bad16a6aeab5.png#dark-mode-only)
...
![Plot](https://clear.ml/docs/latest/assets/images/app_plot-213fce326949e5a216b46934b7314104.png#light-mode-only)![Plot](https://clear.ml/docs/latest/assets/images/app_plot_dark-c237ac3d27789e44f86a9b12955469ff.png#dark-mode-only)
...
![Log](https://clear.ml/docs/latest/assets/images/app_log-cd098b1ed6a12cd522a38da88ff6849e.png#light-mode-only)![Log](https://clear.ml/docs/latest/assets/images/app_log_dark-f3da8534f9e73363412c084e6302ba5e.png#dark-mode-only)


### Assets [​](https://clear.ml/docs/latest/docs/deploying_clearml/enterprise_deploy/app_custom/\#assets "Direct link to Assets")
...
### Python Code [​](https://clear.ml/docs/latest/docs/deploying_clearml/enterprise_deploy/app_custom/\#python-code "Direct link to Python Code")
...
The task is run by a [Custom Applications Agent](https://clear.ml/docs/latest/docs/deploying_clearml/enterprise_deploy/app_custom/#custom-apps-agent) within a Docker. Any packages used should be
...
## Deploying Custom Applications [​](https://clear.ml/docs/latest/docs/deploying_clearml/enterprise_deploy/app_custom/\#deploying-custom-applications "Direct link to Deploying Custom Applications")

### Custom Apps Agent [​](https://clear.ml/docs/latest/docs/deploying_clearml/enterprise_deploy/app_custom/\#custom-apps-agent "Direct link to Custom Apps Agent")
...
### Deploying Apps [​](https://clear.ml/docs/latest/docs/deploying_clearml/enterprise_deploy/app_custom/\#deploying-apps "Direct link to Deploying Apps")

#### Packaging an App [​](https://clear.ml/docs/latest/docs/deploying_clearml/enterprise_deploy/app_custom/\#packaging-an-app "Direct link to Packaging an App")
...
#### Installing an App [​](https://clear.ml/docs/latest/docs/deploying_clearml/enterprise_deploy/app_custom/\#installing-an-app "Direct link to Installing an App")
...
#### Removing an App [​](https://clear.ml/docs/latest/docs/deploying_clearml/enterprise_deploy/app_custom/\#removing-an-app "Direct link to Removing an App")
...
- [Configuration File](https://clear.ml/docs/latest/docs/deploying_clearml/enterprise_deploy/app_custom/#configuration-file)
  - [General](https://clear.ml/docs/latest/docs/deploying_clearml/enterprise_deploy/app_custom/#general)
  - [Task](https://clear.ml/docs/latest/docs/deploying_clearml/enterprise_deploy/app_custom/#task)
  - [Wizard](https://clear.ml/docs/latest/docs/deploying_clearml/enterprise_deploy/app_custom/#wizard)
  - [Dashboard](https://clear.ml/docs/latest/docs/deploying_clearml/enterprise_deploy/app_custom/#dashboard)
  - [Assets](https://clear.ml/docs/latest/docs/deploying_clearml/enterprise_deploy/app_custom/#assets)
  - [Python Code](https://clear.ml/docs/latest/docs/deploying_clearml/enterprise_deploy/app_custom/#python-code)
- [Deploying Custom Applications](https://clear.ml/docs/latest/docs/deploying_clearml/enterprise_deploy/app_custom/#deploying-custom-applications)
  - [Custom Apps Agent](https://clear.ml/docs/latest/docs/deploying_clearml/enterprise_deploy/app_custom/#custom-apps-agent)
  - [Deploying Apps](https://clear.ml/docs/latest/docs/deploying_clearml/enterprise_deploy/app_custom/#deploying-apps)