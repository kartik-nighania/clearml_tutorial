---
url: "https://clear.ml/docs/latest/docs/clearml_sdk/clearml_sdk_setup/"
title: "ClearML Python Package | ClearML"
---

[Skip to main content](https://clear.ml/docs/latest/docs/clearml_sdk/clearml_sdk_setup/#__docusaurus_skipToContent_fallback)
...
## Install ClearML [​](https://clear.ml/docs/latest/docs/clearml_sdk/clearml_sdk_setup/\#install-clearml "Direct link to Install ClearML")
...
## Connect ClearML SDK to the Server [​](https://clear.ml/docs/latest/docs/clearml_sdk/clearml_sdk_setup/\#connect-clearml-sdk-to-the-server "Direct link to Connect ClearML SDK to the Server")

Private Network / Custom CA Configuration
...
### Local Python [​](https://clear.ml/docs/latest/docs/clearml_sdk/clearml_sdk_setup/\#local-python "Direct link to Local Python")
...
For more information about running tasks inside Docker containers, see [ClearML Agent Deployment](https://clear.ml/docs/latest/docs/clearml_agent/clearml_agent_deployment_bare_metal)
and [ClearML Agent Reference](https://clear.ml/docs/latest/docs/clearml_agent/clearml_agent_ref).
...
3. Get ClearML credentials. Open the ClearML Web UI in a browser. On the [**SETTINGS > WORKSPACE**](https://app.clear.ml/settings/workspace-configuration)
...
4. At the command prompt `Paste copied configuration here:`, paste the ClearML credentials.
...
Now you can integrate ClearML into your code! Continue [here](https://clear.ml/docs/latest/docs/getting_started/auto_log_exp).

### Jupyter Notebook [​](https://clear.ml/docs/latest/docs/clearml_sdk/clearml_sdk_setup/\#jupyter-notebook "Direct link to Jupyter Notebook")
...
Now you can use ClearML in your notebook! Continue [here](https://clear.ml/docs/latest/docs/getting_started/auto_log_exp).

- [Install ClearML](https://clear.ml/docs/latest/docs/clearml_sdk/clearml_sdk_setup/#install-clearml)
- [Connect ClearML SDK to the Server](https://clear.ml/docs/latest/docs/clearml_sdk/clearml_sdk_setup/#connect-clearml-sdk-to-the-server)
  - [Local Python](https://clear.ml/docs/latest/docs/clearml_sdk/clearml_sdk_setup/#local-python)
  - [Jupyter Notebook](https://clear.ml/docs/latest/docs/clearml_sdk/clearml_sdk_setup/#jupyter-notebook)