---
url: "https://clear.ml/docs/latest/docs/release_notes/sdk/open_source/ver_1_1/"
title: "Version 1.1 | ClearML"
---

[Skip to main content](https://clear.ml/docs/latest/docs/release_notes/sdk/open_source/ver_1_1/#__docusaurus_skipToContent_fallback)

If you ❤️ ️ **ClearML**, ⭐️ us on [GitHub](https://github.com/clearml/clearml)!

On this page

### ClearML 1.1.6 [​](https://clear.ml/docs/latest/docs/release_notes/sdk/open_source/ver_1_1/\#clearml-116 "Direct link to ClearML 1.1.6")
...
### ClearML 1.1.5 [​](https://clear.ml/docs/latest/docs/release_notes/sdk/open_source/ver_1_1/\#clearml-115 "Direct link to ClearML 1.1.5")
...
### ClearML 1.1.4 [​](https://clear.ml/docs/latest/docs/release_notes/sdk/open_source/ver_1_1/\#clearml-114 "Direct link to ClearML 1.1.4")
...
### ClearML 1.1.3 [​](https://clear.ml/docs/latest/docs/release_notes/sdk/open_source/ver_1_1/\#clearml-113 "Direct link to ClearML 1.1.3")
...
### ClearML 1.1.2 [​](https://clear.ml/docs/latest/docs/release_notes/sdk/open_source/ver_1_1/\#clearml-112 "Direct link to ClearML 1.1.2")

**Bug Fix**

- Fix PyJWT issue (limit dependency to `<2.2.0`)

### ClearML 1.1.1 [​](https://clear.ml/docs/latest/docs/release_notes/sdk/open_source/ver_1_1/\#clearml-111 "Direct link to ClearML 1.1.1")
...
### ClearML 1.1.0 [​](https://clear.ml/docs/latest/docs/release_notes/sdk/open_source/ver_1_1/\#clearml-110 "Direct link to ClearML 1.1.0")
...
- Add missing _clearml-task_ parameters `--docker_args`, `--docker_bash_setup_script` and `--output-uri`
...
- Fix passing `task-type` to _clearml-task_ ( [#422](https://github.com/clearml/clearml/issues/422))
- Fix `clearml-task --version` throws an error ( [#422](https://github.com/clearml/clearml/issues/422))
- Fix _clearml-task_ ssh repository links are not detected as remote repositories ( [#423](https://github.com/clearml/clearml/issues/423))
...
- Fix _clearml-task_ exit with error when failing to verify `output_uri` (output warning instead)
...
- [ClearML 1.1.6](https://clear.ml/docs/latest/docs/release_notes/sdk/open_source/ver_1_1/#clearml-116)
- [ClearML 1.1.5](https://clear.ml/docs/latest/docs/release_notes/sdk/open_source/ver_1_1/#clearml-115)
- [ClearML 1.1.4](https://clear.ml/docs/latest/docs/release_notes/sdk/open_source/ver_1_1/#clearml-114)
- [ClearML 1.1.3](https://clear.ml/docs/latest/docs/release_notes/sdk/open_source/ver_1_1/#clearml-113)
- [ClearML 1.1.2](https://clear.ml/docs/latest/docs/release_notes/sdk/open_source/ver_1_1/#clearml-112)
- [ClearML 1.1.1](https://clear.ml/docs/latest/docs/release_notes/sdk/open_source/ver_1_1/#clearml-111)
- [ClearML 1.1.0](https://clear.ml/docs/latest/docs/release_notes/sdk/open_source/ver_1_1/#clearml-110)